--FastLeaks BEST, Https://dsc.gg/fastleakss
...
for i = 1, 9 do
    ...
    if read == nil then
        file_downloader.download_file_from_url('https://github.com/ghxszeff/nl-fonts/raw/refs/heads/main/small_pixel.ttf', 'nl\\melancholia\\small_pixel.ttf')
