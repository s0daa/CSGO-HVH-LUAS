...
menu.neverlose_config = tab.home.main:button("                "..colors.main..icons.neverlose..colors.default.." Author Neverlose Config".."             ", function() panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://neverlose.cc/market/item?id=g0nrLG&edit=1")  end, true)
menu.discord = tab.home.main:button(colors.main..icons.discord..colors.default.." Our Discord Community", function() panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://discord.gg/elevrate")  end, true)
menu.youtube = tab.home.main:button(colors.main..icons.youtube..colors.default.." Youtube ", function() panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://www.youtube.com/channel/UCvRqCiKGLO4Wn3QWUUodn-Q")  end, true)
...
--https://steamcommunity.com/id/contactwithu/
local death_phases = {
