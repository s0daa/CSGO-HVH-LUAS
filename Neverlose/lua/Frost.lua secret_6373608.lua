...
local menu = {
    global = {
        information = {
            ...
            current_build = tabs.global.tab_selection:label(" \f<tag>   Build: \vSecret"),
...
local indicators = function() 
    ...
    local gradient_text = gradient.text_animate("FROST SECRET", -1, {color(first_color.r, first_color.g, first_color.b, 255), color(second_color.r, second_color.g, second_color.b, 255)})
    gradient_text:animate()

    local frost_size = render.measure_text(2, "c", "FROST SECRET")
...
local watermark = function() 
    ...
    if gear_funcs.watermark_style:get() == "Frost" then
        ...
        local gradient_animation_watermark_modern = gradient.text_animate(">/ frost anti aim - " .. common.get_username() .. " - [secret] /<", -2, {color(frost_color.r, frost_color.g, frost_color.b, 255), color(50, 50, 50, 255)})
