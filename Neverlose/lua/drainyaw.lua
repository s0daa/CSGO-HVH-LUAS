...
menu.button(ui_handler.groups_name.setup.additional, defines.colored_text({"Live Build"}), function()
    panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://market.neverlose.cc/JVGjf2")
end, true)
...
menu.button(ui_handler.groups_name.setup.additional, defines.colored_text({"Telegram Group"}), function()
    panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://t.me/drainyaw")
end, true)
menu.button(ui_handler.groups_name.setup.additional, defines.colored_text({"YouTube Channel"}), function()
    panorama.SteamOverlayAPI.OpenExternalBrowserURL("https://youtube.com/c/sadboyzZz")
end, true)
