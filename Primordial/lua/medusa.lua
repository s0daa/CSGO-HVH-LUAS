...
client.log_screen("medusa ", color_t(207,218,255), "["..build.."] ",  color_t(255,255,255), "successfuly loaded! User:", color_t(232,209,255), ""..user.name.. " [" ..user.uid.. "].")
...
local killsay_phrases = {
    ...
    ksay_russian = {
        "Брат, сегодня пятница, не пропусти джума-намаз",
        "почесал яйца таокй потом апельсин чоо",
        "Sanchezj подал мне оружие и кадыров выебал барана",
        "lordpuma 1v1 jory",
        "+ кто хохол",
        "свежий кабанчик",
        "насрал в коран",
        "ку есть 5 рублей",
        "бляя ща рыгнул пизда громка",
        "ну ты и сомалийский писькасвист конешно",
        "ты когда срал последний раз?",
        "бля яйцо почесал заеюись ваще",
        "дристанул",
        "блин сёдня встал пассать и хуй ис штанов выпал",
        "Тронуло до самой души! Читать всем! Звонок в час ночи: -Алло.",
        "ыыпырпрылпрыл прылпылрылпыл",
        ...
        "стефан vs скалли",
        "ЧТООО??!?!?!?! это чё помидор!??!?!!",
        "писюн больше не чешется, я его почесал",
        "оближи мои немытые ноги",
        "рш онмхлюеьэ врн ъ бн бпелъ унййеимнцн люрвю, рбнч люрэ бшхймск мюуси мю окныюдйс, врна нмю охгдюйнл ябнхл бнпнрю псяяйху гюыхыюкю?)",
        "рш онмхлюеьэ врн брнъ люрэ яедхр с лемъ мю жеох х йюй аскэднц ╗аюммши мю лни уси якчмх акъдэ осяйюер?-)",
        "ты чеченская моча",
        "ты анус краба",
        "ты ананас в уретре",
        "ты кукурузная вагина",
        "ты крабовый член",
        "ты писюнявый салоед",
        "ты анальный гамбургер",
        "ты гепатит дельфина",
        "ты дагестанский насильник",
        "ты анальный привод",
        "ты пружинный спермус",
        "ты киргизский трехчлен",
        "ты дудковый припездохен",
        "ты подпиздатрахнутый членоволосок",
        "ты подпольная дрочка",
        "ты пиздоносатый жукочлен",
        "ты пиздоебланутый членорукий хуехряк",
        "ты подзалупная членоотвертка",
        "ты радиактивный членоотражатель",
        "ты колумбийский спермотоксикоз",
        "ты подпиздожирафовый членохуйлан",
        "ты валынопиздотраховый членосамосвал",
        "ты карибский сперможук",
        "ты подзалупотреугольночленовьебнутый драконопиздонасвай",
        "ты членотрахнутыйсамоотсасывающийстоякодрочун",
        "ты собакотрахнутыйподпиздофалосныйчленохуйлановыйобьёбнутоприпизднутыйантропоморфныйфалосоподобный членоеблан",
        "ты спермамахнояйцовыйчленоотводящийстоякокулачныйдрочепиздотрахнутоподьёбнопенисокиргизкийсиськомочеписюлькожопатрахуевый киберфалос",
        "когда посрал и такой ХУУУУУЙЙ",
        "ты когда нибудь срал с 13 этажа?",
        "билайн",
        "иисус или мтс?",
        "церковь или подьемный кран?",
        "геноцид евреев или арбуз?",
        "а ты пробовал когди-нибудь вместо своей залупы вкрутить лампочку?",
        "ууу цироз анльного пингвина отлетел изи",
        "колпик",
        "когда жестко выебал арбуз и такой танки онлайн",
        "почему в чизбургер не добавляют отрубленый хуй носарога? эьо же чизбурегр??",
        "л",
        "а ты срал хомяком?",
        "зачем кадыров насилует баранов?",
        "казахстан",
        "хохел",
        "Zеленский",
        "а вы знали что утюг делают не из говна?",
        "world of tanks",
        "не ври чт никогда не хотел жестоко трахнуть дворника прямо в его огромную промежность",
        "ты шайтан дон",
        "писюнтик",
        "когда видишь жопу горилы и такой кончаешь 3 раза",
        "р жчдкотззйгрпкдзйн?)",
        "ЪЪЪЪ)))) ооппоповап ЪЪЪ БББЮ",
        "лучшие закладки вашего города - тг @fipp1337",
        "господи этот, лысый, отщучивается ахах",
        "мен, дрочила, отлетает обосан",
        "михаил горшков",
    },

    ksay_english = {
        "what this nigga doin??",
        "dont be loser buy defuser",
        "which nigger stole your resolver?",
        ...
        "by god mode hack",
        "+1",
        "𝔬𝔴𝔫𝔢𝔡 𝕓𝕪 𝖕𝖗𝖎𝖒𝖔𝖗𝖉𝖎𝖆𝖑 & 𝖒𝖊𝖉𝖚𝖘𝖆.𝖌𝖌",
        "𝖋𝖚𝖈𝖐 *𝕟𝕖𝕧𝕖𝕣𝕝𝕠𝕤𝕖* 𝐚𝐥𝐥 𝐦𝐲 𝐡𝐨𝐦𝐢𝐞𝐬 𝐮𝐬𝐞 𝖕𝖗𝖎𝖒𝖔𝖗𝖉𝖎𝖆𝖑",
        "𝖕𝖗𝖎𝖒𝖔𝖗𝖉𝖎𝖆𝖑.𝖉𝖊𝖛? 𝙤𝙣𝙡𝙮 𝙬𝙞𝙩𝙝 𝖒𝖊𝖉𝖚𝖘𝖆.𝖌𝖌",
    ...
    ksay_english_hs = {
        ...
        "do you have antiaim enabled?",
        "2 - 1 = ?",
        "nice aa",
        "p aa bro",
        'still wasting ur money on "antiaim" luas?',
        "bad aa lua, buy another one",
        "tell me how much money you fucked up this time on another useless aa lua",
        "next time, use your brain, not your lame aa lua",
    }
...
local refs = {
    ...
    min_damage_a            = menu.find("aimbot", "auto", "target overrides", "min. damage")[2],
    min_damage_s            = menu.find("aimbot", "scout", "target overrides", "min. damage")[2],
    min_damage_r            = menu.find("aimbot", "revolver", "target overrides", "min. damage")[2],
    min_damage_d            = menu.find("aimbot", "deagle", "target overrides", "min. damage")[2],
    min_damage_p            = menu.find("aimbot", "pistols", "target overrides", "min. damage")[2],
    min_damage_awp          = menu.find("aimbot", "awp", "target overrides", "min. damage")[2],
    amount_auto             = unpack(menu.find("aimbot", "auto", "target overrides", "min. damage")),
    amount_scout            = unpack(menu.find("aimbot", "scout", "target overrides", "min. damage")),
    amount_awp              = unpack(menu.find("aimbot", "awp", "target overrides", "min. damage")),
    amount_revolver         = unpack(menu.find("aimbot", "revolver", "target overrides", "min. damage")),
    amount_deagle           = unpack(menu.find("aimbot", "deagle", "target overrides", "min. damage")),
    amount_pistol           = unpack(menu.find("aimbot", "pistols", "target overrides", "min. damage")),
    -- antiaim refs
...
local aa_f = {
    --tanki online
    aa_check                      = menu.add_checkbox("medusa  ›  antiaim  ›  main", "antiaim builder", false),
    conditionselection            = menu.add_selection("medusa  ›  antiaim  ›  main", "condition", {"global", "standing", "moving", "air", "air-duck", "crouching", "slow walk"}),

    -- override global
    aa_overg_stand                = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[s]  override global", false),
    aa_overg_move                 = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[m]  override global", false),
    aa_overg_air                  = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[a]  override global", false),
    aa_overg_airduck              = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[a-d] override global", false),
    aa_overg_crouch               = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[c]  override global", false),
    aa_overg_slowwalk             = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[sw] override global", false),

    -- jitter type
    aa_jittertype_global          = menu.add_selection("medusa  ›  antiaim  ›  main", "[g] jitter type ", {"center", "offset"}),
    aa_jittertype_stand           = menu.add_selection("medusa  ›  antiaim  ›  main", "[s] jitter type ", {"center", "offset"}),
    aa_jittertype_move            = menu.add_selection("medusa  ›  antiaim  ›  main", "[m] jitter type", {"center", "offset"}),
    aa_jittertype_air             = menu.add_selection("medusa  ›  antiaim  ›  main", "[a] jitter type", {"center", "offset"}),
    aa_jittertype_airduck         = menu.add_selection("medusa  ›  antiaim  ›  main", "[a-d] jitter type", {"center", "offset"}),
    aa_jittertype_crouch          = menu.add_selection("medusa  ›  antiaim  ›  main", "[c] jitter type", {"center", "offset"}),
    aa_jittertype_slowwalk        = menu.add_selection("medusa  ›  antiaim  ›  main", "[sw] jitter type", {"center", "offset"}),
    -- jitter add
    aa_jitter_global              = menu.add_slider("medusa  ›  antiaim  ›  main", "[g] jitter add", -180, 180),
    aa_jitter_stand               = menu.add_slider("medusa  ›  antiaim  ›  main", "[s] jitter add", -180, 180),
    aa_jitter_move                = menu.add_slider("medusa  ›  antiaim  ›  main", "[m] jitter add", -180, 180),
    aa_jitter_air                 = menu.add_slider("medusa  ›  antiaim  ›  main", "[a] jitter add", -180, 180),
    aa_jitter_crouch              = menu.add_slider("medusa  ›  antiaim  ›  main", "[c] jitter add", -180, 180),
    aa_jitter_airduck             = menu.add_slider("medusa  ›  antiaim  ›  main", "[a-d] jitter add", -180, 180),
    aa_jitter_slowwalk            = menu.add_slider("medusa  ›  antiaim  ›  main", "[sw] jitter add", -180, 180),
    --yaw left
    aa_yawlimleft_global          = menu.add_slider("medusa  ›  antiaim  ›  main", "[g] yaw limit left", -90, 90),
    aa_yawlimleft_stand           = menu.add_slider("medusa  ›  antiaim  ›  main", "[s] yaw limit left", -90, 90),
    aa_yawlimleft_move            = menu.add_slider("medusa  ›  antiaim  ›  main", "[m] yaw limit left", -90, 90),
    aa_yawlimleft_air             = menu.add_slider("medusa  ›  antiaim  ›  main", "[a] yaw limit left", -90, 90),
    aa_yawlimleft_airduck         = menu.add_slider("medusa  ›  antiaim  ›  main", "[a-d] yaw limit left", -90, 90),
    aa_yawlimleft_crouch          = menu.add_slider("medusa  ›  antiaim  ›  main", "[c] yaw limit left", -90, 90),
    aa_yawlimleft_slowwalk        = menu.add_slider("medusa  ›  antiaim  ›  main", "[sw] yaw limit left", -90, 90),
    --yaw right
    aa_yawlimright_global          = menu.add_slider("medusa  ›  antiaim  ›  main", "[g] yaw limit right", -90, 90),
    aa_yawlimright_stand          = menu.add_slider("medusa  ›  antiaim  ›  main", "[s] yaw limit right", -90, 90),
    aa_yawlimright_move           = menu.add_slider("medusa  ›  antiaim  ›  main", "[m] yaw limit right", -90, 90),
    aa_yawlimright_air            = menu.add_slider("medusa  ›  antiaim  ›  main", "[a] yaw limit right", -90, 90),
    aa_yawlimright_airduck        = menu.add_slider("medusa  ›  antiaim  ›  main", "[a-d] yaw limit right", -90, 90),
    aa_yawlimright_crouch         = menu.add_slider("medusa  ›  antiaim  ›  main", "[c] yaw limit right", -90, 90),
    aa_yawlimright_slowwalk       = menu.add_slider("medusa  ›  antiaim  ›  main", "[sw] yaw limit right", -90, 90),
    --yaw offset
    aa_offset_global               = menu.add_slider("medusa  ›  antiaim  ›  main", "[g] yaw offset", -180, 180),
    aa_offset_stand               = menu.add_slider("medusa  ›  antiaim  ›  main", "[s] yaw offset", -180, 180),
    aa_offset_move                = menu.add_slider("medusa  ›  antiaim  ›  main", "[m] yaw offset", -180, 180),
    aa_offset_air                 = menu.add_slider("medusa  ›  antiaim  ›  main", "[a] yaw offset", -180, 180),
    aa_offset_airduck             = menu.add_slider("medusa  ›  antiaim  ›  main", "[a-d] yaw offset", -180, 180),
    aa_offset_crouch              = menu.add_slider("medusa  ›  antiaim  ›  main", "[c] yaw loffset", -180, 180),
    aa_offset_slowwalk            = menu.add_slider("medusa  ›  antiaim  ›  main", "[sw] yaw offset", -180, 180),
    --fake left
    aa_fakelimleft_global          = menu.add_slider("medusa  ›  antiaim  ›  main", "[g] fake limit left", 0, 100),
    aa_fakelimleft_stand          = menu.add_slider("medusa  ›  antiaim  ›  main", "[s] fake limit left", 0, 100),
    aa_fakelimleft_move           = menu.add_slider("medusa  ›  antiaim  ›  main", "[m] fake limit left", 0, 100),
    aa_fakelimleft_air            = menu.add_slider("medusa  ›  antiaim  ›  main", "[a] fake limit left", 0, 100),
    aa_fakelimleft_airduck        = menu.add_slider("medusa  ›  antiaim  ›  main", "[a-d] fake limit left", 0, 100),
    aa_fakelimleft_crouch         = menu.add_slider("medusa  ›  antiaim  ›  main", "[c] fake limit left", 0, 100),
    aa_fakelimleft_slowwalk       = menu.add_slider("medusa  ›  antiaim  ›  main", "[sw] fake limit left", 0, 100),
    --fake right
    aa_fakelimright_global         = menu.add_slider("medusa  ›  antiaim  ›  main", "[g] fake limit right", 0, 100),
    aa_fakelimright_stand         = menu.add_slider("medusa  ›  antiaim  ›  main", "[s] fake limit right", 0, 100),
    aa_fakelimright_move          = menu.add_slider("medusa  ›  antiaim  ›  main", "[m] fake limit right", 0, 100),
    aa_fakelimright_air           = menu.add_slider("medusa  ›  antiaim  ›  main", "[a] fake limit right", 0, 100),
    aa_fakelimright_airduck       = menu.add_slider("medusa  ›  antiaim  ›  main", "[a-d] fake limit right", 0, 100),
    aa_fakelimright_crouch        = menu.add_slider("medusa  ›  antiaim  ›  main", "[c] fake limit right", 0, 100),
    aa_fakelimright_slowwalk      = menu.add_slider("medusa  ›  antiaim  ›  main", "[sw] fake limit right", 0, 100),
    --lean checks & modes
    aa_lean_check_global           = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[g] use body lean", false),
    aa_lean_mode_global            = menu.add_selection("medusa  ›  antiaim  ›  main", "[g] body lean mode", {"static", "jitter"}),
    aa_lean_check_stand           = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[s] use body lean", false),
    aa_lean_mode_stand            = menu.add_selection("medusa  ›  antiaim  ›  main", "[s] body lean mode", {"static", "jitter"}),
    aa_lean_check_move            = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[m] use body lean", false),
    aa_lean_mode_move             = menu.add_selection("medusa  ›  antiaim  ›  main", "[m] body lean mode", {"static", "jitter"}),
    aa_lean_check_air             = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[a] use body lean", false),
    aa_lean_mode_air              = menu.add_selection("medusa  ›  antiaim  ›  main", "[a] body lean mode", {"static", "jitter"}),
    aa_lean_check_airduck         = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[a-d] use body lean", false),
    aa_lean_mode_airduck          = menu.add_selection("medusa  ›  antiaim  ›  main", "[a-d] body lean mode", {"static", "jitter"}),
    aa_lean_check_crouch          = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[c] use body lean", false),
    aa_lean_mode_crouch           = menu.add_selection("medusa  ›  antiaim  ›  main", "[c] body lean mode", {"static", "jitter"}),
    aa_lean_check_slowwalk        = menu.add_checkbox("medusa  ›  antiaim  ›  main", "[sw] use body lean", false),
    aa_lean_mode_slowwalk         = menu.add_selection("medusa  ›  antiaim  ›  main", "[sw] body lean mode", {"static", "jitter"}),
    --lean left
    aa_leanlimleft_global          = menu.add_slider("medusa  ›  antiaim  ›  main", "[g] lean limit left", 0, 50),
    aa_leanlimleft_stand          = menu.add_slider("medusa  ›  antiaim  ›  main", "[s] lean limit left", 0, 50),
    aa_leanlimleft_move           = menu.add_slider("medusa  ›  antiaim  ›  main", "[m] lean limit left", 0, 50),
    aa_leanlimleft_air            = menu.add_slider("medusa  ›  antiaim  ›  main", "[a] lean limit left", 0, 50),
    aa_leanlimleft_airduck        = menu.add_slider("medusa  ›  antiaim  ›  main", "[a-d] lean limit left", 0, 50),
    aa_leanlimleft_crouch         = menu.add_slider("medusa  ›  antiaim  ›  main", "[c] lean limit left", 0, 50),
    aa_leanlimleft_slowwalk       = menu.add_slider("medusa  ›  antiaim  ›  main", "[sw] lean limit left", 0, 50),
    --lean right
    aa_leanlimright_global         = menu.add_slider("medusa  ›  antiaim  ›  main", "[g] lean limit right", 0, 50),
    aa_leanlimright_stand         = menu.add_slider("medusa  ›  antiaim  ›  main", "[s] lean limit right", 0, 50),
    aa_leanlimright_move          = menu.add_slider("medusa  ›  antiaim  ›  main", "[m] lean limit right", 0, 50),
    aa_leanlimright_air           = menu.add_slider("medusa  ›  antiaim  ›  main", "[a] lean limit right", 0, 50),
    aa_leanlimright_airduck       = menu.add_slider("medusa  ›  antiaim  ›  main", "[a-d] lean limit right", 0, 50),
    aa_leanlimright_crouch        = menu.add_slider("medusa  ›  antiaim  ›  main", "[c] lean limit right", 0, 50),
    aa_leanlimright_slowwalk      = menu.add_slider("medusa  ›  antiaim  ›  main", "[sw] lean limit right", 0, 50),
    aa_lean_switchside            = menu.add_text("medusa  ›  antiaim  ›  main", "switch static Lean side"),
    --yaw randomise left
    aa_randomise_global_left_check = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[g] randomise left yaw side", false),
    aa_randomise_global_left1      = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[g] randomise value 1", -20, 20),
    aa_randomise_global_left2      = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[g] randomise value 2", -20, 20),
    aa_randomise_stand_left_check = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[s] randomise left yaw side", false),
    aa_randomise_stand_left1      = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[s] randomise value 1", -20, 20),
    aa_randomise_stand_left2      = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[s] randomise value 2", -20, 20),
    aa_randomise_move_left_check  = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[m] randomise left yaw side", false),    
    aa_randomise_move_left1       = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[m] randomise value 1", -20, 20),
    aa_randomise_move_left2       = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[m] randomise value 2", -20, 20),    
    aa_randomise_air_left_check   = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[a] randomise left yaw side", false),    
    aa_randomise_air_left1        = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[a] randomise value 1", -20, 20),
    aa_randomise_air_left2        = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[a] randomise value 2", -20, 20),    
    aa_randomise_airduck_left_check   = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise left yaw side", false),    
    aa_randomise_airduck_left1    = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise value 1", -20, 20),
    aa_randomise_airduck_left2    = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise value 2", -20, 20),
    aa_randomise_crouch_left_check   = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[c] randomise left yaw side", false),    
    aa_randomise_crouch_left1     = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[c] randomise value 1", -20, 20),
    aa_randomise_crouch_left2     = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[c] randomise value 2", -20, 20),    
    aa_randomise_slowwalk_left_check   = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[sw] randomise left yaw side", false),    
    aa_randomise_slowwalk_left1   = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[sw] randomise value 1", -20, 20),
    aa_randomise_slowwalk_left2   = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[sw] randomise value 2", -20, 20),    
    --yaw randomise right
    aa_randomise_global_right_check= menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[g] randomise right yaw side", false),
    aa_randomise_global_right1     = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[g] randomise value 1", -20, 20),
    aa_randomise_global_right2     = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[g] randomise value 2", -20, 20),
    aa_randomise_stand_right_check= menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[s] randomise right yaw side", false),
    aa_randomise_stand_right1     = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[s] randomise value 1", -20, 20),
    aa_randomise_stand_right2     = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[s] randomise value 2", -20, 20),
    aa_randomise_move_right_check = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[m] randomise right yaw side", false),    
    aa_randomise_move_right1      = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[m] randomise value 1", -20, 20),
    aa_randomise_move_right2      = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[m] randomise value 2", -20, 20),   
    aa_randomise_air_right_check  = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[a] randomise right yaw side", false),    
    aa_randomise_air_right1       = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[a] randomise value 1", -20, 20),
    aa_randomise_air_right2       = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[a] randomise value 2", -20, 20),    
    aa_randomise_airduck_right_check  = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise right yaw side", false),    
    aa_randomise_airduck_right1   = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise value 1", -20, 20),
    aa_randomise_airduck_right2   = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[a-d] randomise value 2", -20, 20), 
    aa_randomise_crouch_right_check  = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[c] randomise right yaw side", false),    
    aa_randomise_crouch_right1    = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[c] randomise value 1", -20, 20),
    aa_randomise_crouch_right2    = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[c] randomise value 2", -20, 20),    
    aa_randomise_slowwalk_right_check  = menu.add_checkbox("medusa  ›  antiaim  ›  main  ›  additional features", "[sw] randomise right yaw side", false),    
    aa_randomise_slowwalk_right1  = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[sw] randomise value 1", -20, 20),
    aa_randomise_slowwalk_right2  = menu.add_slider("medusa  ›  antiaim  ›  main  ›  additional features", "[sw] randomise value 2", -20, 20),
    -- animbreaker
    aa_animbreaker_check          = menu.add_checkbox("medusa  ›  antiaim  ›  other", "animation breakers", false),
    aa_animbreaker_main           = menu.add_multi_selection("medusa  ›  antiaim  ›  other", "main", {"lean in air", "legs in air", "backward slide", "0 pitch on land", "static legs on slowwalk"}),
    aa_animbreaker_legs           = menu.add_selection("medusa  ›  antiaim  ›  other", "legs in air", {"static", "walk"}),
    aa_animbreaker_other          = menu.add_multi_selection("medusa  ›  antiaim  ›  other", "other", {"sus"}),
    -- onshot fl
    onshotfl_check                = menu.add_checkbox("medusa  ›  antiaim  ›  other", "on shot fakelag", false),
    -- lc
    lc_check                      = menu.add_checkbox("medusa  ›  antiaim  ›  other", "break lc in air", false),
    lc_weapons                    = menu.add_multi_selection("medusa  ›  antiaim  ›  other", "weapons", {"scout", "auto", "awp", "pistols", "deagle", "revolver", "taser", "other"}),
    lc_state_check                = menu.add_checkbox("medusa  ›  antiaim  ›  other", "in all states", false),
    -- anti zeus
    anti_zeus_check               = menu.add_checkbox("medusa  ›  antiaim  ›  other", "anti zeus", false),
    anti_zeus_max_dist            = menu.add_slider("medusa  ›  antiaim  ›  other", "distance", 10, 30),
    -- warmup
    warmup_check                  = menu.add_checkbox("medusa  ›  antiaim  ›  other", "shit preset on warmup", false),
}
aa_f.anti_zeus_max_dist:set(17)

local rage_f = {
    customdt_check                = menu.add_checkbox("medusa  ›  ragebot  ›  main", "override doubletap", false),
    customdt_speed                = menu.add_slider("medusa  ›  ragebot  ›  main", "speed", 10, 22),
    customdt_waning               = menu.add_text("medusa  ›  ragebot  ›  main", "this dt speed may cause unregistered shots."),
    customdt_corrections          = menu.add_checkbox("medusa  ›  ragebot  ›  main", "disable corrections", false),
    recharge_check                = menu.add_checkbox("medusa  ›  ragebot  ›  main", "faster recharge", false),
    disableinterp_check           = menu.add_checkbox("medusa  ›  ragebot  ›  main", "disable interpolation", false),
    prediction_check              = menu.add_checkbox("medusa  ›  ragebot  ›  main", "better prediction", false),
    prediction_warning            = menu.add_text("medusa  ›  ragebot  ›  main", "recommended to use this feature only with force prediction."),
    early_check                   = menu.add_checkbox("medusa  ›  ragebot  ›  main", "early autostop on autopeek", false),
    early_weapons                 = menu.add_multi_selection("medusa  ›  ragebot  ›  main", "weapons", {"scout", "awp"}),
}
rage_f.customdt_speed:set(15)

local visual_f = {
    windows_combo                 = menu.add_multi_selection("medusa  ›  visual  ›  main", "windows", {"watermark", "keybinds"}),
    windows_mode                  = menu.add_selection("medusa  ›  visual  ›  main", "windows style", {"medusa ui v1", "medusa ui v2"}),
    watermark_custom_watername    = menu.add_selection("medusa  ›  visual  ›  main", "watermark name", {"medusa", "primordial", "primordial | medusa", "custom"}),
    watermark_custom_custom       = menu.add_text_input("medusa  ›  visual  ›  main", "name"),
    watermark_custom_showuid      = menu.add_checkbox("medusa  ›  visual  ›  main", "show uid", false),
    indicators_check              = menu.add_checkbox("medusa  ›  visual  ›  main", "indicators", false),
    indicators_customisation      = menu.add_multi_selection("medusa  ›  visual  ›  main", "customisation", {"doubletap charge bar", "background", "state color", "display desync side"}),
    indicators_customisation_bg   = menu.add_multi_selection("medusa  ›  visual  ›  main", "apply background on", {"watermark", "state", "binds"}),
    indicators_state_color        = menu.add_selection("medusa  ›  visual  ›  main", "state color mode", {"default", "state based"}),
    indicators_customisation_rect = menu.add_checkbox("medusa  ›  visual  ›  main", "background rect", false),
    disable_primomark             = menu.add_checkbox("medusa  ›  visual  ›  main", "disable primordial watermark", false),

    lethal_indicator_check        = menu.add_checkbox("medusa  ›  visual  ›  main", "lethal indicator", false),
    slowdownind_check             = menu.add_checkbox("medusa  ›  visual  ›  main", "slowed down indicator", false),
    infobox_check                 = menu.add_checkbox("medusa  ›  visual  ›  main", "info box", false),
    penisdot_check                = menu.add_checkbox("medusa  ›  visual  ›  main", "better penetration dot", false),
    zeus_warning_check            = menu.add_checkbox("medusa  ›  visual  ›  main", "zeus warning", false),
    lobby_waning                  = menu.add_text("medusa  ›  visual  ›  main", "you are in lobby some visual features will not work."),

    floydmode_check               = menu.add_checkbox("medusa  ›  visual  ›  other", "dark theme", false),

    color_theme_mode              = menu.add_selection("medusa  ›  visual  ›  accent color", "accent color mode", {"custom", "sync with menu"}),
    color_theme_text              = menu.add_text("medusa  ›  visual  ›  accent color", "accent color main"),
    color_theme_text_2            = menu.add_text("medusa  ›  visual  ›  accent color", "accent color second"),
    color_theme_alpha             = menu.add_slider("medusa  ›  visual  ›  accent color", "global alpha", 0, 255),

    fonttext                      = menu.add_text("medusa  ›  visual  ›  font", "install this font for the visuals work properly -"),
    fontlink                      = menu.add_button("medusa  ›  visual  ›  font", "copy link", function() clipboard_export("https://www.dafont.com/smallest-pixel-7.font") client.log_screen("copied!") engine.execute_cmd("play reggin.wav") end),
}
visual_f.color_theme_alpha:set(148)

local misc_f = {
    trashtalk_check               = menu.add_checkbox("medusa  ›  miscellaneous  ›  main", "trashtalk", false),
    trashtalk_mode                = menu.add_selection("medusa  ›  miscellaneous  ›  main", "trashtalk mode", {"russian", "english"}),
    tt_hs_check                   = menu.add_checkbox("medusa  ›  miscellaneous  ›  main", "announce headshot", false),
    clantag_check                 = menu.add_checkbox("medusa  ›  miscellaneous  ›  main", "clantag", false),
    clantag_mode                  = menu.add_selection("medusa  ›  miscellaneous  ›  main", "clantag mode", {"medusa", "time hack"}),
    gh_fix_check                  = menu.add_checkbox("medusa  ›  miscellaneous  ›  main", "grenade helper fix", false),
    autobuy_check                 = menu.add_checkbox("medusa  ›  miscellaneous  ›  main", "disable autobuy on pistol round", false),

    localserver_check             = menu.add_checkbox("medusa  ›  miscellaneous  ›  local server", "enable", false),
    localserver_configure         = menu.add_button("medusa  ›  miscellaneous  ›  local server", "configure", function() engine.execute_cmd("sv_cheats 1; mp_do_warmup_offine 1; mp_warmuptime 14881488; mp_warmup_pausetimer 1;  mp_warmup_start; sv_infinite_ammo 1; mp_limitteams 16; mp_autoteambalance 0; bot_kick; god; sv_airaccelerate 80; bot_stop 1") end),
    localserver_bottext           = menu.add_text("medusa  ›  miscellaneous  ›  local server", "bots -"),
    localserver_botaddct          = menu.add_button("medusa  ›  miscellaneous  ›  local server", "add ct", function() engine.execute_cmd("bot_add_ct;") end),
    localserver_botaddt           = menu.add_button("medusa  ›  miscellaneous  ›  local server", "add t", function() engine.execute_cmd("bot_add_t;") end),
    localserver_botkick           = menu.add_button("medusa  ›  miscellaneous  ›  local server", "kick", function() engine.execute_cmd("bot_kick;") end),
}

local binds = {
    aa_lean_switchside_bind       = aa_f.aa_lean_switchside:add_keybind("medusa  ›  antiaim  ›  main", "switch static lean side"),
}
...
local infotab = {
    space132                      = menu.add_text("medusa  ›  information  ›  main", ""),
    neforlogo                     = menu.add_text("medusa  ›  information  ›  main", "||| medusa.gg"),
    space12                       = menu.add_text("medusa  ›  information  ›  main", ""),
    neforbild                     = menu.add_text("medusa  ›  information  ›  main", "build: "..build.. "."),
    neforver                      = menu.add_text("medusa  ›  information  ›  main", "version: "..buildver.. "."),
    neforuser                     = menu.add_text("medusa  ›  information  ›  main", "user: " ..user.name.. " [" ..user.uid.. "]."),
    neforcord                     = menu.add_text("medusa  ›  information  ›  main", "join our discord server to stay up to date."),
    neforlog                      = menu.add_text("medusa  ›  information  ›  main", "changelog and other info in discord."),
}
...
local unregtab = {
    ...
    contactscopy                  = menu.add_button("error", "discord (click to copy)", function() clipboard_export("wht#3489") client.log_screen("copied!") end),
}

menu.set_group_column("medusa", 1)
menu.set_group_column("medusa  ›  ragebot  ›  main", 2)
menu.set_group_column("medusa  ›  antiaim  ›  main", 2)
menu.set_group_column("medusa  ›  antiaim  ›  main  ›  additional features", 2)
local function aa_sort() if not aa_f.aa_check:get() then menu.set_group_column("medusa  ›  antiaim  ›  other", 2) else menu.set_group_column("medusa  ›  antiaim  ›  other", 1) end end
menu.set_group_column("medusa  ›  visual  ›  main", 2)
menu.set_group_column("medusa  ›  visual  ›  other", 1)
menu.set_group_column("medusa  ›  visual  ›  font", 1)
menu.set_group_column("medusa  ›  visual  ›  accent color", 2)
menu.set_group_column("medusa  ›  miscellaneous  ›  main", 2)
menu.set_group_column("medusa  ›  miscellaneous  ›  other", 2)
menu.set_group_column("medusa  ›  miscellaneous  ›  local server", 2)
menu.set_group_column("medusa  ›  information  ›  main", 2)
...
configs.import = function(input)
    local protected = function()
        ...
        client.log_screen("[medusa] config loaded")
        engine.execute_cmd("play aa_config.wav")
    end
    local status, message = pcall(protected)
    if not status then
        client.log_screen("[medusa] failed to load config or not all items have changed")
...
configs.export = function()
	...
	client.log_screen("[medusa] config exported")
    engine.execute_cmd("play aa_config.wav")
end
...
local function menuwater()
    if menu.is_open() then 
        ...
        if visual_f.color_theme_mode:get() == 2 then
            ...
            render.text(pixel, "MEDUSA ", vec2_t(menu.get_pos().x + 10, menu.get_pos().y - 16), refs.accentclr:get())
        else
            ...
            render.text(pixel, "MEDUSA ", vec2_t(menu.get_pos().x + 10, menu.get_pos().y - 16), colorpickers.color_theme:get())
        end

        render.text(pixel, ".gg ", vec2_t(render.get_text_size(pixel, "MEDUSA").x + menu.get_pos().x + 10, menu.get_pos().y - 16), color_t(200,200,200, 255))
        render.text(pixel, anal_string, vec2_t(render.get_text_size(pixel, "medusa.gg ").x + menu.get_pos().x + 10, menu.get_pos().y - 16), color_t(255,255,255, 255))
    end
end
    ...
    if visual_f.indicators_check:get() then
        ...
        if visual_f.indicators_customisation:get(2) then
            if visual_f.indicators_customisation_bg:get(1) then
                render.rect_filled(vec2_t(screensize.x/2 + 6, screensize.y/2 + 11), vec2_t(render.get_text_size(pixel, "medusa").x + 5, render.get_text_size(pixel, "medusa").y - 3), (color_t(0,0,0, 188)))
                if visual_f.indicators_customisation_rect:get() then
                    if visual_f.color_theme_mode:get() == 1 then
                        render.rect_filled(vec2_t(screensize.x/2 + 4, screensize.y/2 + 11), vec2_t(2, render.get_text_size(pixel, "medusa").y - 3), colorpickers.color_theme:get())
                    else
                        render.rect_filled(vec2_t(screensize.x/2 + 4, screensize.y/2 + 11), vec2_t(2, render.get_text_size(pixel, "medusa").y - 3), refs.accentclr:get())
                    end
                end
            end
        end
        ...
        if visual_f.color_theme_mode:get() == 1 then
            if visual_f.indicators_customisation:get(4) then
                ...
                render.text(pixel, "medusa", vec2_t(screensize.x/2 + 8, screensize.y/2 + 10), color_t(colorpickers.color_theme:get().r, colorpickers.color_theme:get().g, colorpickers.color_theme:get().b, 255))
            end
        else
            if visual_f.indicators_customisation:get(4) then
                ...
                render.text(pixel, "medusa", vec2_t(screensize.x/2 + 8, screensize.y/2 + 10), color_t(refs.accentclr:get().r, refs.accentclr:get().g, refs.accentclr:get().b, 255))
            end
        end
...
local function watermarkcustom()
    if visual_f.windows_combo:get(1) then
        ...
        elseif visual_f.watermark_custom_watername:get() == 3 then
            wmname = "primordial | medusa"
        elseif visual_f.watermark_custom_watername:get() == 4 then
            wmname = visual_f.watermark_custom_custom:get() == "" and "medusa" or visual_f.watermark_custom_custom:get()
        end
...
local function keybinds()
    ...
    keybindings = {
        ...
        ["min damage"]                    = menu.find("aimbot", daun, "target overrides", "min. damage"),
        ["force lethal"]                  = menu.find("aimbot", daun, "target overrides", "lethal shot"),
        ["hitchance override"]            = menu.find("aimbot", daun, "target overrides", "hitchance"),
        ["force hitbox"]                  = menu.find("aimbot", daun, "target overrides", "hitbox"),
        ["force safepoint"]               = menu.find("aimbot", daun, "target overrides", "safepoint"),
        ["force body lean safepoint"]     = menu.find("aimbot", daun, "target overrides", "body lean safepoint"),
        ...
        ["autothrow"]                     = menu.find("misc","nade helper","autothrow"),
    }
...
local function infobox()
    ...
    if visual_f.infobox_check:get() then
        ...
        if visual_f.color_theme_mode:get() == 1 then
            ...
            render.text(pixel, "medusa.gg", vec2_t(screensize.x/20 - 50 + render.get_text_size(pixel, ">>> ").x, screensize.y/2.5 + 20), color_t(255, 255, 255, 255))
            render.text(pixel, "["..build.."]", vec2_t(screensize.x/20 - 50 + render.get_text_size(pixel, ">>> medusa.gg ").x, screensize.y/2.5 + 20), colorpickers.color_theme:get())
            ...
            render.text(pixel, "medusa.gg", vec2_t(screensize.x/20 - 50 + render.get_text_size(pixel, ">>> ").x, screensize.y/2.5 + 20), color_t(255, 255, 255, 255))
            render.text(pixel, "["..build.."]", vec2_t(screensize.x/20 - 50 + render.get_text_size(pixel, ">>> medusa.gg ").x, screensize.y/2.5 + 20), refs.accentclr:get())
