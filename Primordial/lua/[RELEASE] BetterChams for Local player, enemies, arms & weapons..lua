...
callbacks.add(e_callbacks.DRAW_MODEL, function(ctx)
   ...
   if arms_base_chams_master:get() and not ctx.model_name:find("w_models") and (ctx.model_name:find("arms") or ctx.model_name:find("sleeve")) then
   ...
   if (arms_overlay_chams_master:get(1) or arms_overlay_chams_master:get(2)) and not ctx.model_name:find("w_models") and (ctx.model_name:find("arms") or ctx.model_name:find("sleeve")) then
      if arms_chams_keep_original:get() then
          ctx:draw_original()
      end
   end

   if arms_overlay_chams_master:get(1) and not ctx.model_name:find("w_models") and (ctx.model_name:find("arms") or ctx.model_name:find("sleeve")) then
   ...
   if arms_overlay_chams_master:get(2) and not ctx.model_name:find("w_models") and (ctx.model_name:find("arms") or ctx.model_name:find("sleeve")) then
   ...
   if weapon_base_chams_master:get() and ctx.model_name:find("weapons/v_") and not ctx.model_name:find("arms") then
   ...
   if (weapon_overlay_chams_master:get(1) or weapon_overlay_chams_master:get(2)) and ctx.model_name:find("weapons/v_") and not ctx.model_name:find("arms") then
      if weapon_chams_keep_original:get() then
          ctx:draw_original()
      end
   end

   if weapon_overlay_chams_master:get(1) and ctx.model_name:find("weapons/v_") and not ctx.model_name:find("arms") then
   ...
   if weapon_overlay_chams_master:get(2) and ctx.model_name:find("weapons/v_") and not ctx.model_name:find("arms") then
   ...
   if local_base_chams_master:get() and ctx.model_name:find("models/player") then
   ...
   if (local_overlay_chams_master:get(1) or local_overlay_chams_master:get(2)) and ctx.model_name:find("models/player") then
      if ctx.entity == local_player then
   ...
   if local_overlay_chams_master:get(1) and ctx.model_name:find("models/player") then
      if ctx.entity == local_player then
   ...
   if local_overlay_chams_master:get(2) and ctx.model_name:find("models/player") then
      if ctx.entity == local_player then
