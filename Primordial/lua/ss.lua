--[[ UPDATED LOGS
      -new fonts 
      -fixed center texted message
]]--

client.log_screen('Humanity#4720.')
...
local function indicators()
    ...
    render.text(font_inds, "shadowsense", vec2_t(x + 2, y + 43), indi_color, true)
