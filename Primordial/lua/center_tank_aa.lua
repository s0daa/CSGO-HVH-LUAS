local jitter_center = menu.add_slider("group", "jitter center", -180, 180)
...
function on_antiaim(ctx)
    ...
    vars._jitter = jitter_center:get()
    ...
    side_stand:set(vars.val_n > 0 and 3 or 2)
    side_move:set(vars.val_n > 0 and 3 or 2)
    side_slowm:set(vars.val_n > 0 and 3 or 2)
