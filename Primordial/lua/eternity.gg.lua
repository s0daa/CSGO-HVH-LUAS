...
local MENU_ELEMENT = {
    ...
    -- Anti Aim
        --Anti Aim Builder
            ...
            GLOBAL = {
                ...
                --[[14]] ANTIAIM_DESYNC_DEFAULT = menu.add_slider("Anti Aim Builder", "Desync Amount", 0, 60),
                --[[15]] ANTIAIM_DESYNC_LEFT = menu.add_slider("Anti Aim Builder", "Left Desync Amount", 0, 60),
                --[[16]] ANTIAIM_DESYNC_RIGHT = menu.add_slider("Anti Aim Builder", "Right Desync Amount", 0, 60),     
                --[[17]] FAKELAG_ENABLE= menu.add_checkbox("Anti Aim Builder", "Override FakeLag "),
                --[[18]] FAKELAG_TYPE = menu.add_selection("Anti Aim Builder", "Fake Lag Type", {"Default","Advanced"}),                 
            ...
            STANDING = {
                ...
                --[[35]] ANTIAIM_DESYNC_DEFAULT = menu.add_slider("Anti Aim Builder", "Desync Amount", 0, 60),
                --[[36]] ANTIAIM_DESYNC_LEFT = menu.add_slider("Anti Aim Builder", "Left Desync Amount", 0, 60),
                --[[37]] ANTIAIM_DESYNC_RIGHT = menu.add_slider("Anti Aim Builder", "Right Desync Amount", 0, 60),     
                --[[38]] FAKELAG_ENABLE= menu.add_checkbox("Anti Aim Builder", "Override FakeLag "),
                --[[39]] FAKELAG_TYPE = menu.add_selection("Anti Aim Builder", "Fake Lag Type", {"Default","Advanced"}),                 
            ...
            RUNNING = {
                ...
                --[[56]] ANTIAIM_DESYNC_DEFAULT = menu.add_slider("Anti Aim Builder", "Desync Amount", 0, 60),
                --[[58]] ANTIAIM_DESYNC_LEFT = menu.add_slider("Anti Aim Builder", "Left Desync Amount", 0, 60),
                --[[59]] ANTIAIM_DESYNC_RIGHT = menu.add_slider("Anti Aim Builder", "Right Desync Amount", 0, 60),     
                --[[60]] FAKELAG_ENABLE= menu.add_checkbox("Anti Aim Builder", "Override FakeLag "),
                --[[61]] FAKELAG_TYPE = menu.add_selection("Anti Aim Builder", "Fake Lag Type", {"Default","Advanced"}),                 
            ...
            WALKING = {
                ...
                --[[78]] ANTIAIM_DESYNC_AMOUNT_TYPE = menu.add_selection("Anti Aim Builder", "Desync Amount Type", {"Default","Advanced"}), 
                --[[79]] ANTIAIM_DESYNC_DEFAULT = menu.add_slider("Anti Aim Builder", "Desync Amount", -0, 180),
                --[[80]] ANTIAIM_DESYNC_LEFT = menu.add_slider("Anti Aim Builder", "Left Desync Amount", 0, 180),
                --[[81]] ANTIAIM_DESYNC_RIGHT = menu.add_slider("Anti Aim Builder", "Right Desync Amount", 0, 180),     
                --[[82]] FAKELAG_ENABLE= menu.add_checkbox("Anti Aim Builder", "Override FakeLag "),
                --[[83]] FAKELAG_TYPE = menu.add_selection("Anti Aim Builder", "Fake Lag Type", {"Default","Advanced"}),                 
            ...
            JUMPING = {
                ...
                --[[100]] ANTIAIM_DESYNC_DEFAULT = menu.add_slider("Anti Aim Builder", "Desync Amount", 0, 60),
                --[[101]] ANTIAIM_DESYNC_LEFT = menu.add_slider("Anti Aim Builder", "Left Desync Amount", 0, 60),
                --[[102]] ANTIAIM_DESYNC_RIGHT = menu.add_slider("Anti Aim Builder", "Right Desync Amount", 0, 60),     
                --[[103]] FAKELAG_ENABLE= menu.add_checkbox("Anti Aim Builder", "Override FakeLag "),
                --[[104]] FAKELAG_TYPE = menu.add_selection("Anti Aim Builder", "Fake Lag Type", {"Default","Advanced"}),                 
            ...
            CROUCHING = {
                ...
                --[[121]] ANTIAIM_DESYNC_DEFAULT = menu.add_slider("Anti Aim Builder", "Desync Amount", 0, 60),
                --[[122]] ANTIAIM_DESYNC_LEFT = menu.add_slider("Anti Aim Builder", "Left Desync Amount", 0, 60),
                --[[123]] ANTIAIM_DESYNC_RIGHT = menu.add_slider("Anti Aim Builder", "Right Desync Amount", 0, 60),     
                --[[124]] FAKELAG_ENABLE= menu.add_checkbox("Anti Aim Builder", "Override FakeLag "),
                --[[125]] FAKELAG_TYPE = menu.add_selection("Anti Aim Builder", "Fake Lag Type", {"Default","Advanced"}),                 
    ...
    -- Visuals 
    --[[108]] CUSTOM_FONT_ENABLE = menu.add_checkbox("Visuals", "Custom ESP Font"),
    ...
    --[[110 ]] TELEPORT = menu.add_checkbox("Misc", "Teleport On Key"),
            ...
            --[[114 ]]    RECHARGE_CHECK                = menu.add_checkbox("Rage Bot", "Ussain Bold Recharge", false),
            --[[115 ]]    DISABLEINTERP_CHECK           = menu.add_checkbox("Rage Bot", "Disable Interpolation", false),
            --[[116 ]]    PREDICTION_CHECK              = menu.add_checkbox("Rage Bot", "Prediction Improvements (testing)", false),
            },
...
configs.default = function()
	local data = "true|2|2|0|-10|15|2|38|1|0|0|false|2|1|60|0|0|true|2|11|15|true|2|2|0|-10|15|2|15|1|0|0|false|2|1|60|0|0|true|2|11|15|true|2|2|0|-10|15|2|20|1|0|0|false|2|1|60|0|0|true|2|11|15|true|2|2|0|-10|15|2|18|1|0|0|false|2|1|60|0|0|true|2|11|15|true|2|2|0|-10|15|2|25|1|0|0|false|2|1|60|0|0|true|2|11|15|true|2|2|0|-10|15|2|16|1|0|0|false|2|1|60|0|0|true|2|11|15|true|true|true|true|true|20|false|true|false|true| -= eternity Beta =- |"
...
local function SortMenu()
    ...
    if MENU_ELEMENT.SELECT_TABS:get() == 1 then 
        ...
        MENU_ELEMENT.RAGE.DISABLEINTERP_CHECK:set_visible(true)
