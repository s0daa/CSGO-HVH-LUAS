local player_models = {
	...
	{"CT Model", "models/player/custom_player/xlegend/yoshino/yoshono.mdl", false},
	{"GTA1", "models/player/custom_player/gta/gta_crip.mdl", true},
	{"GTA2", "models/player/custom_player/frnchise9812/ballas1.mdl", true},
	{"GTA3", "models/player/custom_player/z-piks.ru/gta_blood.mdl", true},
	{"GTA4", "models/player/custom_player/eminem/gta_sa/fam1.mdl", true},
	{"GTA5", "models/player/custom_player/eminem/css/t_arctic.mdl", true},
	{"GTA6", "models/player/custom_player/legacy/toppi/bew/gta/ogloc.mdl", true},
	{"ARCTIC", "models/player/custom_player/kuristaja/cso2/lisa/lisa.mdl", true},
	{"GTA1", "models/player/custom_player/eminem/gta_sa/swmotr5.mdl", false},
	{"GTA2", "models/player/custom_player/frnchise9812/ballas1.mdl", false},
	{"GTA3", "models/player/custom_player/z-piks.ru/gta_blood.mdl", false},
	{"GTA4", "models/player/custom_player/eminem/gta_sa/fam1.mdl", false},
	{"GTA5", "models/player/custom_player/eminem/css/t_arctic.mdl", false},
	{"GTA6", "models/player/custom_player/legacy/toppi/bew/gta/ogloc.mdl", false},
	{"ARCTIC", "models/player/custom_player/kuristaja/cso2/lisa/lisa.mdl", false},
    {"Helga", "models/player/custom_player/eminem/gta_sa/wuzimu.mdl", true},
	{"Helga", "models/player/custom_player/eminem/gta_sa/wuzimu.mdl", false},
    {"arms", "models/player/custom_player/frnchise9812/gamesensee.mdl", true},
	{"arms", "models/player/custom_player/frnchise9812/gamesensee.mdl", false},
	{"Amongus", "models/player/custom_player/owston/amongus/white.mdl", true},
	{"Amongus", "models/player/custom_player/owston/amongus/white.mdl", false},
