...
for i = 1, 7 do
    Antiaim[i] = {
        ...
        Flickfake = menu.add_checkbox("Solace | Anti-aim", "["..pstates[i].."] Flick fake", false),
...
ApplyAntiaim = function()
    ...
    -- Set desync side value
    if Antiaim[state].Flickfake:get() then
      if Antiaim[state].DesyncSide:get() == 2 then
        refs.D_side:set(global_vars.server_tick() % 14 > 1 and 2 or 3)
      elseif Antiaim[state].DesyncSide:get() == 3 then
        refs.D_side:set(global_vars.server_tick() % 14 > 1 and 3 or 2)
      end
    end
    ...
    if math.abs(Distance) < 85 then
        ...
        if global_vars.real_time() - globals.time_since_shot >= 0 then
            ...
            if Antibrute[state].ABType:get() == 1 then
                ...
                globals.Yawadd = math.random(Antiaim[state].Yawadd:get() * 0.65, Antiaim[state].Yawadd:get() * 1.2)
                globals.Yawleft = math.random(Antiaim[state].Yawleft:get() * 0.65, Antiaim[state].Yawleft:get() * 1.2)
                globals.Yawright = math.random(-Antiaim[state].Yawright:get() * 0.65, -Antiaim[state].Yawright:get() * 1.2)
                globals.YawleftR = math.random(Antiaim[state].YawleftR:get() * 0.65, Antiaim[state].YawleftR:get() * 1.2)
                globals.YawrightR = math.random(Antiaim[state].YawrightR:get() * 0.65, Antiaim[state].YawrightR:get() * 1.2)
                globals.YRandomization = math.random(Antiaim[state].YRandomization:get() * 0.65, Antiaim[state].YRandomization:get() * 1.2)
                globals.YawAddSway = math.random(Antiaim[state].YawAddSway:get() * 0.65, Antiaim[state].YawAddSway:get() * 1.2)
                globals.SpinAmount = math.random(Antiaim[state].SpinAmount:get() * 0.65, Antiaim[state].SpinAmount:get() * 1.2)
                globals.TWYaw1 = math.random(Antiaim[state].TWYaw1:get() * 0.65, Antiaim[state].TWYaw1:get() * 1.2)
                globals.TWYaw2 = math.random(Antiaim[state].TWYaw2:get() * 0.65, Antiaim[state].TWYaw2:get() * 1.2)
                globals.TWYaw3 = math.random(Antiaim[state].TWYaw3:get() * 0.65, Antiaim[state].TWYaw3:get() * 1.2)
                globals.Jitteramount = math.random(Antiaim[state].Jitteramount:get() * 0.8, Antiaim[state].Jitteramount:get() * 1.2)
                globals.JitterL = math.random(Antiaim[state].JitterL:get() * 0.65, Antiaim[state].JitterL:get() * 1.2)
                globals.JitterR = math.random(Antiaim[state].JitterR:get() * 0.65, Antiaim[state].JitterR:get() * 1.2)
                globals.JitterLR = math.random(Antiaim[state].JitterLR:get() * 0.65, Antiaim[state].JitterLR:get() * 1.2)
                globals.JitterRR = math.random(Antiaim[state].JitterRR:get() * 0.65, Antiaim[state].JitterRR:get() * 1.2)
                globals.JRandomization = math.random(Antiaim[state].JRandomization:get() * 0.65, Antiaim[state].JRandomization:get() * 1.2)
            ...
            elseif Antibrute[state].ABType:get() == 3 then
                if closest_arm == "right" then
                    ...
                    globals.YawAddSway = math.random(Antiaim[state].YawAddSway:get() * 0.65, Antiaim[state].YawAddSway:get() * 1.2)
                    globals.SpinAmount = math.random(Antiaim[state].SpinAmount:get() * 0.65, Antiaim[state].SpinAmount:get() * 1.2)
                    globals.Jitteramount = math.random(Antiaim[state].Jitteramount:get() * 0.65, Antiaim[state].Jitteramount:get() * 1.2)
                    globals.JitterR = math.random(Antiaim[state].JitterR:get() * 0.65, Antiaim[state].JitterR:get() * 1.2)
                    globals.JitterRR = math.random(Antiaim[state].JitterRR:get() * 0.65, Antiaim[state].JitterRR:get() * 1.2)
                    globals.JRandomization = math.random(Antiaim[state].JRandomization:get() * 0.65, Antiaim[state].JRandomization:get() * 1.2)
...
local pixel = render.create_font("Smallest Pixel-7", 10, 1000, e_font_flags.OUTLINE, e_font_flags.BOLD)
...
for i = 1, 7 do
    ...
    Antiaim[i].Flickfake:set_visible(tab == 2 and selection == i and Antiaim[i].EnableAA:get() and Antiaim[i].DesyncSide:get() == 2 or Antiaim[i].DesyncSide:get() == 3)
...
exportaa = function()
    ...
    for state = 1, 7 do
        ...
        ..tostring(Antiaim[state].Flickfake:get()).."|"
...
importaa = function(input)
    ...
    local protected = function()
        ...
        for state = 1, 7 do
            Antiaim[state].EnableAA:set(to_boolean(tbl[1 + (30 * (state-1))]))
            Antiaim[state].Yawmode:set(tonumber(tbl[2 + (30 * (state-1))]))
            Antiaim[state].Yawadd:set(tonumber(tbl[3 + (30 * (state-1))]))
            Antiaim[state].Yawleft:set(tonumber(tbl[4 + (30 * (state-1))]))
            Antiaim[state].Yawright:set(tonumber(tbl[5 + (30 * (state-1))]))
            Antiaim[state].YawleftR:set(tonumber(tbl[6 + (30 * (state-1))]))
            Antiaim[state].YawrightR:set(tonumber(tbl[7 + (30 * (state-1))]))
            Antiaim[state].YRandomization:set(tonumber(tbl[8 + (30 * (state-1))]))
            Antiaim[state].YawAddSway:set(tonumber(tbl[9 + (30 * (state-1))]))
            Antiaim[state].SwaySpeed:set(tonumber(tbl[10 + (30 * (state-1))]))
            Antiaim[state].SpinAmount:set(tonumber(tbl[11 + (30 * (state-1))]))
            Antiaim[state].SpinSpeed:set(tonumber(tbl[12 + (30 * (state-1))]))
            Antiaim[state].TWYaw1:set(tonumber(tbl[13 + (30 * (state-1))]))
            Antiaim[state].TWYaw2:set(tonumber(tbl[14 + (30 * (state-1))]))
            Antiaim[state].TWYaw3:set(tonumber(tbl[15 + (30 * (state-1))]))
            Antiaim[state].Jittermode:set(tonumber(tbl[16 + (30 * (state-1))]))
            Antiaim[state].Jittertype:set(tonumber(tbl[17 + (30 * (state-1))]))
            Antiaim[state].Jitteramount:set(tonumber(tbl[18 + (30 * (state-1))]))
            Antiaim[state].JitterL:set(tonumber(tbl[19 + (30 * (state-1))]))
            Antiaim[state].JitterR:set(tonumber(tbl[20 + (30 * (state-1))]))
            Antiaim[state].JitterLR:set(tonumber(tbl[21 + (30 * (state-1))]))
            Antiaim[state].JitterRR:set(tonumber(tbl[22 + (30 * (state-1))]))
            Antiaim[state].JRandomization:set(tonumber(tbl[23 + (30 * (state-1))]))
            Antiaim[state].DesyncSide:set(tonumber(tbl[24 + (30 * (state-1))]))
            Antiaim[state].Flickfake:set(to_boolean(tbl[25 + (30 * (state-1))]))
            Antiaim[state].Desyncleft:set(tonumber(tbl[26 + (30 * (state-1))]))
            Antiaim[state].Desyncright:set(tonumber(tbl[27 + (30 * (state-1))]))
            Antibrute[state].EnableAB:set(to_boolean(tbl[28 + (30 * (state-1))]))
            Antibrute[state].ABTime:set(tonumber(tbl[29 + (30 * (state-1))]))
            Antibrute[state].ABType:set(tonumber(tbl[30 + (30 * (state-1))]))
        end
...
importdefaultaa = function(input)
    ...
    local protected = function()
        ...
        local input = ""
