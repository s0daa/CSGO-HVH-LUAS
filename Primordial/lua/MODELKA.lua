local player_models = {
	...
	{"gta_crip", "models/player/custom_player/z-piks.ru/gta_blood.mdl", true},
	{"gta_crip", "models/player/custom_player/z-piks.ru/gta_blood.mdl", false},
	{"2", "models/player/custom_player/eminem/css/t_leet_federal_prisoner/t_leet_federal_prisoner.mdl", true},
	{"2", "models/player/custom_player/eminem/css/t_leet_federal_prisoner/t_leet_federal_prisoner.mdl", false},
}
...
local safe_start = function(callback, func, callback_name)
    try(function() callbacks.add(callback, func) end, function(e) client.log_screen(color_t(255, 0, 0), "MODEL ERROR") print(e) end)
end
...
local function do_model_change()
	...
	if(model_index == nil and model_path ~= nil) then
		try(function() client.precache_model(model_path) end, function(e) end)
	end

	model_index_prev = model_index

	if model_index ~= nil then
		try(function() set_model_idx(player_ptr,model_index) end, function(e) end)
	end
end

--callbacks.add(e_callbacks.NET_UPDATE,do_model_change)
safe_start(e_callbacks.NET_UPDATE, do_model_change, "NET_UPDATE")
