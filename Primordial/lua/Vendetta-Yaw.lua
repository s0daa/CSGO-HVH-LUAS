-- coded by dominic-#0001, this is a source leak of my free lua Vendetta for Primordial
...
local ui = {
    --main
    welcome = menu.add_text("Vendetta | Information", "Thank you for using Vendetta.yaw!"),
    buildstate = menu.add_text("Vendetta | Information", string.format("Build State: %s", build)),
    selection_item = menu.add_selection("Vendetta | Information", "Current Tab:", {"Ragebot","Anti-aims", "Visuals", "Misc"}),

    FasterDoubletap = menu.add_checkbox("Vendetta | Ragebot", "Faster Doubletap", false),
    ClockCorrection = menu.add_checkbox("Vendetta | Ragebot", "Disable Clock Correction", false),
    saferecharge    = menu.add_checkbox("Vendetta | Ragebot", "Safe Recharge", false),
    AET             = menu.add_checkbox("Vendetta | Ragebot", "Quick Fall (Awp and Scout)", false),
    Delayshotfix    = menu.add_checkbox("Vendetta | Ragebot", "Delayshot Fix", false),
    customfakeping  = menu.add_checkbox("Vendetta | Ragebot", "Custom backtrack", false),
    fpamount  = menu.add_slider("Vendetta | Ragebot", "Custom backtrack amount", 0, 400),

    selection_presets = menu.add_selection("Vendetta | Anti-aims", "Anti-aim preset:", {"-","Avoidance Jitter", "Tank AA", "Safe head", "Conditional"}),
    selection_condition = menu.add_selection("Vendetta | Anti-aims", "Player state:", {"Standing", "Moving", "Slowwalk", "Crouch", "Air"}),

    Sseperator = menu.add_text("Vendetta | Anti-aims Standing", "|   Yaw Base   |"),
    Spitch = menu.add_selection("Vendetta | Anti-aims Standing", "Pitch:", {"None", "Down", "Up", "Zero", "Jitter"}),
    Syawmode = menu.add_selection("Vendetta | Anti-aims Standing", "Yaw mode", {"Static", "Jitter"}),
    Syawadd = menu.add_slider("Vendetta | Anti-aims Standing", "Yaw add", -180, 180),
    Syawaddleft = menu.add_slider("Vendetta | Anti-aims Standing", "Yaw jitter left", -180, 180),
    Syawaddright = menu.add_slider("Vendetta | Anti-aims Standing", "Yaw jitter right", -180, 180),
    Saw_base = menu.add_selection("Vendetta | Anti-aims Standing", "Yaw Base", {"View angle", "At-targets (crosshair)", "At-targets (distance)"}),
    Sseperator3 = menu.add_text("Vendetta | Anti-aims Standing", "| Yaw Modifier |"),
    Srotate = menu.add_checkbox("Vendetta | Anti-aims Standing", "Rotate", false),
    Srotaterange = menu.add_slider("Vendetta | Anti-aims Standing", "Rotate Range", 0, 360),
    Srotatespeed = menu.add_slider("Vendetta | Anti-aims Standing", "Rotate Speed", 0, 100),
    Sjittermode = menu.add_selection("Vendetta | Anti-aims Standing", "Jitter Mode:", {"None", "Static", "Random"}),
    Sjittertype = menu.add_selection("Vendetta | Anti-aims Standing", "Jitter Type:", {"Offset", "Center"}),
    Sjitteradd = menu.add_slider("Vendetta | Anti-aims Standing", "Jitter Amount", -180, 180),
    Sseperator5 = menu.add_text("Vendetta | Anti-aims Standing", "| Roll Angles |"),
    Sbodyleanmode = menu.add_selection("Vendetta | Anti-aims Standing", "Body Lean Mode:", {"None", "Static", "Static Jitter", "Random Jitter", "Sway"}),
    Sbodyleanamount = menu.add_slider("Vendetta | Anti-aims Standing", "Body Lean Amount:", -50, 50),
    Sbodyleanjitter = menu.add_slider("Vendetta | Anti-aims Standing", "Body Lean Jitter:", 0, 100),
    Sseperator7 = menu.add_text("Vendetta | Anti-aims Standing", "| Fake  Options |"),
    SD_side = menu.add_selection("Vendetta | Anti-aims Standing", "Desync Side:", {"None", "Left", "Right", "Jitter", "Peek Fake", "Peek Real", "Body Sway"}),
    Sfake_limit_left = menu.add_slider("Vendetta | Anti-aims Standing", "Fake limit left", 0, 100),
    Sfake_limit_right = menu.add_slider("Vendetta | Anti-aims Standing", "Fake limit right", 0, 100),
    SAntibrute = menu.add_checkbox("Vendetta | Anti-aims Standing", "Anti-Bruteforce", false),
    SOn_shot = menu.add_selection("Vendetta | Anti-aims Standing", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Sseperator9 = menu.add_text("Vendetta | Anti-aims Standing", "| Fake lag |"),
    Sfakelag_limit = menu.add_slider("Vendetta | Anti-aims Standing", "Fake Lag Amount", 1, 15),

    Mseperator = menu.add_text("Vendetta | Anti-aims Moving", "|   Yaw Base   |"),
    Mpitch = menu.add_selection("Vendetta | Anti-aims Moving", "Pitch:", {"None", "Down", "Up", "Zero", "Jitter"}),
    Myawmode = menu.add_selection("Vendetta | Anti-aims Moving", "Yaw mode", {"Static", "Jitter"}),
    Myawadd = menu.add_slider("Vendetta | Anti-aims Moving", "Yaw add", -180, 180),
    Myawaddleft = menu.add_slider("Vendetta | Anti-aims Moving", "Yaw jitter left", -180, 180),
    Myawaddright = menu.add_slider("Vendetta | Anti-aims Moving", "Yaw jitter right", -180, 180),
    Maw_base = menu.add_selection("Vendetta | Anti-aims Moving", "Yaw Base", {"View angle", "At-targets (crosshair)", "At-targets (distance)"}),
    Mseperator3 = menu.add_text("Vendetta | Anti-aims Moving", "| Yaw Modifier |"),
    Mrotate = menu.add_checkbox("Vendetta | Anti-aims Moving", "Rotate", false),
    Mrotaterange = menu.add_slider("Vendetta | Anti-aims Moving", "Rotate Range", 0, 360),
    Mrotatespeed = menu.add_slider("Vendetta | Anti-aims Moving", "Rotate Speed", 0, 100),
    Mjittermode = menu.add_selection("Vendetta | Anti-aims Moving", "Jitter Mode:", {"None", "Static", "Random"}),
    Mjittertype = menu.add_selection("Vendetta | Anti-aims Moving", "Jitter Type:", {"Offset", "Center"}),
    Mjitteradd = menu.add_slider("Vendetta | Anti-aims Moving", "Jitter Amount", -180, 180),
    Mseperator5 = menu.add_text("Vendetta | Anti-aims Moving", "| Roll Angles |"),
    Mbodyleanmode = menu.add_selection("Vendetta | Anti-aims Moving", "Body Lean Mode:", {"None", "Static", "Static Jitter", "Random Jitter", "Sway"}),
    Mbodyleanamount = menu.add_slider("Vendetta | Anti-aims Moving", "Body Lean Amount:", -50, 50),
    Mbodyleanjitter = menu.add_slider("Vendetta | Anti-aims Moving", "Body Lean Jitter:", 0, 100),
    MAseperator7 = menu.add_text("Vendetta | Anti-aims Moving", "| Fake  Options |"),
    MD_side = menu.add_selection("Vendetta | Anti-aims Moving", "Desync Side:", {"None", "Left", "Right", "Jitter", "Peek Fake", "Peek Real", "Body Sway"}),
    Mfake_limit_left = menu.add_slider("Vendetta | Anti-aims Moving", "Fake limit left", 0, 100),
    Mfake_limit_right = menu.add_slider("Vendetta | Anti-aims Moving", "Fake limit right", 0, 100),
    MAntibrute = menu.add_checkbox("Vendetta | Anti-aims Moving", "Anti-Bruteforce", false),
    MOn_shot = menu.add_selection("Vendetta | Anti-aims Moving", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Mseperator9 = menu.add_text("Vendetta | Anti-aims Moving", "| Fake lag |"),
    Mfakelag_limit = menu.add_slider("Vendetta | Anti-aims Moving", "Fake Lag Amount", 1, 15),
   
    SLseperator = menu.add_text("Vendetta | Anti-aims Slowwalk", "|   Yaw Base   |"),
    SLpitch = menu.add_selection("Vendetta | Anti-aims Slowwalk", "Pitch:", {"None", "Down", "Up", "Zero", "Jitter"}),
    SLyawmode = menu.add_selection("Vendetta | Anti-aims Slowwalk", "Yaw mode", {"Static", "Jitter"}),
    SLyawadd = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Yaw add", -180, 180),
    SLyawaddleft = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Yaw jitter left", -180, 180),
    SLyawaddright = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Yaw jitter right", -180, 180),
    SLaw_base = menu.add_selection("Vendetta | Anti-aims Slowwalk", "Yaw Base", {"View angle", "At-targets (crosshair)", "At-targets (distance)"}),
    SLseperator3 = menu.add_text("Vendetta | Anti-aims Slowwalk", "| Yaw Modifier |"),
    SLrotate = menu.add_checkbox("Vendetta | Anti-aims Slowwalk", "Rotate", false),
    SLrotaterange = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Rotate Range", 0, 360),
    SLrotatespeed = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Rotate Speed", 0, 100),
    SLjittermode = menu.add_selection("Vendetta | Anti-aims Slowwalk", "Jitter Mode:", {"None", "Static", "Random"}),
    SLjittertype = menu.add_selection("Vendetta | Anti-aims Slowwalk", "Jitter Type:", {"Offset", "Center"}),
    SLjitteradd = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Jitter Amount", -180, 180),
    SLseperator5 = menu.add_text("Vendetta | Anti-aims Slowwalk", "| Roll Angles |"),
    SLbodyleanmode = menu.add_selection("Vendetta | Anti-aims Slowwalk", "Body Lean Mode:", {"None", "Static", "Static Jitter", "Random Jitter", "Sway"}),
    SLbodyleanamount = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Body Lean Amount:", -50, 50),
    SLbodyleanjitter = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Body Lean Jitter:", 0, 100),
    SLseperator7 = menu.add_text("Vendetta | Anti-aims Slowwalk", "| Fake  Options |"),
    SLD_side = menu.add_selection("Vendetta | Anti-aims Slowwalk", "Desync Side:", {"None", "Left", "Right", "Jitter", "Peek Fake", "Peek Real", "Body Sway"}),
    SLfake_limit_left = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Fake limit left", 0, 100),
    SLfake_limit_right = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Fake limit right", 0, 100),
    SLAntibrute = menu.add_checkbox("Vendetta | Anti-aims Slowwalk", "Anti-Bruteforce", false),
    SLOn_shot = menu.add_selection("Vendetta | Anti-aims Slowwalk", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    SLseperator9 = menu.add_text("Vendetta | Anti-aims Slowwalk", "| Fake lag |"),
    SLfakelag_limit = menu.add_slider("Vendetta | Anti-aims Slowwalk", "Fake Lag Amount", 1, 15),

    Cseperator = menu.add_text("Vendetta | Anti-aims Crouch", "|   Yaw Base   |"),
    Cpitch = menu.add_selection("Vendetta | Anti-aims Crouch", "Pitch:", {"None", "Down", "Up", "Zero", "Jitter"}),
    Cyawmode = menu.add_selection("Vendetta | Anti-aims Crouch", "Yaw mode", {"Static", "Jitter"}),
    Cyawadd = menu.add_slider("Vendetta | Anti-aims Crouch", "Yaw add", -180, 180),
    Cyawaddleft = menu.add_slider("Vendetta | Anti-aims Crouch", "Yaw jitter left", -180, 180),
    Cyawaddright = menu.add_slider("Vendetta | Anti-aims Crouch", "Yaw jitter right", -180, 180),
    Caw_base = menu.add_selection("Vendetta | Anti-aims Crouch", "Yaw Base", {"View angle", "At-targets (crosshair)", "At-targets (distance)"}),
    Cseperator3 = menu.add_text("Vendetta | Anti-aims Crouch", "| Yaw Modifier |"),
    Crotate = menu.add_checkbox("Vendetta | Anti-aims Crouch", "Rotate", false),
    Crotaterange = menu.add_slider("Vendetta | Anti-aims Crouch", "Rotate Range", 0, 360),
    Crotatespeed = menu.add_slider("Vendetta | Anti-aims Crouch", "Rotate Speed", 0, 100),
    Cjittermode = menu.add_selection("Vendetta | Anti-aims Crouch", "Jitter Mode:", {"None", "Static", "Random"}),
    Cjittertype = menu.add_selection("Vendetta | Anti-aims Crouch", "Jitter Type:", {"Offset", "Center"}),
    Cjitteradd = menu.add_slider("Vendetta | Anti-aims Crouch", "Jitter Amount", -180, 180),
    Cseperator5 = menu.add_text("Vendetta | Anti-aims Crouch", "| Roll Angles |"),
    Cbodyleanmode = menu.add_selection("Vendetta | Anti-aims Crouch", "Body Lean Mode:", {"None", "Static", "Static Jitter", "Random Jitter", "Sway"}),
    Cbodyleanamount = menu.add_slider("Vendetta | Anti-aims Crouch", "Body Lean Amount:", -50, 50),
    Cbodyleanjitter = menu.add_slider("Vendetta | Anti-aims Crouch", "Body Lean Jitter:", 0, 100),
    Cseperator7 = menu.add_text("Vendetta | Anti-aims Crouch", "| Fake  Options |"),
    CD_side = menu.add_selection("Vendetta | Anti-aims Crouch", "Desync Side:", {"None", "Left", "Right", "Jitter", "Peek Fake", "Peek Real", "Body Sway"}),
    Cfake_limit_left = menu.add_slider("Vendetta | Anti-aims Crouch", "Fake limit left", 0, 100),
    Cfake_limit_right = menu.add_slider("Vendetta | Anti-aims Crouch", "Fake limit right", 0, 100),
    CAntibrute = menu.add_checkbox("Vendetta | Anti-aims Crouch", "Anti-Bruteforce", false),
    COn_shot = menu.add_selection("Vendetta | Anti-aims Crouch", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Cseperator9 = menu.add_text("Vendetta | Anti-aims Crouch", "| Fake lag |"),
    Cfakelag_limit = menu.add_slider("Vendetta | Anti-aims Crouch", "Fake Lag Amount", 1, 15),
       
    Aseperator = menu.add_text("Vendetta | Anti-aims Air", "|   Yaw Base   |"),
    Apitch = menu.add_selection("Vendetta | Anti-aims Air", "Pitch:", {"None", "Down", "Up", "Zero", "Jitter"}),
    Ayawmode = menu.add_selection("Vendetta | Anti-aims Air", "Yaw mode", {"Static", "Jitter"}),
    Ayawadd = menu.add_slider("Vendetta | Anti-aims Air", "Yaw add", -180, 180),
    Ayawaddleft = menu.add_slider("Vendetta | Anti-aims Air", "Yaw jitter left", -180, 180),
    Ayawaddright = menu.add_slider("Vendetta | Anti-aims Air", "Yaw jitter right", -180, 180),
    Aaw_base = menu.add_selection("Vendetta | Anti-aims Air", "Yaw Base", {"View angle", "At-targets (crosshair)", "At-targets (distance)"}),
    Aseperator3 = menu.add_text("Vendetta | Anti-aims Air", "| Yaw Modifier |"),
    Arotate = menu.add_checkbox("Vendetta | Anti-aims Air", "Rotate", false),
    Arotaterange = menu.add_slider("Vendetta | Anti-aims Air", "Rotate Range", 0, 360),
    Arotatespeed = menu.add_slider("Vendetta | Anti-aims Air", "Rotate Speed", 0, 100),
    Ajittermode = menu.add_selection("Vendetta | Anti-aims Air", "Jitter Mode:", {"None", "Static", "Random"}),
    Ajittertype = menu.add_selection("Vendetta | Anti-aims Air", "Jitter Type:", {"Offset", "Center"}),
    Ajitteradd = menu.add_slider("Vendetta | Anti-aims Air", "Jitter Amount", -180, 180),
    Aseperator5 = menu.add_text("Vendetta | Anti-aims Air", "| Roll Angles |"),
    Abodyleanmode = menu.add_selection("Vendetta | Anti-aims Air", "Body Lean Mode:", {"None", "Static", "Static Jitter", "Random Jitter", "Sway"}),
    Abodyleanamount = menu.add_slider("Vendetta | Anti-aims Air", "Body Lean Amount:", -50, 50),
    Abodyleanjitter = menu.add_slider("Vendetta | Anti-aims Air", "Body Lean Jitter:", 0, 100),
    Aseperator7 = menu.add_text("Vendetta | Anti-aims Air", "| Fake  Options |"),
    AD_side = menu.add_selection("Vendetta | Anti-aims Air", "Desync Side:", {"None", "Left", "Right", "Jitter", "Peek Fake", "Peek Real", "Body Sway"}),
    Afake_limit_left = menu.add_slider("Vendetta | Anti-aims Air", "Fake limit left", 0, 100),
    Afake_limit_right = menu.add_slider("Vendetta | Anti-aims Air", "Fake limit right", 0, 100),
    AAntibrute = menu.add_checkbox("Vendetta | Anti-aims Air", "Anti-Bruteforce", false),
    AOn_shot = menu.add_selection("Vendetta | Anti-aims Air", "On-shot:", {"Off", "Opposite", "Same Side", "Random"}),
    Aseperator9 = menu.add_text("Vendetta | Anti-aims Air", "| Fake lag |"),
    Afakelag_limit = menu.add_slider("Vendetta | Anti-aims Air", "Fake Lag Amount", 1, 15),

    --visuals

    Colortxt = menu.add_text("Vendetta | Visuals", "Main color"),
    manualarrows = menu.add_selection("Vendetta | Visuals", "Manual Arrows", {"-", "Modern", "Classic"}),
    indicatorsmain = menu.add_selection("Vendetta | Visuals", "Indicators:", {"-", "Modern", "Classic"}),
    vendettaUI = menu.add_multi_selection("Vendetta | Visuals", "Vendetta UI", {"Watermark", "Keybinds", "Spectators", "State Panel"}),
    kibitmarker = menu.add_checkbox("Vendetta | Visuals", "Kibit Marker", on_paint),

    --misc
    clientside_animations = menu.add_multi_selection("Vendetta | Misc", "Clientside animations", {"Reversed legs", "Static legs in air", "Lean when running", "Pitch 0 on land"}),
    clantag = menu.add_checkbox("Vendetta | Misc", "Clantag"),
    killsay = menu.add_checkbox("Vendetta | Misc", "Killsay"),

    welcome = menu.add_text("Vendetta | Hidden", "Dragging is broken right now, use these sliders. Sorry"),
}
local clicked = {
    keybind = false,
    spectator = false,
...
local lua_offsets = {
    keybind = {
        x = menu.add_slider("Vendetta | Hidden", "keybind.x", 10, screensize.x),
        y = menu.add_slider("Vendetta | Hidden", "keybind.y", 0, screensize.y),
        modes = {"[toggled]", "[hold]", "[on]", "[on]","[off]"},
        alpha = 0,
        size = 160,
    },
    spectator = {
        x = menu.add_slider("Vendetta | Hidden", "spectators_x", 10, screensize.x),
        y = menu.add_slider("Vendetta | Hidden", "spectators_y", 0, screensize.y),
        alpha = 0,
        list = {},
        size = 140,
    },
    panel = {
        x = menu.add_slider("Vendetta | Hidden", "panels_x", 10, screensize.x),
        y = menu.add_slider("Vendetta | Hidden", "panels_y", 0, screensize.y),
        alpha = 0,
        size = 140,
    },
}
...
menu.add_text("Vendetta | Information","")
menu.add_text("Vendetta | Information","")
menu.add_button("Vendetta | Information", "Load Default Config", function()

---- ragebot
    ui.customfakeping:set(true)
    ui.fpamount:set(275)
---- antiaim
    ui.selection_presets:set(2)
---- visuals
    ui.manualarrows:set(2)
    ui.indicatorsmain:set(3)
    ui.vendettaUI:set(1, true)
    ui.vendettaUI:set(2, true)
    ui.vendettaUI:set(3, true)
    ui.vendettaUI:set(4, true)
...
local function on_hitscan(ctx, cmd, unpredicted_data)
    ...
    if getweapon() == "glock" or getweapon() == "p250" or getweapon() == "cz75a" or getweapon() == "usp-s" or getweapon() == "tec9" or getweapon() == "p2000" or getweapon() == "fiveseven" or getweapon() == "elite" then
        ctx:set_damage_accuracy(75, e_hitscan_groups.HEAD)
        ctx:set_damage_accuracy(75, e_hitscan_groups.STOMACH)
        ctx:set_damage_accuracy(75, e_hitscan_groups.CHEST)
        ctx:set_damage_accuracy(40, e_hitscan_groups.ARMS)
        ctx:set_damage_accuracy(40, e_hitscan_groups.LEGS)
        ctx:set_hitchance(36, e_hitscan_groups.HEAD)
        ctx:set_hitchance(25, e_hitscan_groups.ARMS)
    end

if getweapon() == "ssg08" then
    ctx:set_damage_accuracy(40, e_hitscan_groups.HEAD)
    ctx:set_damage_accuracy(70, e_hitscan_groups.STOMACH)
    ctx:set_damage_accuracy(70, e_hitscan_groups.CHEST)
    ctx:set_damage_accuracy(40, e_hitscan_groups.ARMS)
    ctx:set_damage_accuracy(40, e_hitscan_groups.LEGS)
    ctx:set_hitchance(35, e_hitscan_groups.HEAD)
end

elseif getweapon() == "ssg08" and primordial.isAP[2]:get() then
    ctx:set_damage_accuracy(60, e_hitscan_groups.HEAD)
    ctx:set_damage_accuracy(40, e_hitscan_groups.ARMS)
    ctx:set_hitchance(35, e_hitscan_groups.HEAD)
    ctx:set_hitchance(20, e_hitscan_groups.ARMS)
end

    if getweapon() == "scar20" or getweapon() == "g3sg1" then
            ctx:set_damage_accuracy(120, e_hitscan_groups.HEAD)
            ctx:set_damage_accuracy(60, e_hitscan_groups.STOMACH)
            ctx:set_damage_accuracy(60, e_hitscan_groups.CHEST)
            ctx:set_damage_accuracy(30, e_hitscan_groups.ARMS)
            ctx:set_damage_accuracy(30, e_hitscan_groups.LEGS)
            ctx:set_hitchance(40, e_hitscan_groups.HEAD)
            ctx:set_hitchance(36, e_hitscan_groups.STOMACH)
            ctx:set_hitchance(36, e_hitscan_groups.CHEST)
            ctx:set_hitchance(28, e_hitscan_groups.ARMS)
            ctx:set_hitchance(28, e_hitscan_groups.LEGS)
            ctx:set_hitchance(25, e_hitscan_groups.FEET)
            ctx:set_hitscan_group_state(e_hitscan_groups.HEAD, true, true) 
            ...
            ctx:set_hitscan_group_state(e_hitscan_groups.ARMS, true, true)
            ctx:set_hitscan_group_state(e_hitscan_groups.LEGS, true, true)
            ctx:set_hitscan_group_state(e_hitscan_groups.FEET, true, true)
        end
    end
...
local function Visuals_indic()
    ...
    if ui.manualarrows:get() == 3 and local_player:is_alive() then
    ...
    if ui.manualarrows:get() == 2 and local_player:is_alive() then
        render.text(Acta, "g", vec2_t(x2 - 37, y2-7), color_t(0, 0, 0, 165), -90)
        render.text(Acta, "h", vec2_t(x2 + 20, y2-7), color_t(0, 0, 0, 165), 90)

        if antiaim.get_manual_override() == 1 then
            render.text(Acta, "g", vec2_t(x2 - 37, y2-7), color_t(color_acc:get().r, color_acc:get().g, color_acc:get().b, alpha), -90)
        end
       
        if antiaim.get_manual_override() == 3 then
            render.text(Acta, "h", vec2_t(x2 + 20, y2-7), color_t(color_acc:get().r, color_acc:get().g, color_acc:get().b, alpha), 90)
        end
    end
    ...
    if ui.indicatorsmain:get() == 2 and local_player:is_alive() then
        ...
        render.text(pixel, "Vendetta", vec2_t(x + offset_scope + 18, y+ay), color_t(color_acc:get().r, color_acc:get().g, color_acc:get().b, 255), true, true)
        render.text(pixel, "Yaw", vec2_t(x + offset_scope + 45, y+ay), color_t(255, 255, 255, 255), true, true)
        render.text(pixel, "ULTIMATE", vec2_t(x+offset_scope+25, y+ay-10),color_t(255, 255, 255, alpha), false, true)
        ay = ay + 10

        render.rect_fade(vec2_t(x + offset_scope + 0, y+ay-5), vec2_t(50, 4), color_t(118,161,219, 255), color_t(20,33,49, 255), true)
        render.rect(vec2_t(x + offset_scope + 0, y+ay-5), vec2_t(50, 5), color_t(0,0,0, 255))
        ...
        if exploits.get_charge() >= 1 then
            render.text(pixel, "Rapid", vec2_t(x + 25 + offset_scope, y+ay+5), color_t(255, 255, 255, 255), true, true)
            ay = ay + 9
        end
        if exploits.get_charge() < 1 then
            render.text(pixel, "Rapid", vec2_t(x + 25 + offset_scope, y+ay+5), color_t(255, 0, 0, 255), true, true)
            ay = ay + 9
        end
    end
        ...
        if primordial.isHS[2]:get() then
            render.text(pixel, "OS-AA", vec2_t(x + 25 + offset_scope, y+ay+5), color_t(250, 173, 181, 255), true, true)
            ay = ay + 10
        end
    
        if primordial.ping_spike:get() then
            render.text(pixel, "PING", vec2_t(x + 25 + offset_scope, y+ay+5), color_t(115, 206, 108, 255), true, true)
            ay = ay + 10
        end
    end

    if ui.indicatorsmain:get() == 3 and local_player:is_alive() then
        local eternal_ts = render.get_text_size(pixel, "Vendetta")
        render.text(pixel, "Vendetta", vec2_t(x + 13 + offset_scope, y+ay), color_t(255, 255, 255, 255), true, true)
        render.text(pixel, build, vec2_t(x+eternal_ts.x-2 + 10 + offset_scope, y+ay),color_t(color_acc:get().r, color_acc:get().g, color_acc:get().b, alpha), false, true)
        ay = ay + 10
        ...
        render.text(pixel, current_state, vec2_t(x + offset_scope + 25, y+ay), clr0, true, true)
        ay = ay + 9
   
        local asadsa = math.min(math.floor(math.sin((exploits.get_charge()%2) * 1) * 122), 100)
        if primordial.isDT[2]:get() then
        if exploits.get_charge() >= 1 then
            render.text(pixel, "DT", vec2_t(x + offset_scope + 25, y+ay), color_t(0, 255, 0, 255), true, true)
            ay = ay + 9
        end
        if exploits.get_charge() < 1 then
            render.text(pixel, "DT", vec2_t(x + offset_scope + 25, y+ay), color_t(255, 0, 0, 255), true, true)
            ay = ay + 9
        end
        end
        ...
        local ax = 0
        if primordial.isHS[2]:get() then
            render.text(pixel, "OS", vec2_t(x + offset_scope + 25, y+ay), color_t(250, 173, 181, 255), true, true)
            ay = ay + 10
        end
    end
end
...
---------------- start of vendetta UI

local function watermark()
    local color = color_acc()
    if not ui.vendettaUI:get(1) then return end
    local screensize = render.get_screen_size()
    local h, m, s = client.get_local_time()
    local color =  color_acc:get()
    local text1 = string.format("Vendetta [%s] /", build)
    ...
    render.rect_filled(vec2_t(screensize.x-wtm_size.x-19, 8), vec2_t(wtm_size.x+12, 20), color_t(15,15,15,200), 5)
    render.rect(vec2_t(screensize.x-wtm_size.x-19, 7), vec2_t(wtm_size.x+12, 20), color, 6)

    render.text(verdana, text1, vec2_t(screensize.x-wtm_size.x-11, 11), color_t(255,255,255,255))
    render.text(verdana, text2, vec2_t(screensize.x-wtm_size.x+wtm_size1.x-11, 11), color_t(255,255,255,255))
    render.text(verdana, text3, vec2_t(screensize.x-wtm_size.x+wtm_size1.x+wtm_size2.x-11, 11), color_t(255,255,255,255))
    render.text(verdana, text4, vec2_t(screensize.x-wtm_size.x+wtm_size1.x+wtm_size2.x+wtm_size3.x-11, 11), color_t(255,255,255,255))
    render.text(verdana, text5, vec2_t(screensize.x-wtm_size.x+wtm_size1.x+wtm_size2.x+wtm_size3.x+wtm_size4.x-11, 11), color_t(255,255,255,255))
    render.text(verdana, text6, vec2_t(screensize.x-wtm_size.x+wtm_size1.x+wtm_size2.x+wtm_size3.x+wtm_size4.x+wtm_size5.x-11, 11), color_t(255,255,255,255))
    render.text(verdana, text7, vec2_t(screensize.x-wtm_size.x+wtm_size1.x+wtm_size2.x+wtm_size3.x+wtm_size4.x+wtm_size5.x+wtm_size6.x-11, 11), color_t(255,255,255,255))
    render.text(verdana, text8, vec2_t(screensize.x-wtm_size.x+wtm_size1.x+wtm_size2.x+wtm_size3.x+wtm_size4.x+wtm_size5.x+wtm_size6.x+wtm_size7.x-11, 11), color_t(255,255,255,255))
end

-- keybinds
local function keybinds()
    local color = color_acc()
    if not ui.vendettaUI:get(2) or not entity_list.get_local_player() then return end
...
local function spectators()
    ...
    local color = color_acc()
    if not ui.vendettaUI:get(3) or not entity_list.get_local_player() then return end
    local mousepos = input.get_mouse_pos()
...
local function panel()
    local color = color_acc()
    if not ui.vendettaUI:get(4) or not entity_list.get_local_player() then return end
    local mousepos = input.get_mouse_pos()
    if lua_offsets.panel.show or menu.is_open() then
        lua_offsets.panel.alpha = lua_offsets.panel.alpha > 254 and 255 or lua_offsets.panel.alpha + 15
    else
        lua_offsets.panel.alpha = lua_offsets.panel.alpha < 254 and 255 or lua_offsets.panel.alpha - 15
    end
   
    render.push_alpha_modifier(lua_offsets.panel.alpha/255)

    local mouse = input.get_mouse_pos()
    local hovered = item_button(vector2(lua_offsets.panel.x:get(),lua_offsets.panel.y:get()),vector2(lua_offsets.panel.x:get()+146,lua_offsets.panel.y:get()+19))
    if hovered and not clicked.panel and not clicked.panel and not clicked.panel and input.is_key_pressed(e_keys.MOUSE_LEFT) and menu.is_open() then
        clicked.panel = true
    elseif clicked.panel and input.is_key_held(e_keys.MOUSE_LEFT) and menu.is_open() then
        lua_offsets.panel.x:set(mouse.x-item_offsets.panel.x)
        lua_offsets.panel.y:set(mouse.y-item_offsets.panel.y)
    else
        clicked.panel = false
        item_offsets.panel.x = mouse.x-lua_offsets.panel.x:get()
        item_offsets.panel.y = mouse.y-lua_offsets.panel.y:get()
    end

    render.rect_filled(vec2_t(lua_offsets.panel.x:get() - 3, lua_offsets.panel.y:get()+8), vec2_t(lua_offsets.panel.size+30, 40), color_t(15,15,15,200), 5)
    render.rect(vec2_t(lua_offsets.panel.x:get() - 3, lua_offsets.panel.y:get()+7), vec2_t(lua_offsets.panel.size+30, 40), color, 6)

    render.text(verdana, "» Vendetta anti-aim technology", vec2_t(lua_offsets.panel.x:get()+lua_offsets.panel.size/1.7, lua_offsets.panel.y:get()+16.5), color_t(255,255,255,255), true)
    render.text(verdana, "» User: " .. user.name .."", vec2_t(lua_offsets.panel.x:get()+lua_offsets.panel.size/3.55, lua_offsets.panel.y:get()+27), color_t(255,255,255,255), true)
    render.text(verdana, "» Build: " .. build .. "", vec2_t(lua_offsets.panel.x:get()+lua_offsets.panel.size/4.1, lua_offsets.panel.y:get()+39), color_t(255,255,255,255), true)
    end
...
local function on_antiaim(ctx)
    ...
    elseif presetsc == 4 then
        if globals.jumping then
            ...
            primordial.jittermode:set(2)
            primordial.jittertype:set(2)
            primordial.jitteradd:set(math.random(3, 7))
            primordial.bodyleanmode:set(0)
            primordial.bodyleanamount:set(0)
            primordial.bodyleanjitter:set(0)
            primordial.leftamount:set(100)
        ...
        elseif globals.crouching then
            ...
            primordial.jittermode:set(2)
            primordial.jittertype:set(2)
            primordial.jitteradd:set(math.random(8, 13))
            primordial.bodyleanmode:set(0)
            primordial.bodyleanamount:set(0)
            primordial.bodyleanjitter:set(0)
            primordial.leftamount:set(100)
        ...
        elseif primordial.slowwalk_key:get() then
            ...
            primordial.jittermode:set(3)
            primordial.jittertype:set(1)
            primordial.jitteradd:set(math.random(5, 7))
            primordial.bodyleanmode:set(0)
            primordial.bodyleanamount:set(0)
            primordial.bodyleanjitter:set(0)
            primordial.leftamount:set(math.random(60, 100))
            primordial.rightamount:set(math.random(84,90))
            primordial.yawadd:set(0)
            primordial.Antibrute:set(true)
            primordial.aw_base:set(3)
            primordial.on_shot:set(4)
        ...
        elseif globals.running then
            ...
            primordial.jittermode:set(2)
            primordial.jittertype:set(2)
            primordial.jitteradd:set(math.random(7, 13))
            primordial.bodyleanmode:set(0)
            primordial.bodyleanamount:set(0)
            primordial.bodyleanjitter:set(0)
            primordial.leftamount:set(math.random(88, 100))
            primordial.rightamount:set(math.random(68, 100))
            primordial.yawadd:set(math.random(-3, 3))
            primordial.aw_base:set(3)
            primordial.Antibrute:set(false)
            primordial.on_shot:set(2)
            primordial.D_side:set(4)
        ...
        elseif globals.standing then
            ...
            primordial.jittermode:set(2)
            primordial.jittertype:set(2)
            primordial.jitteradd:set(math.random(0, 0))
            primordial.bodyleanmode:set(0)
            primordial.bodyleanamount:set(0)
            primordial.bodyleanjitter:set(0)
            primordial.leftamount:set(math.random(92, 100))
            primordial.rightamount:set(math.random(88, 100))
            primordial.yawadd:set(0)
            primordial.aw_base:set(3)
            primordial.Antibrute:set(false)
            primordial.on_shot:set(2)
   ...
   cfg_import = menu.add_button("Vendetta | Anti-aims", "Import Config From Clipboard", function() configs.import() end)
   cfg_export = menu.add_button("Vendetta | Anti-aims", "Export Config To Clipboard", function() configs.export() end)
...
local function draw_menu()
    if not show then
      --  text_input_item:set_visible(false)
        menu.set_group_visibility("Vendetta | Information", true)
        ...
        antia = false
        menu.set_group_column("Vendetta | Information", 2)
        ...
        if menu_val == 2 then
            ...
            if selection_presets == 5 then
                ...
                if  menu_conditiom == 1 then
                    menu.set_group_column("Vendetta | Anti-aims Standing", 1)
                    menu.set_group_visibility("Vendetta | Anti-aims Standing", true)
                    menu.set_group_visibility("Vendetta | Anti-aims Moving", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Crouch", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Air", false)

                   
                elseif  menu_conditiom == 2 then
                    menu.set_group_column("Vendetta | Anti-aims Moving", 1)
                    menu.set_group_visibility("Vendetta | Anti-aims Standing", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Moving", true)
                    menu.set_group_visibility("Vendetta | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Crouch", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Air", false)
                ...
                elseif  menu_conditiom == 3 then
                    menu.set_group_column("Vendetta | Anti-aims Slowwalk", 1)
                    menu.set_group_visibility("Vendetta | Anti-aims Standing", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Moving", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Slowwalk", true)
                    menu.set_group_visibility("Vendetta | Anti-aims Crouch", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Air", false)

                   
                elseif  menu_conditiom == 4 then
                    menu.set_group_column("Vendetta | Anti-aims Crouch", 1)
                    menu.set_group_visibility("Vendetta | Anti-aims Standing", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Moving", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Crouch", true)
                    menu.set_group_visibility("Vendetta | Anti-aims Air", false)

                   
                elseif  menu_conditiom == 5 then
                    menu.set_group_column("Vendetta | Anti-aims Air", 1)
                    menu.set_group_visibility("Vendetta | Anti-aims Standing", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Moving", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Slowwalk", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Crouch", false)
                    menu.set_group_visibility("Vendetta | Anti-aims Air", true)
          ...
          menu.set_group_visibility("Vendetta | Anti-aims", true)
          menu.set_group_visibility("Vendetta | Visuals", false)
          menu.set_group_visibility("Vendetta | Misc", false)
          menu.set_group_visibility("Vendetta | Ragebot", false)
          menu.set_group_visibility("Vendetta | Hidden", false)
          menu.set_group_column("Vendetta | Anti-aims", 2)
        ...
        elseif menu_val == 3 then
            ...
            menu.set_group_visibility("Vendetta | Anti-aims", false)
            menu.set_group_visibility("Vendetta | Visuals", true)
            menu.set_group_visibility("Vendetta | Misc", false)
            menu.set_group_visibility("Vendetta | Ragebot", false)
            menu.set_group_visibility("Vendetta | Hidden", false)
            menu.set_group_column("Vendetta | Visuals", 1)
        ...
        elseif menu_val == 4 then
            ...
            menu.set_group_visibility("Vendetta | Anti-aims", false)
            menu.set_group_visibility("Vendetta | Visuals", false)
            menu.set_group_visibility("Vendetta | Misc", true)
            menu.set_group_visibility("Vendetta | Ragebot", false)
            menu.set_group_visibility("Vendetta | Hidden", false)
            menu.set_group_column("Vendetta | Misc", 1)
        ...
        elseif menu_val == 1 then
            ...
            menu.set_group_visibility("Vendetta | Visuals", false)
            menu.set_group_visibility("Vendetta | Misc", false)
            menu.set_group_visibility("Vendetta | Ragebot", true)
            menu.set_group_visibility("Vendetta | Hidden", false)
            menu.set_group_column("Vendetta | Ragebot", 1)
        end
    else
    ...
    --  text_eu:set_visible(false)
      ...
      menu.set_group_visibility("Vendetta | Ragebot", false)
      menu.set_group_visibility("Vendetta | Anti-aims", false)
      menu.set_group_visibility("Vendetta | Information", false)
      menu.set_group_visibility("Vendetta | Visuals", false)
      menu.set_group_visibility("Vendetta | Misc", false)
  end
end
...
local function on_draw_watermark(watermark_text)
  ...
  if menu.is_open() then
    ...
    local function math_clamp(val, low, high)
     ...
     color = color_acc()
      ...
      render.text(font,"Welcome " .. user.name .. " [" .. user.uid .. "] | Vendetta Yaw | Build: ".. build .. " | Build Version: 1.5 | Latest Update:  8/25/2022", pos + vec2_t(200,-25), color_t(255,255,255,255), 15, true)
 end
end
 ...
 callbacks.add(e_callbacks.PAINT, on_paint)
   ...
   clientside_animations.handle = function (poseparam)
       ...
       if ui.clientside_animations:get(3) then
           if sexgod then
...
local primTag = function()
    if ui.clantag:get() then
        local curtime = math.floor(global_vars.cur_time() * 1.5);
...
local get_phrase = function()
    local phrases = {"Vendetta makes me luck boosted", "Vendetta Yaw is just better.", "I wish I had Vendetta Yaw", "Vendetta > all", "Monkey down!", "just get Vendetta doggo", "Vendetta luckboosted mode: ON", "Vendetta > you", "Vendetta > Pastenobyl", "H$..! should have gotten Vendetta", "https://discord.gg/VendettaYaw", "L Bozo", "Gamesense | missed shot due to unhittable AA", "EZ 4 me thank you for HVH medier", "My rezolver chase you like you chase bag, Only differents because my rezolver get you HS but you dont get the bag.", "Allah live, allah die. all you do is die. Choose allah", "【ｗｅａｋ　ｂｏｔ　ｙｏｕ　ａｒｅ　ｂｏｔ　ｙｏｕ　ｇｅｔ　ｈｓ　ｂｙ　ｍｙ　ｓｉｇｍａ．ｌｕａ　ｒｅｓｏｌｖｅｒ】"}
...
if presetsc == 2 or presetsc == 3 and menu.is_open() then 
