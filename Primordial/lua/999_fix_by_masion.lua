...
function Solus.GetBinds()
    local t = {}
    local _def = {
        {text = 'Hideshots', toggle = menu.find("aimbot", "general", "exploits", "hideshots", "enable")[2]:get()},
        {text = 'Autopeek', toggle = menu.find("aimbot", "general", "misc", "autopeek", "enable")[2]:get()},
        {text = 'Safepont', toggle = menu.find("aimbot", realweapon, "target overrides", "safepoint")[2]:get()},
        {text = 'Min. Damage', toggle = menu.find("aimbot", realweapon, "target overrides", "min. damage")[2]:get()},
        {text = 'Double Tap', toggle = menu.find("aimbot", "general", "exploits", "doubletap", "enable")[2]:get()},
        {text = 'Fakeduck', toggle = menu.find("misc", "main", "movement", "sneak", "enable")[2]:get()},
    }
    if active then 
