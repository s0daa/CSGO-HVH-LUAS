...
local r_yaw_add = menu.add_slider("gamesheesh beta", "right yaw add", -50, 50)
local yaw_base = menu.add_selection("gamesheesh beta", "yaw base", {"viewangle", "at target(crosshair)", "at target(distance)"})
...
local function indicators()
    ...
    render.text(font_inds, "gamesheesh beta", vec2_t(x + 2, y + 43), indi_color, true)
