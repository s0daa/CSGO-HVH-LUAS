...
local var_0_7 = ui.new_hotkey("AA", "Other", "~ // lagcompensation ~")
local var_0_8 = ui.new_hotkey("AA", "Other", "~ // lagcompensation ~ when hittable")
...
client.set_event_callback("paint", function()
        local var_5_0 = "~ // lagcompensation active"
        if var_0_19 then
                renderer.indicator(143, 194, 21, 255, var_5_0)
                renderer.text(var_0_5[1] - 1206, 772, 143, 207, 219, 255, "-c", 0, "~ // lagcompensation active")
