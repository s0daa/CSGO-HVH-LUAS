...
local master_switch = ui_new_checkbox("AA", "Other", "Enable sigma adaptive wpn")
local ovr_key = ui_new_hotkey("AA", "Other", "Override minimum damage key")
local ovr_hc_key = ui_new_hotkey("AA", "Other", "Override hit chance key")


local active_wpn = ui_new_combobox("AA", "Other", "View weapon", config_names)

local target_hitbox_ovr = ui_new_multiselect("AA", "Other", "Target hitbox override", { "Head", "Chest", "Arms", "Stomach", "Legs", "Feet" })
local target_hitbox_ovr_key = ui_new_hotkey("AA", "Other", "Target hitbox override key", true)

local unsafe_ovr = ui_new_multiselect("AA", "Other", "Avoid unsafe hitboxes override", { "Head", "Chest", "Arms", "Stomach", "Legs", "Feet" })
local unsafe_ovr_key = ui_new_hotkey("AA", "Other", "Avoid unsafe hitboxes override key", true)

local global_dt_hc = ui_new_checkbox("AA", "Other", "Global double tap hitchance")
...
for i=1, #config_names do
    rage[i] = {
        enabled = ui_new_checkbox("AA", "Other", "Enable " .. config_names[i] .. " config"),
        target_selection = ui_new_combobox("AA", "Other", "[" .. config_names[i] .. "] Target selection", {"Cycle", "Cycle (2x)", "Near crosshair", "Highest damage", "Lowest ping", "Best K/D ratio", "Best hit chance"}),
        accuracy_boost = ui_new_combobox("AA", "Other", "[" .. config_names[i] .. "] Accuracy boost", {"Off", "Low", "Medium", "High", "Maximum"}),
        target_hitbox = ui_new_multiselect("AA", "Other", "[" .. config_names[i] .. "] Target hitbox", { "Head", "Chest", "Arms", "Stomach", "Legs", "Feet" }),
        multipoint = ui_new_multiselect("AA", "Other", "[" .. config_names[i] .. "] Multi-point", { "Head", "Chest", "Arms", "Stomach", "Legs", "Feet" }),
        multimode = ui_new_combobox("AA", "Other", "\n[" .. config_names[i] .. "] Multi-point mode", { "Low", "Medium", "High" }),
        multipoint_scale = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] Multi-point scale", 24, 100, 60, true, "%", 1, { [24] = "Auto" }),
		unsafe = ui_new_multiselect("AA", "Other", "[" .. config_names[i] .. "] Avoid unsafe hitboxes", { "Head", "Chest", "Arms", "Stomach", "Legs", "Feet" }),
        dt_mp_enable = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Custom DT multipoint"),
        dt_multipoint = ui_new_multiselect("AA", "Other", "[" .. config_names[i] .. "] DT Multi-point", { "Head", "Chest", "Arms", "Stomach", "Legs", "Feet" }),   
        dt_multimode = ui_new_combobox("AA", "Other", "\n[" .. config_names[i] .. "] DT Multi-point mode", { "Low", "Medium", "High" }),   
        dt_multipoint_scale = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] DT Multi-point scale", 24, 100, 60, true, "%", 1, { [24] = "Auto" }),
        prefer_safe_point = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Prefer safe point"),
        dt_prefer_safe_point = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Prefer safe point on DT"),
        automatic_fire = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Automatic fire"),
        automatic_penetration = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Automatic penetration"),
        automatic_scope = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Automatic scope"),
        silent_aim = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Silent aim"),
        hitchance = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] Hitchance", 0, 100, 50, true, "%", 1, {"Off"}),
        hitchance_ovr = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] Hitchance override", 0, 100, 50, true, "%", 1, {"Off"}),        
        ns_hitchance = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] Noscope hitchance", 0, 100, 50, true, "%", 1, {"Off"}),
        air_hc_enable = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Custom hitchance in air"),
        hitchance_air = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] Hitchance in air", 0, 100, 50, true, "%", 1, {"Off"}),
        custom_damage = ui_new_multiselect("AA", "Other", "[" .. config_names[i] .. "] Custom min damage", { "Visible", "Double tap", "On-key" }),
        min_damage = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] Minimum damage", 0, 126, 20, true, nil, 1, damage_idx),
        vis_min_damage = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] Visible min damage", 0, 126, 20, true, nil, 1, damage_idx),
        wall_min_damage = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] Autowall min damage", 0, 126, 20, true, nil, 1, damage_idx),
        dt_min_damage = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] Double tap min damage", 0, 126, 20, true, nil, 1, damage_idx),
        ovr_min_damage = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] On-key min damage", 0, 126, 20, true, nil, 1, damage_idx),
        ovr_min_damage2 = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] On-key 2 min damage", -1, 126, -1, true, nil, 1, {[-1] = "Disabled", unpack(damage_idx)}),

        quick_stop = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Quick stop"),
        quick_stop_options = ui_new_multiselect("AA", "Other", "[" .. config_names[i] .. "] Quick stop options", {"Early", "Slow motion", "Duck", "Fake duck", "Move between shots", "Ignore molotov", "Taser"}),
        
        quick_stop_ns = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Quick stop noscope"),
        quick_stop_options_ns = ui_new_multiselect("AA", "Other", "[" .. config_names[i] .. "] Quick stop options ns", {"Early", "Slow motion", "Duck", "Fake duck", "Move between shots", "Ignore molotov", "Taser"}),
        
        prefer_baim = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Prefer body aim"),
        prefer_baim_disablers = ui_new_multiselect("AA", "Other", "[" .. config_names[i] .. "] Prefer body aim disablers", {"Low inaccuracy", "Target shot fired", "Target resolved", "Safe point headshot", "Low damage"}),
        delay_shot = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Delay shot"),
        force_baim_peek = ui_new_checkbox("AA", "Other", "[" .. config_names[i] .. "] Force body aim on peek"),
        doubletap_hc = ui_new_slider("AA", "Other", "[" .. config_names[i] .. "] Double tap hit chance", 0, 100, 0, true, "%", 1)
        --doubletap_stop = ui_new_multiselect("LUA", "A", "[" .. config_names[i] .. ui_reference("RAGE", "Aimbot", "Double tap mode", { "Slow motion", "Duck", "Move between shots" })),
    }
end
rage[scoped_wpn_idx[1]].js_settings = ui_new_checkbox("AA", "Other", "[Scout] Jump Scout settings")
rage[scoped_wpn_idx[1]].js_target_hitbox = ui_new_multiselect("AA", "Other", "[Jump Scout] Target hitbox", { "Head", "Chest", "Arms", "Stomach", "Legs", "Feet" })
rage[scoped_wpn_idx[1]].js_multipoint = ui_new_multiselect("AA", "Other", "[Jump Scout] Multi-point", { "Head", "Chest", "Arms", "Stomach", "Legs", "Feet" })
rage[scoped_wpn_idx[1]].js_multimode = ui_new_combobox("AA", "Other", "\n[Jump Scout] Multi-point mode", { "Low", "Medium", "High" })
rage[scoped_wpn_idx[1]].js_multipoint_scale = ui_new_slider("AA", "Other", "[Jump Scout] Multi-point scale", 24, 100, 60, true, "%", 1, { [24] = "Auto" })
rage[scoped_wpn_idx[1]].js_unsafe = ui_new_multiselect("AA", "Other", "[Jump Scout] Avoid unsafe hitboxes", { "Head", "Chest", "Arms", "Stomach", "Legs", "Feet" })
rage[scoped_wpn_idx[1]].js_prefer_safe_point = ui_new_checkbox("AA", "Other", "[Jump Scout] Prefer safe point")
rage[scoped_wpn_idx[1]].js_automatic_scope = ui_new_checkbox("AA", "Other", "[Jump Scout] Automatic scope")
rage[scoped_wpn_idx[1]].js_hitchance = ui_new_slider("AA", "Other", "[Jump Scout] Hitchance", 0, 100, 50, true, "%", 1, {"Off"})
rage[scoped_wpn_idx[1]].js_min_damage = ui_new_slider("AA", "Other", "[Jump Scout] Minimum damage", 0, 126, 20, true, nil, 1, damage_idx)
rage[scoped_wpn_idx[1]].js_quick_stop = ui_new_checkbox("AA", "Other", "[Jump Scout] Quick stop")
rage[scoped_wpn_idx[1]].js_quick_stop_options = ui_new_multiselect("AA", "Other", "[Jump Scout] Quick stop options", {"Early", "Slow motion", "Duck", "Fake duck", "Move between shots", "Ignore molotov", "Taser"})
rage[scoped_wpn_idx[1]].js_prefer_baim = ui_new_checkbox("AA", "Other", "[Jump Scout] Prefer body aim")
rage[scoped_wpn_idx[1]].js_prefer_baim_disablers = ui_new_multiselect("AA", "Other", "[Jump Scout] Prefer body aim disablers", {"Low inaccuracy", "Target shot fired", "Target resolved", "Safe point headshot", "Low damage"})
rage[scoped_wpn_idx[1]].js_delay_shot = ui_new_checkbox("AA", "Other", "[Jump Scout] Delay shot")
rage[scoped_wpn_idx[1]].js_force_baim_peek = ui_new_checkbox("AA", "Other", "[Jump Scout] Force body aim on peek")

rage[scoped_wpn_idx[2]].doubletap_stop_ns = ui_new_multiselect("AA", "Other", "[Auto] Double tap quick stop noscope", { "Slow motion", "Duck", "Move between shots" })

local lethal_rev = ui_new_checkbox("AA", "Other", "Lethal revolver damage")
local prioritize_awp = ui_new_checkbox("AA", "Other", "Prioritize awpers")
...
--local ref_doubletap_mode = ui_reference("RAGE", "Aimbot", "Double tap mode", { "Slow motion", "Duck", "Move between shots" })
--
local in_speed
