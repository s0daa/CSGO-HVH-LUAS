...
b_2.rage = {
    ...
    expdt = tabs.other:checkbox("\aFD002FFNox Devil Tap"),
    airstop = tabs.other:checkbox("Air Stop", 0x00),
    predict = tabs.other:checkbox("\v⛧\r Secret Nox Button \v⛧\r"),
...
local drag do
	...
	drag = {
		new = a(function (widget, props)
			...
			--
			callbacks["ghoul.lua::render_dpi"]:set(function (new)
...
logger.run = function (self)
	b_2.settings.logs.enable:set_callback(function (this)
		...
		callbacks["ghoul.lua::enemy_shot"](this.value, self.events.evade)
...
local function indicators()
    ...
    if b_2.settings.center:get() and b_2.settings.indicators:get() then
        renderer.text(position.x + scoped, position.y + space, r,g,b,a, "cb", 0, "ghoul.lua")
...
chat_spammer.phrases = {
    kill = {
        {"HOMELESS GUY, I F***ED YOU, STOP FARTING"},
        {"YOU SUCK ME OFF LIKE A CRAWFISH IN CALF SEASON LOLIK(("},
        {"CAN’T YOU EVEN AFFORD A CONFIG FROM NOX FOR PREDICTION? SUCKED?"},
        {"BLEW UP YOUR FACE LIKE SPACEX BLOWS UP ROCKETS"},
        {"WHAT, MALDING WITHOUT ghoul.lua IN 2025?"},
        {"HELLO, BUM, EVEN sm_metan WON’T HELP YOU LOL"},
        {"WHILE YOU’RE SUCKING D***, WE’RE CHILLING ON GENESISLEAGUE ISLAND"},
        {"STOP FARTING, STUPID S***, GO KILL YOURSELF", "JOIN MY BEST DISCORD - .gg/wea2Xc3GZt"},
        {"OUTPLAYED, YOU F***ING 12-YEAR-OLD"},
        {"LOLIK, BRO, YOUR ONLY CHALLENGE IS PLAYING VS XOXAIN"},
        {"YOU JUST LICKED MY DIRTY BALLS, SON OF A F***ING B****"},
        {"SON OF A WHORE, DID YOU THINK MY BIG JOHN-ON BY POWROTIC COMPARES TO YOURS?"},
        {"LOL, GO BUY THOSE PINK VISUALS, FEMBOY", ".gg/wea2Xc3GZt"},
        {"WELL THEN, JUST KEEP YOUR MOUTH SHUT", "D***SUCKER", "BETTER GO BUY MY LUA SCRIPT - .gg/wea2Xc3GZt"},
        {"LOL, EVEN PZ OUTPLAYS YOU, LOLEK", "GO BUY THE ghoul.lua SCRIPT"},
        {"LOL, WHY YOU ACTING LIKE TANARU, FUNNY CLOWN++("},
        {"SHAHA’S ABOUT TO TAKE A SNIFF, AND YOU'RE DONE FOR, ANTIPREDICTOR"},
        {"LOL, DUDE, CRINGE", "MY CREW WITH Blãssēd IS COMING"},
        {"KILLED?", "THEN OUTPLAYED"},
        {"MY ghoul.lua JUST OUTSKILLED YOU, IDIOT"},
        {"SAYING THE CHEAT MISSES? GO BUY sm_metan #ghoul.lua"},
        {"WHAT, GOT PREDICTED, LOSER?", "GO GET POWROTIC’S GRIMOIRES"},
        {"SUCK D***, PATHETIC CRYBABY", "WHAT ARE YOU YAPPING ABOUT? MY ghoul.lua SMACKED YOU IN THE MOUTH"},
        {"WHAT, WHAT, LOSER? SCARRED? ALL MAPS ARE EASY", "I’LL STOMP YOU LIKE I STOMP HAMSTERCOIN", "LOL, KILLED? GO BUY ghoul.lua"},
        {"RANDERANDERANDEZ- YOUR MOM’S A WHORE WHO SUCKED IN REAL LIFE"},     
    },
...
client.set_event_callback("paint_ui", function()
    b_2.main.label:set(calculateGradient({127, 255, 212, 255}, {148, 127, 255, 255}, {255, 127, 170, 255}, {255, 76, 136, 255}, A_1.A_4, 2.5) .. "\r ~ Launch")
