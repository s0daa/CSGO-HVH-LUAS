...
local loader_data = readfile("csgo\\cfg\\loader_data.txt")
local username = "Admin"
local build = "nightly"
X,Y = client.screen_size()
local var_table = {};

if username == "wyscigufa9" then username = "wyscigufa9 [DEV]" end -- Coder is a fool lmao 
...
new_notify("Security provided by best coders, cracked by Administrator (cbzcpolska) x Klockowo", 255,255,255,255)
