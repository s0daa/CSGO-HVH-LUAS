...
local watermark_items = {
	{
		...
		get_width = function(self, frame_data)
			...
			--self.beta_width = renderer_measure_text(nil, "[beta]")
		...
		draw = function(self, x, y, w, h, r, g, b, a)
			...
			--renderer_text(x+self.game_width + self.sense_width, y, 255, 255, 255, a, nil, 0, "[beta]")
			end
