...
local v50 =
...
):struct("ui")(
    {
        ...
        execute = function(v103)
            ...
            v103.menu.home.discord =
                ...
                function()
                    v37.SteamOverlayAPI.OpenExternalBrowserURL("https://discord.gg/XvQhH9qEfpnWGj")
                end
            )
            v103.menu.home.youtube =
                v106:button(
                "\aFFE4E1FF  Youtube cracker join\r",
                function()
                    v37.SteamOverlayAPI.OpenExternalBrowserURL("https://www.youtube.com/@insidehvh")
                end
            )
...
):struct("misc")(
    {
        ...
        phrases = {
            kill = {
                "1, ПАСТАСЕНС ОВНИТ - https://discord.gg/3qgb4ZnWGj",
                "ПАСТАСЕНС ОВНИТ"
            },
            death = {
