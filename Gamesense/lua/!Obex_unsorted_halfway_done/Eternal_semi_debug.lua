...
local obex_data = obex_fetch and obex_fetch() or {username = 'Bigdon', build = 'Private'}
...
return(function(eternal)
    ...
    eternal.load = function(success, response)
        ...
        log(string.format('Successfully loaded Eternal, welcome back %s.', obex_data.username))
