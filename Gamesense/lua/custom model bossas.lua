local t_player_models = {
    ...
    ["marsh_mellow"] = "models/player/custom_player/legacy/nf/fortnite/marsh_mellow/marsh_mellow.mdl",
    ["bananana"] = "models/player/custom_player/caleon1/peely/peely.mdl",
    ...
    ["dark_bom"] = "models/player/custom_player/rabidgames/dark_bom/dark_bom.mdl",
    ["skye_summer"] = "models/player/custom_player/night_fighter/fortnite/summer_skye/summer_skye.mdl",
    ["human_bill"] = "models/player/custom_player/night_fighter/fortnite/human_bill/human_bill.mdl",
    ["axolotl"] = "models/player/custom_player/night_fighter/fortnite/axolotl/axolotl.mdl",
    ["beefboss"] = "models/player/custom_player/napas/garrys/beefboss_pm_beefboss.mdl",
    ["point"] = "models/player/custom_player/napas/point/point_v2.mdl",
...
local ct_player_models = {
    ...
    ["axolotl"] = "models/player/custom_player/night_fighter/fortnite/axolotl/axolotl.mdl",
    ["beefboss"] = "models/player/custom_player/napas/garrys/beefboss_pm_beefboss.mdl",
    ["point"] = "models/player/custom_player/napas/point/point.mdl",
    ["bonewasp"] = "models/player/custom_player/canwit/fortnite/bonewasp.mdl",
    ["velocity"] = "models/player/custom_player/caleon1/velocity/velocity.mdl",
    ["mezmer"] = "models/player/custom_player/caleon1/mezmer/mezmer.mdl",
}
