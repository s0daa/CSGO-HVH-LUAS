...
local enabled_reference = ui.new_checkbox("Lua", "B", "Sound volume modifiers")
...
for i=1, #mixers_list do
	...
	modifier_reference[mixer] = ui_new_slider("Lua", "B", mixer .. " volume modifier", 0, 1000, 100, true, "%", 1, {[0] = "        Muted"})
