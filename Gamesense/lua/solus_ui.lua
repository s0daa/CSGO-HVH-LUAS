...
local ms_lags_exploit = ui_new_checkbox('CONFIG', 'Presets', 'Lags-Exploit indication')
local ms_ieinfo = ui_new_checkbox('CONFIG', 'Presets', 'Frequency update information')

local glow_enabled = ui_new_checkbox('CONFIG', 'Presets', 'Glow Enabled (low fps warning)')
...
local ms_classes = {
	watermark = function()
		...
		local cstyle = { [1] = {'game', 'sense'}, [2] = {'game', 'sense.pub'}, [3] = {'sk', 'eet'}, [4] = {'ske', 'et.cc'}}
