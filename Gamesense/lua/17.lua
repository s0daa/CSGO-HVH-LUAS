...
if var_0_8 then
	ui.new_label("VISUALS", "Other ESP", "Helper: Debug")
	ui.new_button("VISUALS", "Other ESP", "Create helper map patterns", function()
		local var_45_0 = {
			"de_cache",
			"de_mirage",
			"de_dust2",
...
local var_0_144 = {
	title = ui.new_checkbox("VISUALS", "Other ESP", "Helper: Manage sources"),
	list = ui.new_listbox("VISUALS", "Other ESP", "Helper sources", {}),
	source_label1 = ui.new_label("VISUALS", "Other ESP", "Source label 1"),
	enabled = ui.new_checkbox("VISUALS", "Other ESP", "Enabled"),
	source_label2 = ui.new_label("VISUALS", "Other ESP", "Source label 2"),
	source_label3 = ui.new_label("VISUALS", "Other ESP", "Source label 3"),
	name = ui.new_textbox("VISUALS", "Other ESP", "New source name")
}
local var_0_145
local var_0_146
local var_0_147
...
local var_0_149
local var_0_150 = {
	list = ui.new_listbox("VISUALS", "Other ESP", "Selected source locations", {}),
	show_all = ui.new_checkbox("VISUALS", "Other ESP", "Show all maps"),
	sort_by = ui.new_combobox("VISUALS", "Other ESP", "Sort by", {
		"Creation date",
		"Type",
		"Alphabetically"
	}),
	type_label = ui.new_label("MISC", "Settings", "Creating new location"),
	type = ui.new_combobox("MISC", "Settings", "\nLocation Type", {
		"Grenade",
		"Movement",
		"Location",
		"Area"
	}),
	from_label = ui.new_label("MISC", "Settings", "From"),
	from = ui.new_textbox("MISC", "Settings", "From"),
	to_label = ui.new_label("MISC", "Settings", "To"),
	to = ui.new_textbox("MISC", "Settings", "To"),
	description_label = ui.new_label("MISC", "Settings", "Description (Optional)"),
	description = ui.new_textbox("MISC", "Settings", "To"),
	grenade_properties = ui.new_multiselect("MISC", "Settings", "Grenade Properties", {
		"Jump",
		"Run",
		"Walk (Shift)",
		"Throw strength",
	...
	throw_strength = ui.new_combobox("MISC", "Settings", "Throw strength", {
		"Left Click",
		"Left / Right Click",
		"Right Click"
	}),
	run_direction = ui.new_combobox("MISC", "Settings", "Run duration / direction", {
		"Forward",
		"Left",
		"Right",
		"Back",
	...
	run_direction_custom = ui.new_slider("MISC", "Settings", "\nCustom run direction", -180, 180, 0, true, "°"),
	run_duration = ui.new_slider("MISC", "Settings", "\nRun duration", 1, 256, 20, true, "t"),
	delay = ui.new_slider("MISC", "Settings", "Throw delay", 1, 40, 0, true, "t"),
	recovery_direction = ui.new_combobox("MISC", "Settings", "Recovery (after throw) direction", {
		"Back",
		"Forward",
		"Left",
		"Right",
	...
	recovery_direction_custom = ui.new_slider("MISC", "Settings", "\nCustom recovery direction", -180, 180, 0, true, "°", -1),
	recovery_duration = ui.new_slider("MISC", "Settings", "Recovery duration", 0, 128, 0, true, "t", 1, {
		[0] = "Auto"
	}),
	recovery_jump = ui.new_checkbox("MISC", "Settings", "Recovery bunny-hop"),
	record_label = ui.new_label("MISC", "Settings", "Record hotkey"),
	set = ui.new_button("MISC", "Settings", "Set location", function()
		var_0_148()
	end),
	set_hotkey = ui.new_hotkey("MISC", "Settings", "Helper set location hotkey", true),
	teleport = ui.new_button("MISC", "Settings", "Teleport", function()
		var_0_147()
	end),
	teleport_hotkey = ui.new_hotkey("MISC", "Settings", "Helper teleport hotkey", true),
	export = ui.new_button("MISC", "Settings", "Export to clipboard", function()
		var_0_149()
	end),
	save = ui.new_button("MISC", "Settings", "Save", function()
		var_0_145()
	end)
}

var_0_150.delete, var_0_150.delete_cancel, var_0_150.delete_confirm = var_0_116("MISC", "Settings", "Delete", function()
	var_0_146()
end, var_0_99)
var_0_150.delete_hotkey = ui.new_hotkey("MISC", "Settings", "Helper delete hotkey", true)
...
var_0_144.edit = ui.new_button("VISUALS", "Other ESP", "Edit", function()
	var_0_155()
end)
var_0_144.update = ui.new_button("VISUALS", "Other ESP", "Update", function()
	var_0_157()
end)
var_0_144.delete, var_0_144.delete_cancel, var_0_144.delete_confirm = var_0_116("VISUALS", "Other ESP", "Delete", function()
	var_0_158()
end, var_0_99)
var_0_144.create = ui.new_button("VISUALS", "Other ESP", "Create", function()
	var_0_159()
end)
var_0_144.import = ui.new_button("VISUALS", "Other ESP", "Import from clipboard", function()
	var_0_160()
end)
var_0_144.export = ui.new_button("VISUALS", "Other ESP", "Export all to clipboard", function()
	var_0_161()
end)
var_0_144.back = ui.new_button("VISUALS", "Other ESP", "Back", function()
	var_0_156()
end)
var_0_144.source_label4 = ui.new_label("VISUALS", "Other ESP", "Ready.")
