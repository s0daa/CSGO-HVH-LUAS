...
---------------------- WEBHOOK  ----------------------
local Webhook = discord.new('https://discord.com/api/webhooks/1030899786729136219/IZ_dPV5uK_VBYpwCzhGO4gF3OBFTfJa1En0V3XyjpOLMqEWGBiNFqpQGKHzF1A5BE7Gn')
    ...
    ui.set_visible(gui.menu.lua_tab,ui.get(gui.menu.lua_enable) and true or false)
     ...
     ui.set_visible(gui.menu.custom[0].player_state,ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot angles")
        ...
        for i = 1, 7 do
            ...
            ui.set_visible(gui.menu.custom[i].fakeyawlimit, var.active_i == i and ui.get(gui.menu.lua_enable)and ui.get(gui.menu.lua_tab) == "Anti-aimbot angles") 
            ui.set_visible(gui.menu.custom[i].fakeyawlimitr, var.active_i == i and ui.get(gui.menu.lua_enable) and ui.get(gui.menu.lua_tab) == "Anti-aimbot angles")
