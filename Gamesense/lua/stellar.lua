...
-- #region : lua data
local stellar = {} do
    stellar.name = "I <3 Sigma"
    stellar.nigger = "Cracked By Spencer :)"
    stellar.user = "Perception.cx"
...
local ts = {} do
    ...
    menu.label(groups.fakelag)(("\v%s"):format(stellar.nigger))("main", "info_header")
    menu.label(groups.fakelag)(("Best CS2 Cheat: \v%s\r"):format(stellar.user))("main", "user")
