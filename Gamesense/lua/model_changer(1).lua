local t_player_models = {
    -- All Terrorists should be added here! Note that the directories must match!
    ["gamesense"] = "models/player/custom_player/frnchise9812/gamesensee.mdl",
...
local ct_player_models = {
    -- All Counter Terrorists should be added here! Note that the directories must match!
    ["gamesense"] = "models/player/custom_player/frnchise9812/gamesensee.mdl",
    ["ballas2"] = "models/player/custom_player/frnchise9812/ballas2.mdl",
    ["bmybar"] = "models/player/custom_player/eminem/gta_sa/bmybar.mdl",
}
...
label1 = ui.new_label('LUA', 'A', '⤙⤙⤙⤙⤙⤙⤙⤙ Player model ⤚⤚⤚⤚⤚⤚⤚⤚')
