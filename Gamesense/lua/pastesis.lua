...
local json = require("json")
                ...
                local phrases = {
                    "▶• ılıılıılıılıılıılı ｐａｓｔｅｓｉｓ",
                    "♡ ｇａｍｅｓｅｎｓｅ ᛭ ｐａｓｔｅｓｉｓ ♡",
                    "♛ ｇａｍｅｓｅｎｓｅ ♛",
                    "ｐａｓｔｅｓｉｓ.ｌｕａ ｇａｖｅ ｍｅ ａ ｇｏｄｍｏｄｅ",
                    "ｅｓｔｋ  ｓｕｉｃｉｄｅｄ  ｗｈｅｎ  ｐａｓｔｅｓｉｓ.ｌｕａ  ｒｅｌｅａｓｅｄ",
                    "♛ ｂｌａｍｅｌｅｓｓ １ ３ ３ ７ ♛",
                    "( ⸝⸝´꒳`⸝⸝) 𖹭 ｐａｓｔｅｓｉｓ ♡",
                    "𖹭 ｓｌｅｅｐ 𖹭",
                    "▄︻デ══━一💨 pro100 ｂｌａｍｅｌｅｓｓ",
                    "ｔａｐｐｅｄ ｂｙ ｐａｓｔｅｓｉｓ ｒｅｓｏｌｖｅｒ",
                    "「✦ᴘᴀsᴛᴇsɪs✦」",
                    "ᴘᴀsᴛᴇsɪs ʟᴜᴀ ᴏᴡɴs ᴍᴇ ᴀɴᴅ ᴀʟʟ",
