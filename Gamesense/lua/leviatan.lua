...
pui.accent = "69a1faff" -- lua main color
pui.macros.heart = '❤'
...
local aa_table = {
    states = {"Global", "Stand", "Run", "Duck", "Duck-move", "Jump", "Duck-jump", "Slowwalk"},
...
local _ui = {
    lua = {
        enable_lua = group:checkbox("\vLevi\ratan".." - \v".. euphemia.username),
        tab = group:combobox("\n ", "Anti-aim", "Anti-Bruteforce", "Visuals", "Miscellaneous", "Config"),    
    },

    keybinds = {
        types = group:combobox("\n ", {"Builder", "Other"}),
        freestanding = group:hotkey("Freestanding"),
        manual_left = group:checkbox("Manual left", 0x00),
        manual_right = group:checkbox("Manual right", 0x00),
        manual_forward = group:checkbox("Manual forward", 0x00),
        at_target_bind = group:checkbox("At target", 0x00),
        freestanding_disablers = group:multiselect("Freestanding disablers", aa_table.states),
        tweaks = group:multiselect("Tweaks", "Anti-backstab", "Safe head", "E-Spam"),
    ...
    anti_bf = {
        ...
        state = group:multiselect("State", aa_table.defensive_states),
        phase = group:combobox("Phase", anti_bf_table.phase_to_string)
    },

    visuals = {
        enable = group:checkbox("Enable ~ \vVisuals", {105, 161, 250, 255}),
        hitlogs_checkbox = group:checkbox("Enable Hitlogs", {105, 161, 250, 255}),
        hitlogs = group:multiselect("Hitlogs", {"Hit", "Miss", "Naded", "Fired"}),
        notify_style = group:combobox("Notification style", {"Modern", "OG"}),
        inds_style = group:combobox("Indicators", {"Off", "Pixel", "Ideal", "Modern"}),
        inds_options = group:multiselect("Indicators modification", {"In scope", "Alpha"}),
        watermarks = group:combobox("Watermark", {"Off", "Minimal", "Legacy", "Country-Based"}),
        watermark_options = group:multiselect("Watermark modification", {"Desync", "Alpha"}),
        others = group:multiselect("Other", {"Defensive", "Slow-down", "Minimum Damage Override Indicator"}),
...
_ui.antiaim.enable:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.keybinds.types, "Builder"})
_ui.keybinds.types:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"})
_ui.antiaim.yaw_base:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.antiaim.enable, true}, {_ui.keybinds.types, "Builder"})
_ui.antiaim.state:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.antiaim.enable, true}, {_ui.keybinds.types, "Builder"})
...
_ui.keybinds.freestanding:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.keybinds.types, "Other"})
_ui.keybinds.manual_left:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.keybinds.types, "Other"})
_ui.keybinds.manual_right:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.keybinds.types, "Other"})
_ui.keybinds.manual_forward:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.keybinds.types, "Other"})
_ui.keybinds.tweaks:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.keybinds.types, "Other"})
_ui.keybinds.at_target_bind:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.keybinds.types, "Other"})
...
_ui.keybinds.anims:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.keybinds.types, "Other"})
_ui.keybinds.freestanding_disablers:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-aim"}, {_ui.keybinds.types, "Other"})
_ui.visuals.notify_style:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Visuals"}, {_ui.visuals.enable, true}, {_ui.visuals.hitlogs_checkbox, true})
...
_ui.visuals.hitlogs_checkbox:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Visuals"}, {_ui.visuals.enable, true})
_ui.visuals.hitlogs:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Visuals"}, {_ui.visuals.enable, true}, {_ui.visuals.hitlogs_checkbox, true})
...
for i, state in ipairs(aa_table.states) do
    ...
    menu.yaw_slider_delay = group:slider("Delay", 2, 15, 2, true, "%", 1)
    ...
    menu.body_yaw = group:combobox("Body yaw", {"Off", "Opposite", "Jitter", "Static", "Leviatan"})
    menu.body_yaw_slider = group:slider("\n ", -180, 180, 0, true, "°", 1)

    menu.force_def = group:checkbox("Force \vdefensive")
    menu.enable_def = group:checkbox("Defensive")
    menu.pitch_def = group:combobox("Pitch", 'Disabled', 'Up', 'Zero', 'Random', 'leviatan', 'Custom')
    menu.custom_pitch_def = group:slider("\n ", -89, 89, 0, true, "°")
    menu.yaw_def = group:combobox("Yaw", 'Disabled', 'Sideways', 'Random', 'Spin', "3-Way", "5-Way", "L & R")
    menu.yaw_slider_def = group:slider("\n ", 1, 100, 70, true, "%")
    menu.yaw_left_def = group:slider("Left", -100, 100, 0, true, "°")
    menu.yaw_right_def = group:slider("Right", -100, 100, 0, true, "°")
    menu.yaw_jitter_def = group:combobox("Yaw jitter", {"Off", "Offset", "Center", "Random", "Skitter"})
    menu.yaw_jitter_slider_def = group:slider("\n ", -180, 180, 0, true, "°")
    menu.mode_def = group:combobox("Mode", {"Always on", "Switch", "Invalid ticks", "Leviatan"})
end
...
for i, state in ipairs(aa_table.states) do
    ...
    local is_builder = {_ui.keybinds.types, "Builder"}
    menu.enable:depend(is_tab, is_state, is_checkbox_checked, is_enabled_lua, is_builder)
    menu.pitch:depend(is_tab, is_state, is_checkbox_checked, is_enabled, is_enabled_lua, is_builder)
    menu.custom_pitch:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.pitch, "Custom"}, is_enabled_lua, is_builder)
    menu.yaw:depend(is_tab, is_state, is_checkbox_checked, is_enabled, is_enabled_lua, is_builder)
    menu.yaw_type:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.yaw, function() return menu.yaw.value ~= "Off" end}, is_enabled_lua, is_builder)
    menu.yaw_slider_static:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.yaw, function() return menu.yaw.value ~= "Off" end}, {menu.yaw_type, function() return menu.yaw_type.value == "Static" end}, is_enabled_lua, is_builder)
    menu.yaw_slider_l:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.yaw, function() return menu.yaw.value ~= "Off" end}, {menu.yaw_type, function() return menu.yaw_type.value ~= "Static" end}, is_enabled_lua, is_builder)
    menu.yaw_slider_r:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.yaw, function() return menu.yaw.value ~= "Off" end}, {menu.yaw_type, function() return menu.yaw_type.value ~= "Static" end}, is_enabled_lua, is_builder)
    menu.yaw_slider_delay:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.yaw, function() return menu.yaw.value ~= "Off" end}, {menu.yaw_type, function() return menu.yaw_type.value == "Delay" end}, is_enabled_lua, is_builder)
    menu.yaw_jitter:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.yaw, function() return menu.yaw.value ~= "Off" end}, is_enabled_lua, is_builder)
    menu.yaw_jitter_mode:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.yaw, function() return menu.yaw.value ~= "Off" end}, {menu.yaw_jitter, function() return menu.yaw_jitter.value ~= "Off" end}, is_enabled_lua, is_builder)
    menu.yaw_jitter_slider_static:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.yaw, function() return menu.yaw.value ~= "Off" end}, {menu.yaw_jitter, function() return menu.yaw_jitter.value ~= "Off" end}, {menu.yaw_jitter_mode, function() return menu.yaw_jitter_mode.value == "Static" end}, is_enabled_lua, is_builder)
    menu.yaw_jitter_slider_l:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.yaw, function() return menu.yaw.value ~= "Off" end}, {menu.yaw_jitter, function() return menu.yaw_jitter.value ~= "Off" end}, {menu.yaw_jitter_mode, function() return menu.yaw_jitter_mode.value == "L & R" end}, is_enabled_lua, is_builder)
    menu.yaw_jitter_slider_r:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.yaw, function() return menu.yaw.value ~= "Off" end}, {menu.yaw_jitter, function() return menu.yaw_jitter.value ~= "Off" end}, {menu.yaw_jitter_mode, function() return menu.yaw_jitter_mode.value == "L & R" end}, is_enabled_lua, is_builder)
    menu.body_yaw:depend(is_tab, is_state, is_checkbox_checked, is_enabled, is_enabled_lua, is_builder)
    menu.body_yaw_slider:depend(is_tab, is_state, is_checkbox_checked, is_enabled, {menu.body_yaw, function() return menu.body_yaw.value ~= "Off" and menu.body_yaw.value ~= "Opposite" and menu.body_yaw.value ~= "Leviatan" end}, is_enabled_lua, is_builder)

    menu.force_def:depend(is_tab, is_enabled, is_state, {menu.enable_def, false}, is_enabled_lua, is_builder)
    menu.enable_def:depend(is_tab, is_state, is_enabled, {menu.force_def, false}, is_enabled_lua, is_builder)
    menu.pitch_def:depend(is_tab, is_state, is_enabled, {menu.enable_def, true}, is_enabled_lua, is_builder)
    menu.custom_pitch_def:depend(is_tab, is_state, is_enabled, {menu.enable_def, true}, {menu.pitch_def, "Custom"}, is_enabled_lua, is_builder)
    menu.yaw_def:depend(is_tab, is_state, is_enabled, {menu.enable_def, true}, is_enabled_lua, is_builder)
    menu.yaw_slider_def:depend(is_tab, is_state, is_enabled, {menu.enable_def, true}, {menu.yaw_def, function() return menu.yaw_def.value ~= "Off" end}, is_enabled_lua, {menu.yaw_def, "Spin"}, is_builder)
    menu.yaw_left_def:depend(is_tab, is_state, is_enabled, {menu.enable_def, true}, {menu.yaw_def, function() return menu.yaw_def.value ~= "Off" end}, is_enabled_lua, {menu.yaw_def, "L & R"}, is_builder)
    menu.yaw_right_def:depend(is_tab, is_state, is_enabled, {menu.enable_def, true}, {menu.yaw_def, function() return menu.yaw_def.value ~= "Off" end}, is_enabled_lua, {menu.yaw_def, "L & R"}, is_builder)
    menu.yaw_jitter_def:depend(is_tab, is_state, is_enabled, {menu.enable_def, true}, {menu.yaw_def, function() return menu.yaw_def.value ~= "Off" end}, is_enabled_lua, is_builder)
    menu.yaw_jitter_slider_def:depend(is_tab, is_state, is_enabled, {menu.enable_def, true}, {menu.yaw_jitter_def, function() return menu.yaw_jitter_def.value ~= "Off" end}, is_enabled_lua, is_builder)
    menu.mode_def:depend(is_tab, is_state, is_enabled, {menu.enable_def, true}, is_enabled_lua, is_builder)
end
...
for i = 1, anti_bf_table.max_phase do 
    ...
    menu.enabled = group:checkbox("Override ~ \v"..i.."\r phase")
    menu.jitter = group:slider("Yaw jitter", -180, 180, 0, true, "°", 1)
    menu.jitter_type = group:combobox("Yaw Jitter type", {"Off", "Offset", "Center", "Random", "Skitter"})
    menu.body_yaw = group:slider("Body yaw limit", -180, 180, 0, true, "%", 1)
end
...
for i = 1, anti_bf_table.max_phase do 
    ...
    menu.jitter_type:depend({_ui.lua.enable_lua, true}, {_ui.lua.tab, "Anti-Bruteforce"}, {_ui.anti_bf.enable, true}, {_ui.anti_bf.phase, anti_bf_table.phase_to_string[i]}, {menu.enabled, true})
...
--         new_notify("Successfully! Imported settings from clipboard", 105, 161, 250)
--     else
...
--     if pcall(protected) then
--         new_notify("Successfully! Exported settings to clipboard", 105, 161, 250)
--     else
--         new_notify("Error", 214, 0, 36,255)
--     end
-- end
...
function refresh_discord_cfgs()
    http.get("https://wyscigufa9.ct8.pl/get_cfg_list.php?lua_name=leviatan", function(r, s)
        if r then
...
function load_discord_cfgs()
    ...
    http.get("https://wyscigufa9.ct8.pl/get_cfg.php?cfgs="..selected_item.."&lua_name=leviatan", function(r, s)
        if r then
            local data = json.parse(s.body)
            ...
            new_notify("Successfully! Imported settings from discord", 105, 161, 250)
        else
            new_notify("Error",214, 0, 36,255)
        end
    end)
...
function default_cfg()
    http.get("https://wyscigufa9.ct8.pl/cfgs/default.txt", function(r,s)
        if r then
            ...
            new_notify("Successfully! Loaded default config",105, 161, 250)
        else
            new_notify("Error",214, 0, 36,255)
        end
    end)
...
local function downloadlogo()
    ...
    writefile("leviatan.png", response.body)
    end)
end
downloadlogo()
...
function share_cfg()
    ...
    http.get("https://wyscigufa9.ct8.pl/post_cfg.php?encrypted_data="..encrypted.."&unix_time="..client.unix_time().."&name_cfgs="..euphemia.username.."&lua_name=leviatan", function(r, s)
        if r then

            local Webhook = discord.new("https://discord.com/api/webhooks/1231258465536577566/QaPqH3oOkYFX6l06D8TtEjm7Zs3oTK-Ru2Al4dCDhjRETlydespuahcdoJSzzvEHiXD4")
            local RichEmbed = discord.newEmbed()

            Webhook:setUsername("leviatan cfg")
            ...
            new_notify("Successfully! Shared cfg",105, 161, 250)
        else
            new_notify("Error",214, 0, 36,255)
        end
...
local ctx = (function()
    ...
    ctx.cfgs = {
        ...
        save_config = function(name)
            if not database.read(cfg_data.database.configs) then database.write(cfg_data.database.configs, {}) end
            local db = database.read(cfg_data.database.configs) or {}
            local config = {}
        ...
        export_config = function()
            data = package:save()
            encrypted = "leviatan_+" .. base64.encode(json.stringify(data))
            clipboard.set(encrypted)
        end,
        import_config = function()
            decrypted = clipboard.get()
            local cwel = decrypted:gsub("leviatan_++", "")
            local data = json.parse(base64.decode(cwel))
            package:load(data)
        end,
    }
    ...
    ctx.antiaim = {
        run = function(cmd)
            ...
            if aa_builder[ctx.helps.get_state(ctx.helps.speed())].enable.value == false then state = "Global" end 
            ...
            local pitch_tbl = {
                ...
                ['leviatan'] = aguwno > 2 and aguwno < 14 and -89 or 89,
                ['Custom'] = aa_values.custom_pitch_def.value
            }
            ...
            local yaw_tbl = {
                ...
                ['Spin'] = normalize_yaw(globals.curtime() * 1000 * (aa_values.yaw_slider_def.value / 100)),
                ...
                ['L & R'] = desync_side == 1 and aa_values.yaw_left_def.value or aa_values.yaw_right_def.value
            }
            ...
            if aa_values.force_def.value and not aa_values.enable_def.value then
                cmd.force_defensive = true
            elseif aa_values.enable_def.value and not aa_values.force_def.value then
                if aa_values.mode_def.value == "Always on" then
                    cmd.force_defensive = true
                elseif aa_values.mode_def.value == "Switch" then
                    cmd.force_defensive = cmd.command_number % client.random_int(3,6) == 1
                elseif aa_values.mode_def.value == "Invalid ticks" then
                    cmd.force_defensive = cmd.chokedcommands % 2 == 1 and not cmd.no_choke
                elseif aa_values.mode_def.value == "Leviatan" then
                    cmd.force_defensive = cmd.command_number % 3 ~= 1 or cmd.weaponselect ~= 0 or cmd.quick_stop == 1
                end
            end
            ...
            if cmd.command_number % aa_values.yaw_slider_delay.value + 1 > aa_values.yaw_slider_delay.value - 1 then
                to_jitter = not to_jitter
            end

            if aa_values.enable_def.value and ctx.defensive_checks.is_defensive_active() and not ctx.defensive_checks.choking(cmd) and not aa_values.force_def.value and aa_values.enable.value then
                ui.set(refs.ref.yaw, "180")
                ui.set(refs.ref.yaw_value, yaw_tbl[aa_values.yaw_def.value])
                ui.set(refs.ref.pitch, "Custom") 
                ui.set(refs.ref.pitch_value, pitch_tbl[aa_values.pitch_def.value])
                ui.set(refs.ref.yaw_jitter, aa_values.yaw_jitter_def.value)
                ui.set(refs.ref.yaw_jitter_value, aa_values.yaw_jitter_slider_def.value)
            else
                ...
                if aa_values.enable.value and _ui.antiaim.enable.value then
                    ...
                    ui.set(refs.ref.body_yaw, body_yaw_tbl[aa_values.body_yaw.value])
                    ...
                    elseif aa_values.yaw_type.value == "L & R" then
                        ...
                        if aa_values.body_yaw.value == "Leviatan" then
                            ui.set(refs.ref.body_yaw_value, desync_side == 1 and -1 or 1)
                        else
                            ui.set(refs.ref.body_yaw_value, -1)
                        end
                    elseif aa_values.yaw_type.value == "Delay" then
                        if ctx.defensive_checks.choking(cmd) then
                            ui.set(refs.ref.body_yaw_value, -1)
                        else
                            ui.set(refs.ref.yaw_value, to_jitter and aa_values.yaw_slider_l.value or aa_values.yaw_slider_r.value)
                            ui.set(refs.ref.body_yaw, to_jitter and "Opposite" or "Static")
                            ui.set(refs.ref.body_yaw_value, to_jitter and -70 or 70)
                        end
                    end
                    ...
                    if anti_bf_table.miss_counter == 1 and anti_bf_builder[anti_bf_table.miss_counter].enabled.value and funcs.contains(_ui.anti_bf.state.value, ctx.helps.get_state_defensive(ctx.helps.speed())) and _ui.anti_bf.enable.value then
                        ui.set(refs.ref.yaw_jitter, anti_bf_builder[anti_bf_table.miss_counter].jitter_type.value)
                    elseif anti_bf_table.miss_counter == 2 and anti_bf_builder[anti_bf_table.miss_counter].enabled.value and funcs.contains(_ui.anti_bf.state.value, ctx.helps.get_state_defensive(ctx.helps.speed())) and _ui.anti_bf.enable.value then
                        ui.set(refs.ref.yaw_jitter, anti_bf_builder[anti_bf_table.miss_counter].jitter_type.value)
                    elseif anti_bf_table.miss_counter == 3 and anti_bf_builder[anti_bf_table.miss_counter].enabled.value and funcs.contains(_ui.anti_bf.state.value, ctx.helps.get_state_defensive(ctx.helps.speed())) and _ui.anti_bf.enable.value then
                        ui.set(refs.ref.yaw_jitter, anti_bf_builder[anti_bf_table.miss_counter].jitter_type.value)
                    ...
                    if _ui.keybinds.at_target_bind.hotkey:get() == true and _ui.keybinds.at_target_bind:get() == true then
                        ui.set(refs.ref.yaw_base, "At targets")
                    end

                    if _ui.keybinds.manual_left.hotkey:get() == true and _ui.keybinds.manual_right.hotkey:get() == false and _ui.keybinds.manual_forward.hotkey:get() == false and _ui.keybinds.manual_left:get() == true then
                        ui.set(refs.ref.pitch, "down")
                        ui.set(refs.ref.yaw, "180")
                        ui.set(refs.ref.yaw_value, -90)
                        ui.set(refs.ref.yaw_base, "Local view")
                    ...
                    elseif _ui.keybinds.manual_right.hotkey:get() == true and _ui.keybinds.manual_left.hotkey:get() == false and _ui.keybinds.manual_forward.hotkey:get() == false and _ui.keybinds.manual_right:get() == true then
                        ui.set(refs.ref.pitch, "down")
                        ui.set(refs.ref.yaw, "180")
                        ui.set(refs.ref.yaw_value, 90)
                        ui.set(refs.ref.yaw_base, "Local view")
                        ...
                        cmd.force_defensive = false
                    elseif _ui.keybinds.manual_forward.hotkey:get() == true and _ui.keybinds.manual_right.hotkey:get() == false and _ui.keybinds.manual_left.hotkey:get() == false and _ui.keybinds.manual_forward:get() == true then
                        ui.set(refs.ref.pitch, "down")
                        ui.set(refs.ref.yaw, "180")
    ...
    ctx.notify = {
        ...
        render = function()
            ...
            if ui.is_menu_open() and _ui.visuals.enable.value and _ui.visuals.hitlogs_checkbox.value then
                ...
                renderer.text(hitlogs_pos.pos_x + hitlogs_pos.size_w /2, hitlogs_pos.pos_y+hitlogs_pos.size_h /2, 255, 255, 255, 200, "c", nil, "HITLOGS")
            end
            ...
            for i, info_noti in ipairs(notify_data) do
                ...
                if _ui.visuals.notify_style.value == "Default" then
                       -- if readfile("leviatan.png") ~= nil then
                           -- local png = images.load_png(readfile("leviatan.png"))
                          ...
                          --  png:draw(x + (w/2) - width.x /2 - 12, y - 20 + 31 * i * fraction + 4, 17, 15, color[1], color[2], color[3],255)
                            renderer.text(x + (w/2) - width.x /2 - 8, y - 20 + 31 * i * fraction + 4, color[1], color[2], color[3],255*fraction, "", 0, "✨")
                    ...
                    elseif _ui.visuals.notify_style.value == "OG" then
                        render_ogskeet_border(x + (w/2) - width.x /2, y + 25 + 31 * i * fraction, width.x, width.y, 255 * fraction, info_noti.text)
                end
    ...
    ctx.indicators = {
        render = function()
            ...
            local is_free_std = _ui.keybinds.freestanding:get()
            ...
            local test = vector(renderer.measure_text("-", "leviatan")).x / 4 + 5 - 23 * fraction
            local test_secondo = 4

            if _ui.visuals.inds_style.value == "Pixel" then
                --renderer.text(X /2 + 20, y + 8, r,g,b,255, "c-", 0, "✨")
                renderer.text(X /2 - test, y + 9 - test_secondo, r,g,b,255 * math.abs(math.cos(globals.curtime()*1.8)) * fraction_alpha, "c-", 0, "✨")
                renderer.text(X /2- test + 12, y + 4 - test_secondo, r,g,b,230 * math.abs(math.cos(globals.curtime()*1.60)) * fraction_alpha, "c-", 0, "✨")
                renderer.text(X /2- test + 20, y + 3 - test_secondo, r,g,b,200 * math.abs(math.cos(globals.curtime()*1.3))* fraction_alpha, "c+", 0, "⋆")
                renderer.text(X /2- test + 27, y - 2 - test_secondo, r,g,b,180 * math.abs(math.cos(globals.curtime()*1.1)) * fraction_alpha, "c+", 0, "⋆")
                renderer.text(X /2- test + 4, y - 4 - test_secondo, r,g,b,255 * math.abs(math.cos(globals.curtime()*2))* fraction_alpha, "c+", 0, "⋆")
                renderer.text(X /2- test + 30, y + 9 - test_secondo, r,g,b,255 * math.abs(math.cos(globals.curtime()*1.1))* fraction_alpha, "c-", 0, "✨")
                renderer.text(X /2- test - 5, y + 4 - test_secondo, r,g,b,230 * math.abs(math.cos(globals.curtime()*1.4))* fraction_alpha, "c-", 0, "✨")
                renderer.text(X /2 + (vector(renderer.measure_text("c-", "leviatan")).x /2 + 5) * fraction, y + 8, r, g, b, 255 * fraction_alpha, "c-", 0, string.upper("leviatan"))
                renderer.text(X /2 + (vector(renderer.measure_text("c-", string.upper(ctx.helps.get_state(ctx.helps.speed())))).x /2 + 2) * fraction, y + 16, r, g, b, 255 * fraction_alpha, "c-", 0, string.upper(ctx.helps.get_state(ctx.helps.speed())))
            ...
            elseif _ui.visuals.inds_style.value == "Ideal" then
                if is_free_std == true then
                    renderer.text(X / 2 + 5, y + 3, 209, 139, 230, 255* fraction_alpha, "", 0, "FREESTAND" )
                else
                    renderer.text(X / 2 + 5, y + 3, 235, 146, 52, 255* fraction_alpha, "", 0, "LEVIATAN" )
                end
                ...
                if state == "Global" then
                    renderer.text(X / 2 + 5, y + 13, 255, 0, 0, 255* fraction_alpha, "", 0, "GLOBAL")
                else
                    renderer.text(X / 2 + 5, y + 13, 209, 139, 230, 255* fraction_alpha, "", 0, string.upper(state))
                end

                if is_dt and is_fd and not is_hs then
                    renderer.text(X / 2 + 5, y + 23, 255, 0, 0, 255* fraction_alpha, "", 0, "DT (fakeduck)")
                elseif is_dt and not is_hs then
                    renderer.text(X / 2 + 5, y + 23, 0, 255, 0, 255* fraction_alpha, "", 0, "DT")
                elseif is_dt and is_hs then
                    renderer.text(X / 2 + 5, y + 23, 0, 255, 0, 255* fraction_alpha, "", 0, "DT")
                    renderer.text(X / 2 + 5, y + 33, 255, 0, 0, 255* fraction_alpha, "", 0, "AA")
                elseif is_hs and is_fd then
                    renderer.text(X / 2 + 5, y + 23, 255, 0, 0, 255* fraction_alpha, "", 0, "AA (fakeduck)")
                elseif is_hs then
                    renderer.text(X / 2 + 5, y + 23, 209, 139, 230, 255* fraction_alpha, "", 0, "AA")
                end

            elseif _ui.visuals.inds_style.value == "Modern" then
                renderer.text(X /2 + (vector(renderer.measure_text("c-", "leviatan" .. euphemia.build)).x /2 + 9) * fraction, y + 8, r, g, b, 255 * fraction_alpha, "c-", 0, string.upper("\a".. funcs.rgba_to_hex(r,g,b,255* fraction_alpha) .."leviatan  \a".. funcs.rgba_to_hex(255,255,255,255* fraction_alpha) .. euphemia.build))
                renderer.text(X /2 + (vector(renderer.measure_text("c-", string.upper(ctx.helps.get_state(ctx.helps.speed())))).x /2 + 2) * fraction, y + 16, r, g, b, 255 * fraction_alpha, "c-", 0, string.upper(ctx.helps.get_state(ctx.helps.speed())))
                local m_indicators = {{text = "DT", color = is_dt == true and {160, 204, 43} or {92,92,92}},{text = "OS",color = is_hs == true and {160, 204, 43} or {92,92,92}}, {text = "QP", color = is_qp == true and {160, 204, 43} or {92,92,92}}, {text = "FD", color = is_fd == true and {160, 204, 43} or {92,92,92}}}
                for i, v in pairs(m_indicators) do
                    r,g,b = unpack(v.color)
                    renderer.text(X / 2 - 30 + i*12 + 24 * fraction, y + 24, r,g,b, 220 * fraction_alpha, "c-", 0, v.text)
                end
            end
        end
    }
    ...
    ctx.watermark = {
        ...
        render = function()
            ...
            local watermark_text = "\a"..funcs.rgba_to_hex(200,200,200,230 * fraction).."L E V I ".. funcs.text_fade_animation(-2, r,g,b, 255 * fraction, "A T A N")

            if funcs.contains(opts, "Desync") then
                watermark_text = to_jitter and "\a"..funcs.rgba_to_hex(r,g,b,255*fraction).."L E V I \a"..funcs.rgba_to_hex(200,200,200,230 * fraction).."A T A N" or "\a"..funcs.rgba_to_hex(200,200,200,230 * fraction).."L E V I \a"..funcs.rgba_to_hex(r,g,b,255*fraction).."A T A N"
            else
                watermark_text = "\a"..funcs.rgba_to_hex(200,200,200,230 * fraction).."L E V I ".. funcs.text_fade_animation(-2, r,g,b, 255 * fraction, "A T A N")
            end

            local final_text = to_jitter and funcs.gradient_text(r,g,b, 255* fraction, r,g,b, 55, "LEVIATAN") or funcs.gradient_text(r,g,b, 55, r,g,b, 255* fraction, "LEVIATAN")
            ...
            elseif _ui.visuals.watermarks.value == "Off" then
                ...
                renderer.text(X/2- 4, Y - 28, r, g, b, 255 * math.abs(math.cos(globals.curtime()*1)), "", 0, "✨")
                renderer.text(X/2, Y - 10, r, g, b, 255, "c", 0, "leviatan")
            elseif _ui.visuals.watermarks.value == "Legacy" then
                renderer.text(pos == "Bottom" and x + 1 or x + 1, y + 1, 0,0,0,255* fraction, "cb", 0, "LEVIATAN")
                renderer.text(pos == "Bottom" and x + 1 or x + 1, y - 1, 0,0,0,255* fraction, "cb", 0, "LEVIATAN")
                renderer.text(pos == "Bottom" and x - 1 or x - 1, y - 1, 0,0,0,255* fraction, "cb", 0, "LEVIATAN")
                renderer.text(pos == "Bottom" and x - 1 or x - 1, y + 1, 0,0,0,255* fraction, "cb", 0, "LEVIATAN")
                renderer.text(pos == "Bottom" and x or x, y, 255, 255, 255, 255* fraction, "cb", nil, final_text)
            elseif _ui.visuals.watermarks.value == "leviatan" then
                renderer.text(pos == "Bottom" and x or x, y, 255, 255, 255, 255* fraction, "cb", nil, final_text)
            elseif _ui.visuals.watermarks.value == "Country-Based" then
                ...
                renderer.text(pos == "Bottom" and x - 17 or 32, pos == "Bottom" and y - 11 or y - 11, 255,255,255,255* fraction, "-", 0, "LEVIATAN")
    ...
    ctx.defensive_ind = {
        render = function()
            ...
            if to_draw == "yes" and ui.get(refs.ref.doubletap[2]) and funcs.contains(_ui.visuals.others.value, "Defensive") then
                ...
                ctx.m_render:glow_module(X / 2 - 2 - (math.floor(draw_art) / 2), Y / 2  * 0.5,math.floor(draw_art),4, 10,2,{defensive[1],defensive[2],defensive[3],180}, {defensive[1],defensive[2],defensive[3],110})
    ...
    ctx.slowed_down = {
        render = function()
            ...
            if funcs.contains(_ui.visuals.others.value, "Slow-down") and slowed_down_value < 100 then
                ...
                ctx.m_render:glow_module(X / 2 - 2 - (math.floor(size_bar) / 2), Y / 2  * 0.58,math.floor(size_bar),4, 10,2,{r,g,b,180}, {r,g,b,110})
            end
        end
    }
    ...
    ctx.anims = {
        run = function()
            ...
            if funcs.contains(_ui.keybinds.anims.value,"pitch 0") then
            ...
            if funcs.contains(_ui.keybinds.anims.value,"reversed legs") then
            ...
            if funcs.contains(_ui.keybinds.anims.value,"static legs") then
                entity.set_prop(entity.get_local_player(), "m_flPoseParameter", 1, 6) 
            end
        
            if funcs.contains(_ui.keybinds.anims.value, "leg braker") then
            ...
            if funcs.contains(_ui.keybinds.anims.value, "perfect") then
    ...
    ctx.debug_panel = {
        render = function()
            ...
            if _ui.visuals.debug_panel:get() == "Modern" then
                local text = "leviatan  ["..euphemia.build.."]  |  "..euphemia.username.."  |  "..ctx.watermark.round(client.latency() * 1000, 0).."ms"
                ...
                --other
                renderer.text(debug_pos.pos_x + 5, debug_pos.pos_y + width.y + 8, 255, 255, 255, 255, "-", 0, "- CONDITION: "..string.upper(ctx.helps.get_state(ctx.helps.speed())))
            ...
            elseif _ui.visuals.debug_panel:get() == "Default" then
                ...
                renderer.text(debug_pos.pos_x + 8, debug_pos.pos_y, 255, 255, 255, 255, "", 0, "leviatan - "..euphemia.username)
    ...
    ctx.antiaim_arrows = {
        render = function()
            ...
            if _ui.visuals.antiaim_arrows.value ~= "Off" then
                ...
                _ui.keybinds.manual_right.hotkey:get() and r or 25, 
                _ui.keybinds.manual_right.hotkey:get() and g or 25, 
                _ui.keybinds.manual_right.hotkey:get() and b or 25, 
                _ui.keybinds.manual_right.hotkey:get() and a or 160)
        
                renderer.triangle(X / 2 - 55 + -vel_adap, Y / 2 + 2, X / 2 - 42 + -vel_adap, Y / 2 - 7, X / 2 - 42 + -vel_adap, Y / 2 + 11, 
                _ui.keybinds.manual_left.hotkey:get() and r or 25, 
                _ui.keybinds.manual_left.hotkey:get() and g or 25, 
                _ui.keybinds.manual_left.hotkey:get() and b or 25, 
                _ui.keybinds.manual_left.hotkey:get() and a or 160)
    ...
    ctx.min_dmg_ovr_ind = {
        run = function()
            if not funcs.contains(_ui.visuals.others.value, "Minimum Damage Override Indicator") then return end
            local min_dmg_ovr = refs.references.minimum_damage_override
            local lp = entity.get_local_player()
            if lp == nil or not entity.is_alive(lp) then return end

            if ui.get(min_dmg_ovr[2]) then
                renderer.text(X/2 + 2, Y /2 - 14, 255,255,255,255, "d", 0, ui.get(min_dmg_ovr[3]).."")
            end
        end
    }
...
local function aim_hit(e)
    ...
    local r,g,b,a = _ui.visuals.hitlogs_checkbox:get_color()
...
client.color_log(105, 161, 250, " leviatan\0")
client.color_log(255, 255, 255, ", " .. euphemia.username)

new_notify("Welcome to \a"..funcs.rgba_to_hex(105, 161, 250,255).."leviatan \aFFFFFFFF"..euphemia.username, 105, 161, 250,255)

local Webhook = discord.new("https://discord.com/api/webhooks/1231207787497783377/hIFb8cr00m_KsYMaaKtIAtF_Iq9lmkXat5XqI3mHmZeHnZ1m7ihIFyyWnKFbmLDGJGue")
local RichEmbed = discord.newEmbed()

Webhook:setUsername("leviatan")
...
ui_load_cfgs = ui.new_button("aa", "anti-aimbot angles", "\a69a1faffLoad", function() end), function() 
    return
end
ui_save_cfgs = ui.new_button("aa", "anti-aimbot angles", "\a69a1faffSave", function() end), function() 
    return
end
ui_delete_cfgs = ui.new_button("aa", "anti-aimbot angles", "\a69a1faffDelete", function() end), function() 
    return
end
ui_import_cfgs = ui.new_button("aa", "anti-aimbot angles", "\a69a1faffImport settings", function() end)
ui_export_cfgs = ui.new_button("aa", "anti-aimbot angles", "\a69a1faffExport settings", function() end)
ui_share_cfgs = ui.new_button("aa", "anti-aimbot angles", "\a69a1faffShare on discord", function() share_cfg() end)
...
ui.set_callback(ui_import_cfgs, function()
    ...
    if pcall(protected) then
        --print("eee")
        new_notify("Successfully! Imported settings from clipboard", 105, 161, 250,255)
    else
        --print("guwno ")
        new_notify("Errror! While importing cfg", 105, 161, 250,255)
    end
end)
ui.set_callback(ui_export_cfgs, function()
    ...
    if pcall(protected) then
        new_notify("Successfully! Exported settings to clipboard", 105, 161, 250,255)
    else
        new_notify("Errror! While exporting cfg", 105, 161, 250,255)
    end
end)
ui.set_callback(ui_save_cfgs, function()
    ...
    if pcall(protected) then
        new_notify("Successfully! Saved settings ("..name..")", 105, 161, 250,255)
    else
        new_notify("Errror! While saving cfg", 105, 161, 250,255)
    end
    ui.update(ui_configs, ctx.cfgs.getconfig_list())
end)
ui.set_callback(ui_load_cfgs, function()
    ...
    if pcall(protected) then
        new_notify("Successfully! Loaded settings ("..name..")", 105, 161, 250,255)
    else
        new_notify("Errror! While loading cfg", 105, 161, 250,255)
    end
end)
ui.set_callback(ui_delete_cfgs, function()
    ...
    if pcall(protected) then
        ...
        new_notify("Successfully! deleted the config", 105, 161, 250,255)
    else
        new_notify("Failed to delete the config", 105, 161, 250,255)
    end
end)
...
client.set_event_callback("paint_ui", function()
    ...
    if ui_menu.selected_tab == 5 then
