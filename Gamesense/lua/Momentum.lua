...
local main = function()
    ...
    local obex_data = obex_fetch and obex_fetch() or {username = "scriptleaks", build = "stable"}
    ...
    -- Header related
    local images_links = {
        "http://cloudpusy.ct8.pl/loader/gamesensetools/taser_icon.png"; -- logo
        "http://cloudpusy.ct8.pl/loader/gamesensetools/gst_menu_icon_antiaim.png"; -- antiaim
        "http://cloudpusy.ct8.pl/loader/gamesensetools/gst_menu_icon_other.png"; -- misc
        "http://cloudpusy.ct8.pl/loader/gamesensetools/gst_menu_icon_visuals.png"; -- visuals
        "http://cloudpusy.ct8.pl/loader/gamesensetools/gst_menu_icon_ragebot.png"; -- cfg
    }
