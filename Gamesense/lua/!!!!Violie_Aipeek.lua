...
ADSe2e = ui.new_label("Misc", "Movement", "**********AI PEEK***********")

local menu = {
    main_switch = ui_new_checkbox("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFMain switch"),
    key = ui_new_hotkey("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFMain switch", true, 0),
    dt_peek = ui.new_hotkey('Misc', 'Movement', "\aAFAFC3FF[Pr] \aFFFFFFFFDT teleport prediction",false),
    mode = ui_new_combobox("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFAi mode", {"Risky", "Safest"}),
    target = ui_new_combobox("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFAi target", {"Current", "All target"}),
    hitbox = ui_new_multiselect(
        "Misc",
        "Movement",
        "\aAFAFC3FF[Violie] \aFFFFFFFFhitboxes",
        {"Head", "Neck", "Chest", "Stomach", "Arms", "Legs", "Feet"}
    ),
    tick = ui_new_slider("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFReserve extrapolate tick", 0, 5, 0),
    unlock = ui_new_checkbox("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFUnlock camera"),
    segament = ui_new_slider("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFSegament", 2, 60, 2),
    radius = ui_new_slider("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFRadius", 0, 250, 50),
    depart = ui_new_slider("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFDepartment", 1, 12, 2),
    middle = ui_new_checkbox("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFMiddle point"),
    limit = ui_new_checkbox("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFMax prediction point limit"),
    limit_num = ui_new_slider("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFLimit num", 0, 20, 5),
    debugger = ui_new_multiselect(
        "Misc",
        "Movement",
        "\aAFAFC3FF[Violie] \aFFFFFFFFAI indicators",
        {"Line player-predict", "Line predict-target", "Fraction detection", "Base"}
    ),
    color = ui_new_color_picker("Misc", "Movement", "\aAFAFC3FF[Violie] \aFFFFFFFFindicators color", 255, 255, 255, 255)
}
