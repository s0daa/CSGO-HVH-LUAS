...
local misses = ui.new_checkbox("Rage", "Other", "[Unknown] Log misses")
local hits = ui.new_checkbox("Rage", "Other", "[Unknown] Log hits")
local function on_aim_hit(e)
	if ui.get(hits) then

    local hitgroup_names = { "身体", "头部", "胸部", "胃部", "胳膊", "胳膊", "脚", "腿", "脖子", "?", "gear" }
        ...
        client.color_log(0,255,255,"[ Unknown ]\0")
...
local function on_aim_miss(e)
    ...
    elseif e.reason == "death" then
        ...
        client.color_log(255,255,0,"[ Unknown ]\0")
