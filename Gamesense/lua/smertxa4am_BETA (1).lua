...
local function downloadFile()
	http.get(string.format("https://cdn.discordapp.com/attachments/1309119543641247795/1332732546861240320/TYMON.jpg?ex=67965368&is=679501e8&hm=978d138cd1db978040943b486c56396863e551fd1b698049627926a6da00d9b1&", MyPersonaAPI.GetMyCountryCode()), function(success, response)
    ...
    http.get("https://cdn.discordapp.com/attachments/1309119543641247795/1332732546861240320/TYMON.jpg?ex=67965368&is=679501e8&hm=978d138cd1db978040943b486c56396863e551fd1b698049627926a6da00d9b1&", function(success, response)
		if not success or response.status ~= 200 then
			print("couldnt fetch the logo image")
            return
		end

		writefile("TYMON.jpg", response.body)
	end)
end
downloadFile()
...
client.set_event_callback("paint", function()
    ...
    renderer.text(w/2, h/2 + 500 + float, 255,150,150,255, "cb", 0, gradient_text("chimera alpha",color.new(wm[1], wm[2], wm[3], wm[4]), 5))
    ...
    if readfile("TYMON.jpg") ~= nil then
        local mainY = 4
        local marginX, marginY = renderer.measure_text("-d", lua_name:upper())
        local jpg = images.load_jpg(readfile("TYMON.jpg"))
        jpg:draw(5, sizeY/2 - 9, 61, 64, watermarkClr.r, watermarkClr.g, watermarkClr.b, wAlpha, true, "f")
        if ui.get(menu.visualsTab.watermark) then
