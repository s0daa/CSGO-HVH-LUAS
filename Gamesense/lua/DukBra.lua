...
client.set_event_callback('paint_ui', function()
	...
	renderer.text(screen.x/10, screen.y/3, 184, 184, 184, 255, 'c', 0, '- They wanna see me dead (nova chance) [BETA]')
	...
	if renderguwno == "yes" then
		...
		renderer.text(screen.x/2, screen.y - y, 184, 184, 184, alpha, 'c', 0, 'mygirl uwu')
