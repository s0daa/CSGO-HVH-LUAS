...
local menu = {
    ...
    indicators_combo = ui_new_combobox(adaptive_c, adaptive_d, "Indicators style", "Default", "Old", "Centered"),
...
local lua_user = obex_fetch and obex_fetch() or {username = 'dev', build = 'Source', discord='https://discord.gg/wdgBFcCx6E'}
