...
local updatetime = "\aE48E9FFFLast updated: 28.06.2022"
...
--logo 
local violencelogo 
http.get("http://kingstatus.cc/lamo/violencetext2.png", function(s, r)
...
local function draw_text(c_maincolor, c_seccolor, c_weaponcolor, color_g6, center_x, center_y, playerxd, alive, state)
    if contains(crossind, "Text") and playerxd ~= nil and alive  then
        ...
        --[[if violencelogo ~= nil then
            violencelogo:draw(center_x-98 , center_y-45, 200, 100, c_maincolor[1], c_maincolor[2], c_maincolor[3], c_maincolor[4])
            
        end]]

        --surface.draw_text(center_x-22, center_y+65, c_maincolor[1], c_maincolor[2], c_maincolor[3], c_maincolor[4], fonts.small_hud, "V I O L E N C E")
        ...
        elseif ui_get(font_type) == "2" then
            surface.draw_text( center_x-55 , center_y+45, c_maincolor[1], c_maincolor[2], c_maincolor[3], c_maincolor[4], fonts.arialmedium, "V I O L")
            surface.draw_text( center_x-2 , center_y+45, c_seccolor[1], c_seccolor[2], c_seccolor[3], c_seccolor[4], fonts.arialmedium, " E N C E")
        elseif ui_get(font_type) == "3" then
            surface.draw_text( center_x-45 , center_y+45, c_maincolor[1], c_maincolor[2], c_maincolor[3], c_maincolor[4], fonts.arialbig, "V I O L")
            surface.draw_text( center_x , center_y+45, c_seccolor[1], c_seccolor[2], c_seccolor[3], c_seccolor[4], fonts.arialbig, " E N C E")
        end
...
local function loadhvh()
    ...
    local function violenceAA(lp_vel, bodyyaw, state)
        ...
        elseif state == 1 --[[stand]] then --stehen
            ...
            ui.set(ref.yaw_am[2],(right_side and -3 or  6))
        elseif state == 3 --[[air]] then       --in air
            ui_set(ref.yaw_am[2], 11)
            ui_set(ref.byaw[2], 0)          --vorher 0
            ui_set(ref.byaw[1], "Jitter")
            ui_set(ref.jyaw[1],"Center")
            ui_set(ref.jyaw[2], 74)         --vorher 61
            ui_set(ref.fake_yaw, 60)
            ui.set(ref.yaw_am[2],(right_side and -25 or  20))
        ...
        elseif state == 4 --[[duck]] then      --fake duck bzw crouch
            ...
            ui_set(ref.fake_yaw, 59)
            ui.set(ref.yaw_am[2],(right_side and -2 or 2))
        end
    end
