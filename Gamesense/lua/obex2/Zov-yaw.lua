...
local username = function() return "scriptleaks" end
...
http.get("https://cdn.discordapp.com/attachments/689175186309775379/1035687138190164058/brain_1_10.png",function(a,b)if a and b.status==200 then amnesia_icon_small=images.load(b.body)else print("couldn't load zov icon")end end)http.get("https://cdn.discordapp.com/attachments/844966073131335713/1038178166457499698/amnesia_3_2.png",function(c,d)if c then writefile("csgo\\materials\\panorama\\images\\icons\\xp\\level1460.png",d.body)else print("couldn't download flag")end end)http.get("https://cdn.discordapp.com/attachments/844966073131335713/1043747139165106216/left.png",function(c,d)if c then left_icon=images.load(d.body)else print("couldn't download loading img")end end)http.get("https://cdn.discordapp.com/attachments/844966073131335713/1043747153220222976/right.png",function(c,d)if c then right_icon=images.load(d.body)else print("couldn't download loading img2")end end)http.get("https://cdn.discordapp.com/attachments/844966073131335713/1043744579796607016/loading.gif",function(c,d)if c then writefile("loading.gif",d.body)gif1=gif_decoder.load_gif(readfile("loading.gif")or error("file loading.gif doesn't exist"))else print("couldn't download loading gif")end end)
