...
local function paint()
    ...
    elseif ui.get(menu.Visuals.indicator_mode) == "Modern" then
        ...
        renderer.text(middle[1] + 24, middle[2] + 35, color[1], color[2], color[3], alpha_pulse, "-", 0, "DEBUG")
    ...
    elseif ui.get(menu.Visuals.indicator_mode) == "Legacy[1]" then
        ...
        local text = "NIGGA [DEBUG]" .. "     |    " .. string.upper(tostring(obex.username)) .. "     |    " .. string.format("%dMS", latency)
