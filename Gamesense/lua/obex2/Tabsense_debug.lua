...
local obex_data = obex_fetch and obex_fetch() or {username = 'wyscigufa9', build = 'DEV', discord=''}
...
local _ui = {
    lua = {
        enable = group:checkbox("\vtabsense - "..obex_data.username..""),
    ...
    antiaim = {
        ...
        cfg_reset = group:button("\ae32727FFReset anti-aim settings", function() config.import("") end),
    ...
    visuals = {
        ...
        color_style = ui.new_color_picker("aa", "anti-aimbot angles", "Color", 227, 39, 39,255),
        ...
        indicators_on = group:checkbox("Indicators", {227, 39, 39,255}),
        indicators = group:combobox("Style", "Minimal", "Pixel"),
        watermark = group:checkbox("Watermark", {227, 39, 39,255}),
        slowed_down = group:checkbox("Slowed down", {227, 39, 39,255}),
        defensive_ind = group:checkbox("Defensive indicator", {227, 39, 39,255}),
        min_dmg_ind = group:checkbox("Minimum Damage Override Indicator", {227, 39, 39,255}),
        damage_ind = group:checkbox("3D hitmarker", {227, 39, 39,255}),
    ...
    resolver = {
        enable = resolver_gr:checkbox("\vResolver"),
        delta_mode = resolver_gr:combobox("Delta Mode", "FIRST", "SECOND", "THIRD"),
        reso_mode = resolver_gr:combobox("Mode", "FIRST", "SECOND", "THIRD"),
        pitch_reso = resolver_gr:checkbox("Pitch Resolver"),
        resolver_disabler = resolver_gr:multiselect("Resolver Disabler", "CORRECTION ACTIVE","MOVE","CROUCH","INAIR","SLOWWALK"),
...
_ui.resolver.reso_mode:depend({_ui.resolver.enable, true})
_ui.resolver.delta_mode:depend({_ui.resolver.enable, true})
_ui.resolver.pitch_reso:depend({_ui.resolver.enable, true})
_ui.resolver.resolver_disabler:depend({_ui.resolver.enable, true})
...
local function ResolveJitter(player, currentYaw, currentEyeAnglesX, currentEyeAnglesY)
    ...
    local layer = get_anim_layer(lpent, player)
    ...
    -- local delta = math.floor(normalize_yaw1(entity_get_prop(player, "m_angEyeAngles[1]")))

    -- local delta = normalize_yaw1(entity_get_prop(player, "m_angEyeAngles[1]"))
    -- local delta = normalize_yaw1(entity_get_prop(player, "m_angEyeAngles[1]")) - entity.get_prop(player, "m_flPoseParameter", 11)
    if _ui.resolver.delta_mode.value == "FIRST" then
        delta = entity.get_prop(player, "m_angEyeAngles[1]"), entity.get_prop(player, "m_angEyeAngles[0]")
    elseif _ui.resolver.delta_mode.value == "SECOND" then
        delta = entity.get_prop(player, "m_angEyeAngles[1]") * (entity.get_prop(player, "m_flPoseParameter", 11) or 1) * 116 - 58, entity.get_prop(player, "m_angEyeAngles[0]")
    elseif _ui.resolver.delta_mode.value == "THIRD" then
        delta = entity.get_prop(player, "m_angEyeAngles[1]") - entity.get_prop(player, "m_flPoseParameter", 11)
    end
    ...
    local targetYaw = entity.get_prop(player, "m_angEyeAngles[1]")
    local JitterFix = entity.get_prop(player, "m_angEyeAngles[0]")
    local targetOldYaw = plist.get(player, "Force body yaw value") 
    local targetYawDelta = math.abs(targetYaw - targetOldYaw) 
    enemyyaw = targetYawDelta



    local targetAimtimeDelta = lastShotTime
    ejteim = targetAimtimeDelta

    local targetBodyYawValue = plist.get(player, "Force body yaw value")
    bodiyaw = targetBodyYawValue

    local yaws
    local yaws_multiplier = 1.3

    local yaw1 = entity.get_prop(player, "m_flPoseParameter", 11) * 120 - 60 --moze crashowac


    --local yaw1 = (entity.get_prop(player, "m_flPoseParameter", 11) or 1) * 116 - 58

    if _ui.resolver.reso_mode.value == "FIRST" then
            yaws = delta * animstate.m_flCurrentTorsoYaw * layer.m_flPlaybackRate * yaw1
    elseif _ui.resolver.reso_mode.value == "SECOND" then
            yaws = delta * entity.get_prop(player, "m_flPoseParameter", 11)
    elseif _ui.resolver.reso_mode.value == "THIRD" then
    ...
    if contains(_ui.resolver.resolver_disabler.value, "CORRECTION ACTIVE") then
        plist.set(player, "Correction Active", true)
    elseif velocity == 0 or velocity == 1 then
        plist.set(player, "Force body yaw", false)
    elseif contains(_ui.resolver.resolver_disabler.value, "MOVE") and velocity > 10 and not isinair then
        plist.set(player, "Force body yaw", false)
    elseif  contains(_ui.resolver.resolver_disabler.value, "CROUCH") and nDuckAmount > 0 then
        plist.set(player, "Force body yaw", false)
    elseif contains(_ui.resolver.resolver_disabler.value, "INAIR") and isinair then
        plist.set(player, "Force body yaw", false)
    elseif contains(_ui.resolver.resolver_disabler.value, "SLOWWALK") and velocity > 6 and velocity < 90 and velocity > 70 then
        plist.set(player, "Force body yaw", false)
    else
...
local function Resolver(player)
    if _ui.resolver.enable.value then
        ...
        if _ui.resolver.pitch_reso.value then
            ResolvePitchExp(player, currentEyeAnglesX)
        end
    ...
    ctx.watermark = {
        render = function()
            if(_ui.visuals.watermark.value) then
                ...
                local text_size = vector(renderer.measure_text("cb", "T A B S E N S E  ["..obex_data.build:gsub(".", " %0"):sub(2):upper() .."]"))
              ...
              --print(ui.mouse_position()[1])
                renderer.text(watermark_x, watermark_y, 255, 255, 255, 255, "cb", nil, text_fade_animation_guwno(1, r, g, b, a, "T A B S E N S E ").. "\a"..rgba_to_hex(r,g,b,a).."["..obex_data.build:gsub(".", " %0"):sub(2):upper().."]")
            else
                local color_table = { _ui.visuals.watermark:get_color() }
                local r,g,b,a = unpack(color_table)
              ...
              --  renderer.text(X - 120 + text_size_guwno.x /2, Y - Y + 39, 255, 255, 255, 255, "c", nil, "tabsense - "..build.."")
                ...
                renderer.text(X/2, Y/2 + 510 + float, 255,150,150,255, "cb", 0, "\a363636FF["..ctx.animation.gradient_text(string.upper(obex_data.build), 5, r,g,b,a).."\a363636FF]")
            end
        end
    }
...
--     local r,g,b,a = ui.get(_ui.config_g.menu_color)
...
--     print(color_r,color_g,color_b,255)
-- end)
