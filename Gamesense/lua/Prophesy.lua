...
local obex_data = obex_fetch and obex_fetch() or {username = 'scriptleaks', build = 'nightly', discord=''}
...
prophesy = {
    table = {
        config_data = {};
        visuals = {
            picture = "http://cloudpusy.ct8.pl/loader/prophesy/255px-Transgender_Pride_flag.png";
            image_loaded = "";
            animation_variables = {};
            new_change = true;
            to_draw_ticks = 0;
...
prophesy.menu.antiaim_discord = ui.new_button("AA", "Anti-aimbot angles", "load button" , function()
    if ui.get(prophesy.menu.antiaim_combo) == "discord" then
    panorama.loadstring("SteamOverlayAPI.OpenExternalBrowserURL('https://discord.gg/scriptleaks');")()
    elseif ui.get(prophesy.menu.antiaim_combo) == "youtube" then
    panorama.loadstring("SteamOverlayAPI.OpenExternalBrowserURL('https://www.youtube.com/watch?v=QXyvTeWiwNE');")()
    end
end);
