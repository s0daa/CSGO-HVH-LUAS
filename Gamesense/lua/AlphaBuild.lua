...
local lua_data = {
    username = "-", 
    build = "\aDB90E2FFalpha\affffffff",
    version = "1.2"
}
...
local ent_last_sim_time = 0
local ent_defensive_until = 0
local function is_player_defensive_active(player)
    local tickcount = globals.tickcount()
    local sim_time = toticks(entity.get_prop(player, "m_flSimulationTime"))
    local sim_diff = sim_time - ent_last_sim_time

    if sim_diff < 0 then
        ent_defensive_until = tickcount + math.abs(sim_diff) - toticks(client.latency())
    end

    ent_last_sim_time = sim_time

    return ent_defensive_until > tickcount
end
...
local _ui = {
    ...
    start = {
        group:label("   "),
        hello_im_braindead = group:label(" \a5F5F5FFF»  \rWelcome back"),
        look_i_shit_myself = group:label(" \a5F5F5FFF»  \rScript build: "..lua_data.build),
        my_iq_is_lower_then_my_age = group:label(" \a5F5F5FFF»  \rScript version: \aFFFFFFFF"..lua_data.version),
        group:label(" "),
    ...
    ragebot = {
        ...
        resolver_mode = group:combobox("\a5F5F5FFF»  \rMode", "Default", "Experimental"),
        defensive_aa_resolver = group:checkbox("Defensive anti-aim resolver"),
        backtrack_exploit = group:checkbox("Backtrack exploit"),
        dt_last_tick = group:checkbox("Doubletap on last tick"),
        group:label("\a515151FF—  Safety"),
        force_body = group:checkbox("Force body aim on lethal"),
        group:label("\a515151FF—  Other"),
        shot_logs = group:checkbox("Aimbot logs"),
        peekbot = group:checkbox("Peek bot"),
        peekbot_bind = group:hotkey("\a5F5F5FFF»  \rPeek bot bind"),
        peekbot_distance = group:slider("\a5F5F5FFF»  \rTracing distance", 30, 100, 60),
        peekbot_freestanding = group:checkbox("\a5F5F5FFF»  \rFreestanding"),
        peekbot_visualize = group:checkbox("\a5F5F5FFF»  \rRenderer trace positions"),
    },
    ...
    antiaim = {
        ...
        builder = {
            ...
            condition = group:combobox("Player state", aa_state),
        },
        ...
        configs = {
            ...
            cfg_reset = group:button("\ac32e1dffReset anti-aim settings", function() config.reset("") end)
        }
    },
    ...
    visuals = {
        ...
        indicators_binds = group:multiselect("  \a5F5F5FFF»  \rBinds", "Double tap", "Hide shots", "Damage override", "Force body aim", "Force safe points", "Quick peek", "Freestanding", "Edgeyaw", "Fakeduck"),
        ...
        lagcomp_debug = group:checkbox("Lagcomp debug")
    },
...
for i = 1, 7 do
    ...
    aa_builder[i].fakelag_override = pui.group("aa","fake lag"):checkbox("Override \v"..aa_state[i].."\r fake lag")
    aa_builder[i].fakelag_amount = pui.group("aa","fake lag"):combobox("\v"..aa_state[i].."  \a5F5F5FFF»\r  Amount", "Dynamic", "Fluctuate", "Maximum")
    aa_builder[i].fakelag_variance = pui.group("aa","fake lag"):slider("\v"..aa_state[i].."  \a5F5F5FFF»\r  Variance", 0, 100, 0)
    aa_builder[i].fakelag_limit = pui.group("aa","fake lag"):slider("\v"..aa_state[i].."  \a5F5F5FFF»\r  Limit", 1, 15, 13)
end
...
local visiblity = function()
    ...
    for i = 1, 7 do
        ...
        for i, f in pairs({aa_builder[i].override.ref, aa_builder[i].yaw_value.ref, aa_builder[i].yaw_modifier.ref, aa_builder[i].body_yaw.ref, aa_builder[i].defensive_modifiers.ref}) do
            ui.set_visible(f, req)
        end
        ...
        for _, x in pairs({aa_builder[i].fakelag_amount.ref, aa_builder[i].fakelag_variance.ref, aa_builder[i].fakelag_limit.ref}) do
            ui.set_visible(x, _ui.lua.enable.value and _ui.antiaim._global.enable.value and aa_builder[i].fakelag_override.value and _ui.antiaim.builder.condition.value == aa_state[i] and (ui.get(ref.fl_enable[1]) and ui.get(ref.fl_enable[2])))        
        end
    end
    ...
    for i = 2, 7 do ui.set_visible(aa_builder[i].fakelag_override.ref, _ui.lua.enable.value and _ui.antiaim._global.enable.value and _ui.antiaim.builder.condition.value == aa_state[i] and (ui.get(ref.fl_enable[1]) and ui.get(ref.fl_enable[2]))) end ui.set_visible(aa_builder[1].fakelag_override.ref, false) ui.set(aa_builder[1].fakelag_override.ref, true)
    ...
    ui.set_visible(ref.fl_amount, not (_ui.lua.enable.value and _ui.antiaim._global.enable.value))
    ui.set_visible(ref.fl_variance, not (_ui.lua.enable.value and _ui.antiaim._global.enable.value))
    ui.set_visible(ref.fl_limit, not (_ui.lua.enable.value and _ui.antiaim._global.enable.value))

    ui.set_visible(_ui.ragebot.resolver_mode.ref, _ui.ragebot.resolver.value)
end
...
config.reset = function(input)
    decrypted = json.parse(base64.decode(input))
    package:load(decrypted)

    setup_notification("Antiaim settings reset", false)
end
...
resolver.apply = function(m_iEntityIndex, m_flDesync, m_iSide, m_flPitch)
    ...
    local pitch = entity.get_prop(m_iEntityIndex, "m_angEyeAngles[0]")
    if m_flFinalAngle < 0 then
        m_flFinalAngle = math.ceil(m_flFinalAngle - 0.5)
    else
        m_flFinalAngle = math.floor(m_flFinalAngle + 0.5)
    end
    if m_iSide == 0 or (pitch < 10 and pitch > -10) then
        plist.set(m_iEntityIndex, 'Force body yaw', false)
        return
    end
    plist.set(m_iEntityIndex, 'Force body yaw', true)
    plist.set(m_iEntityIndex, 'Force body yaw value', _ui.ragebot.resolver_mode.value == "Default" and m_flFinalAngle or m_flFinalAngle > 0 and 60 or -60)
end
...
local defensive_resolver = function()
    ...
    for i, enemy_ent in ipairs(enemies) do
        if defensive_data[enemy_ent] == nil then
            ...
            if is_player_defensive_active(enemy_ent) then
...
local do_return = function(cmd)
    if bot_data.start_position and bot_data.should_return then
        ...
        if bot_data.start_position:dist2d(lp_origin) > 1 then
...
local peek_bot = function(cmd)
    ...
    if not ui.get(_ui.ragebot.peekbot_bind.ref) then 
        ...
        if not _ui.antiaim._global.enable.value and _ui.ragebot.peekbot_freestanding.value then
...
local dt_last_tick = function()
    if not _ui.ragebot.dt_last_tick.value or not _ui.lua.enable.value then return end

    local tickbase = entity.get_prop(entity.get_local_player(), "m_nTickBase") - globals.tickcount()
    local doubletap_ref = ui.get(ref.doubletap[1]) and ui.get(ref.doubletap[2]) and not ui.get(ref.fakeduck)
    ...
    if last_shot == nil then return end
    ...
    local attack = globals.curtime() - last_shot <= value

    if tickbase > 0 and doubletap_ref then
        if attack then
            ui.set(ref.rage_cb[2], "Always on")
        else
            ui.set(ref.rage_cb[2], "On hotkey")
        end
    else
        ui.set(ref.rage_cb[2], "Always on")
    end
...
local is_lethal = function(player)
    ...
    if not _ui.ragebot.force_body.value or not _ui.lua.enable.value then return end
...
local antiaim_builder = function(cmd)
    ...
    stages = {
        modifier_delayed = {
            [1] = not (defensive and aa_builder[get_override].defensive_modifiers.value and not (aa_builder[get_override].defensive_antiaim.value == "Off")) and aa_builder[get_override].yaw_modifier_value.value or aa_builder[get_override].defensive_yaw_modifier_value.value,
            [2] = not (defensive and aa_builder[get_override].defensive_modifiers.value and not (aa_builder[get_override].defensive_antiaim.value == "Off")) and -aa_builder[get_override].yaw_modifier_value.value or -aa_builder[get_override].defensive_yaw_modifier_value.value
        },

        modifier_5way = {
            [1] = 0,
            [3] = not (defensive and aa_builder[get_override].defensive_modifiers.value and not (aa_builder[get_override].defensive_antiaim.value == "Off")) and -aa_builder[get_override].yaw_modifier_value.value/2 or -aa_builder[get_override].defensive_yaw_modifier_value.value/2,
            [4] = not (defensive and aa_builder[get_override].defensive_modifiers.value and not (aa_builder[get_override].defensive_antiaim.value == "Off")) and aa_builder[get_override].yaw_modifier_value.value/2 or aa_builder[get_override].defensive_yaw_modifier_value.value/2,
            [5] = not (defensive and aa_builder[get_override].defensive_modifiers.value and not (aa_builder[get_override].defensive_antiaim.value == "Off")) and -aa_builder[get_override].yaw_modifier_value.value or -aa_builder[get_override].defensive_yaw_modifier_value.value,
            [2] = not (defensive and aa_builder[get_override].defensive_modifiers.value and not (aa_builder[get_override].defensive_antiaim.value == "Off")) and aa_builder[get_override].yaw_modifier_value.value or aa_builder[get_override].defensive_yaw_modifier_value.value
        },
    ...
    ui.set(ref.fl_amount, aa_builder[aa_builder[state].fakelag_override.value and state or 1].fakelag_amount.value)
    ui.set(ref.fl_variance, aa_builder[aa_builder[state].fakelag_override.value and state or 1].fakelag_variance.value)
    ui.set(ref.fl_limit, aa_builder[aa_builder[state].fakelag_override.value and state or 1].fakelag_limit.value)
    ...
    if ui.get(ref.freestand[1]) then
        ui.set(ref.pitch, "Down")
        ui.set(ref.yaw_base, "Local view")
        ui.set(ref.yaw_jitter, "Off")
        ui.set(ref.yaw, "180")
    ...
    -- binds
    ui.set(ref.freestand[1], (ui.get(_ui.antiaim.binds.freestanding.ref) or (ui.get(_ui.ragebot.peekbot_bind.ref) and _ui.ragebot.peekbot_freestanding.value)) and true or false)
    ui.set(ref.edgeyaw, ui.get(_ui.antiaim.binds.edge_yaw.ref) and true or false)

    -- fixes
    if ((not defensive) or choking(cmd)) then
        if ui.get(ref.pitch) ~= "Minimal" then
            ui.set(ref.pitch, "minimal")
        end

        if not (right_dir or left_dir) and (ui.get(ref.yaw_value) > 30 or ui.get(ref.yaw_value) < -30) then
            ui.set(ref.yaw_value, 0)
        end
    end
    if ui.get(ref.fakeduck) then
        pui.reference("aa", "fake lag", "limit"):override(15)
    else
        pui.reference("aa", "fake lag", "limit"):override()
    end
...
inattack = function() if not _ui.antiaim.settings.fakelag_on_shot.value or not _ui.lua.enable.value then return end vars.shot_time = globals.realtime() vars.in_attack = vars.shot_time + 0.035 return vars.in_attack end
...
local watermark = function()
    ...
    if _ui.visuals.watermark_mode.value == "Simple" then
        ...
        renderer_gs_rect_with_text(screen_size.x/2, screen_size.y - 24 - anims_wm.menu, "gamesense.tools   ~   build : "..lua_data.build, nil, true, color[1], color[2], color[3], 255)
    end
end
...
local indicators = function()
    ...
    local binds_table = {
        ...
        ["BAIM"] = (req and contains(_ui.visuals.indicators_binds.value, "Force body aim") and anims_ind.alpha > 5) and ui.get(ref.baim),
        ["SAFE"] = (req and contains(_ui.visuals.indicators_binds.value, "Force safe points") and anims_ind.alpha > 5) and ui.get(ref.safe),
    ...
    for i, bind in ipairs({"DOUBLE TAP", "IDEALPEEK", "FREESTAND", "AUTOPEEK", "FAKEDUCK", "EDGEYAW", "DMG: "..ui.get(ref.damage[3]), "BAIM", "SAFE", "OS-AA"}) do
...
local target_tracer = function()
    if not _ui.visuals.tracer.value or not _ui.lua.enable.value then return end
...
local function lagcomp_net_update()
    if not _ui.lua.enable.value or not _ui.visuals.lagcomp_debug.value then return end
    local me = entity.get_local_player()
    ...
    for idx, net_data in pairs(g_net_data) do
        if entity.is_alive(idx) and entity.is_enemy(idx) and net_data ~= nil then
            if net_data.lagcomp then
                ...
                local min = vec_add({ entity.get_prop(idx, 'm_vecMins') }, predicted_pos)
                local max = vec_add({ entity.get_prop(idx, 'm_vecMaxs') }, predicted_pos)
                ...
                for i = 1, #edges do
                    if i == 1 then
                        ...
                        local origin_renderer_world_to_screen = { renderer.world_to_screen(origin[1], origin[2], origin[3]) }
                        local min_renderer_world_to_screen = { renderer.world_to_screen(min[1], min[2], min[3]) }

                        if origin_renderer_world_to_screen[1] ~= nil and min_renderer_world_to_screen[1] ~= nil then
                            renderer.line(origin_renderer_world_to_screen[1], origin_renderer_world_to_screen[2], min_renderer_world_to_screen[1], min_renderer_world_to_screen[2], 47, 117, 221, 255)
                        end
                    end
...
local teleport = function(cmd)
    ...
    local pui_dt = {pui.reference("rage", "aimbot", "double tap")}

    if is_vulnerable() and vel_2 < 20 then
        cmd.in_jump = false
        pui_dt[1]:override(false)
    else
        pui_dt[1]:override()
    end
end
...
local shit_talking = function(e)
    ...
    local get_phrase = get_phrases[math.random(1, #get_phrases)]
...
client.set_event_callback("shutdown", function()
    hide_refs(false)
    ui.set_visible(ref.fl_enable[1], true)
    ui.set_visible(ref.fl_enable[2], true)
    ui.set_visible(ref.fl_amount, true)
    ui.set_visible(ref.fl_variance, true)
    ui.set_visible(ref.fl_limit, true)
    client.set_clan_tag("")
end)