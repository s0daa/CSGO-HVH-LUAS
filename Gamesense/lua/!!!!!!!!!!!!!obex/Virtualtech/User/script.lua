...
local obex_data = obex_fetch and obex_fetch() or {username = 'Unknown', build = 'Live', discord=''}
...
bestcfg = 'VT_'
...
local menu = {
    ...
    aim_log = ui_new_multiselect("AA", "Anti-aimbot angles", "Aimbot Log", "Screen", "Console", "Text Only"),
    ...
    crs_iv = ui_new_slider("AA", "Anti-aimbot angles", "Crosshair Interval", 10, 20, 10),
...
local hitgroup_names = {'generic', 'head', 'chest', 'stomach', 'left arm', 'right arm', 'left leg', 'right leg', 'neck', '?', 'gear'}
    ...
    function hit(e)
        local string = string.format("hit %s for %s in the %s [hitscan: %s, bt: %s, lagcomp: %s]", string.lower(entity_get_player_name(e.target)), e.damage, hitgroup_names[e.hitgroup + 1] or '?', math_floor(e.hit_chance).."%", stored_shot.backtrack, stored_shot.lagcomp)
        table_insert(logs, {
            text = string,
            color = true
        })
    ...
    function missed(e)
        local string = string.format("missed %s's %s due to %s [dmg: %s, bt: %s, lagcomp: %s]", string.lower(entity_get_player_name(e.target)), stored_shot.hitbox, e.reason, stored_shot.damage, stored_shot.lagcomp, stored_shot.backtrack)
        table_insert(logs, {
            text = string,
            color = false
        })
...
local function antiaim_enable(cmd)
    ...
    normal_defen = is_defensive_active(local_player) and ui_get(refs.dt[1]) and ui_get(refs.dt[2]) and is_dt()
    run_defen = is_defensive_active(local_player) and is_enemy_peek() and vulnerable_ticks <= 17 and is_dt() and ui_get(refs.dt[1]) and ui_get(refs.dt[2])
    should_defen = state == "MOVE" and run_defen or normal_defen
    ...
    if aa_dir == "reset" then
        ...
        if on_ground == false and hold_knife or hold_zeus then
                ...
                ui_set(refs.yaw[2], should_defen and 49 or math_random(6,9))
                ui_set(refs.yawjitter[2], 0)
                ui_set(refs.bodyyaw[1], should_defen and "Off" or "Opposite")
        ...
        if ui_get(Antiaim[var.p_state].defensive) and ui_get(Antiaim[var.p_state].def_pitch) == "Ideal" and should_defen then
            dec_pitch = dec_pitch >= 89 and -89 or dec_pitch + 10
...
local function animfix(cmd)
    ...
    if contains(ui_get(menu.animfix_other), "Zero Pitch On Landing") then
        ...
        if ground_ticks > 14 and end_time > curtime then
...
local function cross_ind()
    ...
    local interval = ui_get(menu.crs_iv) + 1
    local frametime = globals_frametime()
    local curtime = globals_curtime()
    ...
    if not contains(ui_get(menu.save_fps), "Use Less Glow") then
        txt_glow(center_x + vts_w/2 + scope_anim - vts_w/2 + 3, center_y + distance + 2, vts_w - 3, 0, 7, 0, {r, g, b, 100}, {255, 255, 255, 50})
    end
    renderer_text(center_x + vts_w/2 + scope_anim + 1, center_y + distance + 2, 255, 255, 255, 255, "c", 0, "vir","\a" .. render_hex(r, g, b, 225) .. "tual")
    ---dsy render
    ...
    local active_size = renderer.measure_text("c", is_ideal() and "ideal" or "doubletap")
    local inactive_size = renderer.measure_text("c", "doubletap")
    local rec = animate_text(curtime * 4, is_ideal() and "ideal" or "doubletap", 75, 255, 75, 255)
    ...
    local os_size = renderer.measure_text("c", "hide")
    renderer_text(center_x + vts_w/2  + scope_anim + 1 , center_y + distance + interval * 3 - 2, 25, 255, 55, 255, "c", 0, "hide")
    renderer_text(center_x + vts_w/2  + scope_anim + 1 , center_y + distance + interval * 3 - 2, 25, 255, 55, 255, "c", 0, "hide")
    end
    end
...
local function p_log()
    ...
    for i = 1, #logs do
        ...
        if not logs[i].init then
            ...
            logs[i].time = #logs > 5 and globals_tickcount() + 20 or globals_tickcount() + 220
            logs[i].init = true
        end
        local r,g,b,a = ui_get(menu.log_miss_color)
        if logs[i].color == true then r,g,b,a = ui_get(menu.log_hit_color) end
        local string_size = renderer_measure_text("c", logs[i].text)
        local ts_w , ts_h = renderer_measure_text("c", logs[i].text)
        if not contains(ui_get(menu.aim_log), "Text Only") then
        if not contains(ui_get(menu.save_fps), "Use Less Glow")  then
            container_glow(center_x-string_size/2-6 , scrsize_y-logs[i].y:get()-150 , string_size+15, 20, r, g, b, 1,1.3,r, g, b)
        end
        Render_engine.render_container(center_x-string_size/2-6 , scrsize_y-logs[i].y:get()-150 , string_size+15, 21, r, g, b, 255, 0, 230, 6, 1, true)
        renderer_text(center_x , scrsize_y-logs[i].y:get()-140 , 255,255,255,255,"c",0,logs[i].text)
        end
        if contains(ui_get(menu.aim_log), "Text Only") then
            if not contains(ui_get(menu.save_fps), "Use Less Glow")  then
            --container_glow(center_x-string_size/2-6, scrsize_y-logs[i].y:get()-150, string_size+10, 10, r, g, b, 1, 1.3 ,r, g, b)
            txt_glow(center_x-string_size/2 , scrsize_y-logs[i].y:get()-140 , ts_w - 5, -1, 5, 0, {r, g, b, (a-50) * math_abs(math_cos(curtime*1.5))}, {255, 255, 255, 0 * math_abs(math_cos(curtime*1.5))})
            end
        renderer_text(center_x , scrsize_y-logs[i].y:get()-140 , 255,255,255,255,"c",0,logs[i].text)
        end


        if tonumber(logs[i].time) < globals_tickcount() then
            if logs[i].y:get() < -10 then
                table_remove(logs, i)
            else
                logs[i].y:update(frametime, -50, nil)
            end
        else
            logs[i].y:update(frametime, 20+(i*28), nil)
        end
    end
    if ui_is_menu_open()  then
        local r,g,b,a = ui_get(menu.log_miss_color)
        local string_size2 = renderer_measure_text("c", menu_open())
        local ts_w1 , ts_h1 = renderer_measure_text("c", menu_open())
        if not contains(ui_get(menu.save_fps), "Use Less Glow") and not contains(ui_get(menu.aim_log), "Text Only") then
        container_glow(center_x-string_size2/2 - 6 , scrsize_y-170 , string_size2+15, 20, r, g, b, 1,1.3,r, g, b)
        end
        if not contains(ui_get(menu.aim_log), "Text Only") then
        Render_engine.render_container(center_x-string_size2/2 - 6 , scrsize_y-170 , string_size2+15, 21, r, g, b, 255, 0, 230, 6, 1, true)
        end
        if contains(ui_get(menu.aim_log), "Text Only") then
        txt_glow(center_x - string_size2 /2  , scrsize_y-160 , ts_w1 - 1, -1, 5, 0, {r, g, b, (a-50) * math_abs(math_cos(curtime*2))}, {255, 255, 255, 50 * math_abs(math_cos(curtime*2))})
        end
        renderer_text(center_x , scrsize_y-160 , 255,255,255,255,"c",0,menu_open())
    end
end
...
local function defensive_indicator()
    ...
    if contains(ui_get(menu.visual), "Defensive") then
        ...
        if defensive_ready == true then
            ...
            local expand = is_defensive and 98 or ticker * 98 / 175
            renderer_texture(defen_svg, center_x, center_y  * 0.5 - 10, 24, 24, 255, 255, 255, lerp_alpha)
            renderer_text(center_x , is_defensive and center_y  * 0.5 - 20 or center_y  * 0.5 - 10 ,255,255,255,lerp_alpha,"c",0,is_defensive and "defensive" or "- defensive -")
            if is_defensive then
                renderer_text(center_x , center_y  * 0.5 - 10 ,255,255,255,lerp_alpha,"cb+",0,"∞")
            end
            
            renderer_rectangle(center_x - 50, center_y  * 0.5, 100, 4, 12, 12, 12, lerp_alpha <= 150 and lerp_alpha or 150)
...
local target_yaw = string.format("%.0f", entity_get_prop(target, "m_flPoseParameter", 11) * 120 - 60)
...
last_time = sim_time
defen_state = defensive_untild > tickcount and "true" or "false"
local vx, vy, vz = entity_get_prop(target, "m_vecVelocity")
local debug_lol = animate_text(curtime * 1, "Virtualtech recode - build: [debug]", r, g, b, a)
enemy_velo = string.format("%.0f", math_sqrt(vx ^ 2 + vy ^ 2))
client_draw_text(ctx, 9 , center_y + 30 , 255, 255, 255, 255, "d", 0, " ", unpack(debug_lol))
client_draw_text(ctx, 10 , center_y + 45 , 255, 255, 255, 255, "d", 0, "User: "..user_id())
client_draw_text(ctx, 10 , center_y + 60 , 255, 255, 255, 255, "d", 0, "Target: "..target_name)
client_draw_text(ctx, 10 , center_y + 75 , 255, 255, 255, 255, "d", 0, "Target Yaw: "..target_yaw)
client_draw_text(ctx, 10 , center_y + 90 , 255, 255, 255, 255, "d", 0, "Target Velocity: "..enemy_velo)
client_draw_text(ctx, 10 , center_y + 105 , 255, 255, 255, 255, "d", 0, "Target Defensive: "..defen_state)
...
local function on_load()
    ...
    ui_set_visible(menu.crs_iv, ui_get(menu.tab) == "Visuals" and contains(ui_get(menu.visual), "Crosshair"))
