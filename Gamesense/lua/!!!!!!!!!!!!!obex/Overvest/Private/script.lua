...
local obex_data = obex_fetch and obex_fetch() or {username = 'Kizaru', build = 'Secret', discord=''}
...
local default_config = ""
...
gui = {
    ...
    main = {
        ...
        list = ui_new_combobox("AA", "Anti-aimbot angles", "\a65FFCEFFUI navigator ~", 'Main', 'Ragebot', 'Anti-Aims', 'Visuals', 'Misc'),

        text = ui_new_label("AA", "Anti-aimbot angles", "\aFFFFFFC8So, Shawty, \a65FFCEFFWhat's The Business?"),
        spacing = ui_new_label("AA", "Anti-aimbot angles", "---------------------------------------"),
        user = ui_new_label("AA", "Anti-aimbot angles", "\aFFFFFFC8User: \a65FFCEFF " .. obex_data.username),
        build = ui_new_label("AA", "Anti-aimbot angles", "\aFFFFFFC8Build: \a65FFCEFF " .. obex_data.build),
        version = ui_new_label("AA", "Anti-aimbot angles", "\aFFFFFFC8Version: \a65FFCEFFSecret"),
        update = ui_new_label("AA", "Anti-aimbot angles", "\aFFFFFFC8Last update: \a65FFCEFF31.03.2023"),
    ...
    ragebot = {
        ...
        master_switch = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFRagebot switch"),
        spacing = ui_new_label("AA", "Anti-aimbot angles", "---------------------------------------"),
        resolver = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFJitter correction"),
        enemy_debug = ui_new_multiselect("AA", "Anti-aimbot angles", "Enemy debug information", "Yaw", "Body yaw"),
        spacing2= ui_new_label("AA", "Anti-aimbot angles", "---------------------------------------"),
        ideal_tick = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFIdeal tick"),
        ideal_tick_indicator = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFIdeal tick indicator"),
    ...
    antiaims = {
        master_switch = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFAnti-Aims Master switch"),
        spacing3 = ui_new_label("AA", "Anti-aimbot angles", "---------------------------------------"),
        navigator = ui_new_combobox("AA", "Anti-aimbot angles", " \a65FFCEFFAnti-aims navigator ~", {"Main", "Binds", "Helpers"}),
        spacing2 = ui_new_label("AA", "Anti-aimbot angles", "---------------------------------------"),
        enable_builder = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFBuilder Master switch"),
        conditions = ui_new_combobox("AA", "Anti-aimbot angles", " \a65FFCEFFAnti-Aim conditions ~", {"Stand", "Move", "Air", "Air Crouching", "Crouch", "Slow-walk"}),
        avoid_backstab = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFAvoid backstab"),
        onshot_fix = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFSupress fakelags on hideshots"),
        manual_jitter = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFSupress jitter on manuals"),
        
        freestanding = ui_new_hotkey("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Freestanding key"),
        edge_yaw = ui_new_hotkey("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Edge yaw key"),
        manual_left = ui_new_hotkey("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Manual left key"),
        manual_right = ui_new_hotkey("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Manual right key"),
        manual_reset = ui_new_hotkey("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Manual reset key"),
        spacing = ui_new_label("AA", "Anti-aimbot angles", "---------------------------------------"),
    ...
    visuals = {
        ...
        master_switch = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFVisuals Master switch"),
        spacing = ui_new_label("AA", "Anti-aimbot angles", "---------------------------------------"),
        centered = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFCenter indicators"),
        ...
        name_speed = ui_new_slider("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Center indicators animation speed", 1, 200, 1),

        star = ui_new_label("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Star color"),
        star_col = ui_new_color_picker("AA", "Anti-aimbot angles", "Star color", 255, 255, 255, 255),

        name = ui_new_label("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Name color"),
        name_col = ui_new_color_picker("AA", "Anti-aimbot angles", "Name color", 255, 255, 255, 255),

        name2 = ui_new_label("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Name color #2"),
        name_col2 = ui_new_color_picker("AA", "Anti-aimbot angles", "Name color #2", 255, 255, 255, 255),

        state = ui_new_label("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8State color"),
        state_col = ui_new_color_picker("AA", "Anti-aimbot angles", "State color", 255, 255, 255, 255),

        binds = ui_new_label("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Binds color"),
        binds_col = ui_new_color_picker("AA", "Anti-aimbot angles", "Binds color", 255, 255, 255, 255),

        left_ind = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFSide indicator"),
        ...
        left_ind_speed = ui_new_slider("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Side indicator animation speed", 1, 200, 1),
        left_ind_speed2 = ui_new_slider("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Side indicator animation speed #2", 1, 200, 1),

        left_ind_col = ui_new_label("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Side indicator color"),
        left_ind_color = ui_new_color_picker("AA", "Anti-aimbot angles", "Side color", 255, 255, 255, 255),

        left_ind_col2 = ui_new_label("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Side indicator color #2"),
    ...
    misc = {
        ...
        master_switch = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFMiscellaneous Master switch"),
        spacing = ui_new_label("AA", "Anti-aimbot angles", "---------------------------------------"),
        aimbot_logs = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFNotifications"),
        aimbot_logs_type = ui_new_multiselect("AA", "Anti-aimbot angles", "Notifications output", "Console", "Screen"),
        logs_col = ui_new_label("AA", "Anti-aimbot angles", "\a65FFCEFF>> \aFFFFFFC8Notifications color"),
        logs_color = ui_new_color_picker("AA", "Anti-aimbot angles", "Notifications color", 171, 157, 255, 255),
        console_filter = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFConsole filtering"),
        clan_tag = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFClan tag spammer"),
        trash_talk = ui_new_checkbox("AA", "Anti-aimbot angles", "\a65FFCEFFTrash Talk"),
...
conditions = {"\a65FFCEFF[Stand]", "\a65FFCEFF[Move]", "\a65FFCEFF[Air]", "\a65FFCEFF[Air crouching]", "\a65FFCEFF[Crouch]", "\a65FFCEFF[Slow-walk]"}
builder = {}
...
for i = 1, 6 do
    builder[i] = {
        ...
        yaw_offset = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Yaw offset", -180, 180, 0, true, "°"),
        yaw_offset_left = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Yaw offset left", -180, 180, 0, true, "°"),
        yaw_offset_right = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Yaw offset right", -180, 180, 0, true, "°"),
        ...
        yaw_jitter_offset = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Yaw jitter offset", -180, 180, 0, true, "°"),
        
        x_yaw_jitter_offset_1 = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Yaw jitter offset #1", -180, 180, 0, true, "°"),
        x_yaw_jitter_offset_2 = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Yaw jitter offset #2", -180, 180, 0, true, "°"),
        x_yaw_jitter_offset_3 = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Yaw jitter offset #3", -180, 180, 0, true, "°"),
        x_yaw_jitter_offset_4 = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Yaw jitter offset #4", -180, 180, 0, true, "°"),
        x_yaw_jitter_offset_5 = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Yaw jitter offset #5", -180, 180, 0, true, "°"),
        
        body_yaw = ui_new_combobox("AA", "Anti-aimbot angles", conditions[i] .. " \aFFFFFFC8Body yaw", {"Off", "Opposite", "Jitter", "Static"}),

        body_yaw_type = ui_new_combobox("AA", "Anti-aimbot angles", conditions[i] .. " \aFFFFFFC8Body yaw modifiers", {"Static", "Period switch", "Recursion"}),
        body_yaw_offset = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Body yaw offset", -180, 180, 0, true, "°"),

        body_yaw_offset_left = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Body yaw offset left", -180, 180, 0, true, "°"),
        body_yaw_offset_right = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Body yaw offset right", -180, 180, 0, true, "°"),

        body_yaw_step_ticks = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Recursion ticks", 0, 15, 1, true, "°"),
        body_yaw_step_value = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Recursion value", 0, 180, 5, true, "°"),

        step_bodyyaw_degree_left = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Body yaw offset min", -180, 180, 0, true, "°"),
        step_bodyyaw_degree_right = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Body yaw offset max", -180, 180, 0, true, "°"),
        ...
        defensive_pitch = ui_new_combobox("AA", "Anti-aimbot angles", " \a65FFCEFFDefensive pitch", {"Off", "Up", "Down", "Random"}),
        defensive_yaw = ui_new_combobox("AA", "Anti-aimbot angles", " \a65FFCEFFDefensive yaw", {"Off", "180", "Spin", "180 Z"}),
        defensive_speed = ui_new_slider("AA", "Anti-aimbot angles", " \a65FFCEFF>> \aFFFFFFC8Defensive yaw offset", -180, 180, 0, true, "°"),
...
antiaims.builder = LPH_NO_VIRTUALIZE(function(cmd)
    ...
    elseif aero < 7 then
        ...
        if globals_realtime() * 16 % 2 > 1 then
            state = "=  AERO  -"
        end
    ...
    if ui_get(gui.antiaims.master_switch) and ui_get(gui.antiaims.enable_builder) then
        ...
        bodystep_max = ui_get(builder[stateid].step_bodyyaw_degree_right)
        bodystep_min = ui_get(builder[stateid].step_bodyyaw_degree_left)
        bodystep_step = ui_get(builder[stateid].body_yaw_step_value)
        bodystep_ticks = globals_tickcount() % ui_get(builder[stateid].body_yaw_step_ticks)

        if ui_get(builder[stateid].step_bodyyaw_degree_left) >= ui_get(builder[stateid].step_bodyyaw_degree_right) then
            ui_set(builder[stateid].step_bodyyaw_degree_left,ui_get(builder[stateid].step_bodyyaw_degree_right))
        end

        if bodystep_ticks == ui_get(builder[stateid].body_yaw_step_ticks) - 1 then
            if bodystep_return_value < bodystep_max then
                bodystep_return_value = bodystep_return_value + bodystep_step
            elseif bodystep_return_value >= bodystep_max then
                bodystep_return_value = bodystep_min
            end
        end

        if ui_get(builder[stateid].body_yaw_type) == "Static" then
            ui_set(refs.body_yaw[2], ui_get(builder[stateid].body_yaw_offset))
        elseif ui_get(builder[stateid].body_yaw_type) == "Period switch" then
        ...
        elseif ui_get(builder[stateid].body_yaw_type) == "Recursion" then
            ui_set(refs.body_yaw[2], clamp(bodystep_return_value, bodystep_min, bodystep_max))
        end
...
antiaims.defensive_aa = LPH_NO_VIRTUALIZE(function()
    ...
    if is_force_defensive == 1 and ui_get(builder[stateid].defensive_pitch) ~= "Off" and ui_get(builder[stateid].defensive_yaw) ~= "Off" and ui_get(refs.doubletap[1]) and ui_get(refs.doubletap[2]) then
        if antiaims.vars.it_value_pitch == nil then
        ...
        ui_set(refs.pitch, ui_get(builder[stateid].defensive_pitch))

        ui_set(refs.yaw[1], ui_get(builder[stateid].defensive_yaw))
        ui_set(refs.yaw[2], ui_get(builder[stateid].defensive_speed))
...
is_force_defensive_aa = 0
antiaims.defensive_aa_states = LPH_NO_VIRTUALIZE(function(cmd)
    if not ui_get(gui.main.enable) or not ui_get(gui.antiaims.master_switch) or not ui_get(gui.antiaims.enable_builder) or gl.lp == nil then 
        return 
    end

    if is_force_defensive == 1 and ui_get(builder[stateid].defensive_pitch) ~= "Off" and ui_get(builder[stateid].defensive_yaw) ~= "Off" and ui_get(refs.doubletap[1]) and ui_get(refs.doubletap[2]) then
        is_force_defensive_aa = 1
    else
        is_force_defensive_aa = 0;
    end

    if is_force_defensive_aa == 1 then
...
widgets = {
    ...
    center = {
        ...
        draw = LPH_NO_VIRTUALIZE(function(self)
            ...
            rendering.glow_module(x - offset_name * (1 - self.scope_move) + 2 + major_offset, y + 35, measure_name.x - 3, 0, 10, 0, {clr_name.r, clr_name.g, clr_name.b, 255}, {clr_name.r, clr_name.g, clr_name.b, 255})
...
configs.data = {
    ...
    ints = {
        ...
        builder[1].body_yaw_step_ticks, builder[2].body_yaw_step_ticks, builder[3].body_yaw_step_ticks, builder[4].body_yaw_step_ticks, builder[5].body_yaw_step_ticks, builder[6].body_yaw_step_ticks,
        builder[1].body_yaw_step_value, builder[2].body_yaw_step_value, builder[3].body_yaw_step_value, builder[4].body_yaw_step_value, builder[5].body_yaw_step_value, builder[6].body_yaw_step_value,
        builder[1].step_bodyyaw_degree_left, builder[2].step_bodyyaw_degree_left, builder[3].step_bodyyaw_degree_left, builder[4].step_bodyyaw_degree_left, builder[5].step_bodyyaw_degree_left, builder[6].step_bodyyaw_degree_left,
        builder[1].step_bodyyaw_degree_right, builder[2].step_bodyyaw_degree_right, builder[3].step_bodyyaw_degree_right, builder[4].step_bodyyaw_degree_right, builder[5].step_bodyyaw_degree_right, builder[6].step_bodyyaw_degree_right,
        builder[1].defensive_speed, builder[2].defensive_speed, builder[3].defensive_speed, builder[4].defensive_speed, builder[5].defensive_speed, builder[6].defensive_speed,
    ...
    strings = {
        ...
        builder[1].defensive_yaw, builder[2].defensive_yaw, builder[3].defensive_yaw, builder[4].defensive_yaw, builder[5].defensive_yaw, builder[6].defensive_yaw,
        builder[1].defensive_pitch, builder[2].defensive_pitch, builder[3].defensive_pitch, builder[4].defensive_pitch, builder[5].defensive_pitch, builder[6].defensive_pitch,
    },
...
gui.callbacks = LPH_NO_VIRTUALIZE(function()
    ...
    for i = 1, 6 do
        ...
        ui_set_visible(builder[i].step_bodyyaw_degree_left, enable and a_tab and a_switch and a_navigator == 'Main' and conditional and conditions == i and ui_get(builder[i].body_yaw) ~= "Off" and ui_get(builder[i].body_yaw) ~= "Opposite" and ui_get(builder[i].body_yaw_type) == "Recursion")
        ui_set_visible(builder[i].step_bodyyaw_degree_right, enable and a_tab and a_switch and a_navigator == 'Main' and conditional and conditions == i and ui_get(builder[i].body_yaw) ~= "Off" and ui_get(builder[i].body_yaw) ~= "Opposite" and ui_get(builder[i].body_yaw_type) == "Recursion")

        ui_set_visible(builder[i].body_yaw_step_ticks, enable and a_tab and a_switch and a_navigator == 'Main' and conditional and conditions == i and ui_get(builder[i].body_yaw) ~= "Off" and ui_get(builder[i].body_yaw) ~= "Opposite" and ui_get(builder[i].body_yaw_type) == "Recursion")
        ui_set_visible(builder[i].body_yaw_step_value, enable and a_tab and a_switch and a_navigator == 'Main' and conditional and conditions == i and ui_get(builder[i].body_yaw) ~= "Off" and ui_get(builder[i].body_yaw) ~= "Opposite" and ui_get(builder[i].body_yaw_type) == "Recursion")
        ...
        ui_set_visible(builder[i].defensive_pitch, enable and a_tab and a_switch and a_navigator == 'Main' and conditional and conditions == i and ui_get(builder[i].force_defensive))
        ui_set_visible(builder[i].defensive_yaw, enable and a_tab and a_switch and a_navigator == 'Main' and conditional and conditions == i and ui_get(builder[i].force_defensive))
        ui_set_visible(builder[i].defensive_speed, enable and a_tab and a_switch and a_navigator == 'Main' and conditional and conditions == i and ui_get(builder[i].defensive_yaw) ~= "Off" and ui_get(builder[i].force_defensive))
    end
