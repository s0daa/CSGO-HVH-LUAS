...
local LUA_UPDATE_WAS = 1692723566;
...
do
    ...
    local function update_correction(player)
        ...
        if record.is_prev_jittering and record.is_jittering then
            ...
            jitter_fix = abs_body_yaw > 12 and abs_body_yaw < 72;
        end
...
do
    ...
    local function is_defensive_active()
        ...
        local duration = data.duration - toticks(client.real_latency());
