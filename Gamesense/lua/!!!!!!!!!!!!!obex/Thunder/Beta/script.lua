...
local menu = {
    ...
    visualsTab = {
        indicatorsType = ui.new_combobox(tab, container, "Indicators", "-", "1", "3"),
        ...
        screenIndication = ui.new_multiselect(tab, container, "Screen indication", "Defensive Manager", "Flag"),
...
local function initDatabase()
    ...
    local link = "https://pastebin.com/raw/n9NgM5xM"
...
client.set_event_callback("paint_ui", function()
    ...
    ui.set_visible(menu.visualsTab.indicatorsStyle, (ui.get(menu.visualsTab.indicatorsType) == "1" or ui.get(menu.visualsTab.indicatorsType) == "3") and isVisualsTab and isEnabled)
