...
local obex_data = obex_fetch and obex_fetch() or {username = '', build = '', discord=''}
local userdata = {
    username = obex_data.username == nil or obex_data.username,
    build = obex_data.build ~= nil and obex_data.build:gsub("Private", "secret"):gsub("Debug", "nightly"):gsub("Beta", "beta"):gsub("User", "live")
}
client.exec("clear")
