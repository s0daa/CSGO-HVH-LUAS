...
client.set_event_callback("paint", function()
    ...
    renderer.text(30 - 1,y_pos, 255, 255, 255, 255, "-c", 0, "USER: ")
    renderer.text(30 + sizes[1].x,y_pos, 255, 255, 255, 255, "-c", 0, string.upper(obex_data.username))
    renderer.text(30 + sizes[1].x,y_pos, 255, 255, 255, 255, "-c", 0, modify_text(r, g, b, string.upper(obex_data.username)))
    y_pos = y_pos + sizes[1].y
    renderer.text(30,y_pos, 255, 255, 255, 255, "-c", 0, "BUILD: ")
    renderer.text(30 + sizes[2].x,y_pos, r, g, b, animate_alpha(255), "-c", 0, "BOOSTERS")
