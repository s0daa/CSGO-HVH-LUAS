...
local watermark = {} do
    ...
    http.get('https://cdn.discordapp.com/attachments/1073732301340553228/1150497962754068590/risen_logo.png', function(s, r)
    ...
    http.get('https://cdn.discordapp.com/attachments/884455063232348210/1150494484451315784/wifi_icon.png', function(s, r)
        if s and r.status == 200 then
    ...
    http.get('https://cdn.discordapp.com/attachments/884455063232348210/1150520931257683989/clock_icon.png', function(s, r)
        if s and r.status == 200 then
...
notifications = {} do
    ...
    http.get('https://cdn.discordapp.com/attachments/884455063232348210/1150926157835931658/cross-circle2.png', function(s, r)
        if s and r.status == 200 then
