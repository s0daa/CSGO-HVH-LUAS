...
local kill = {
    ...
    "I will punch Baim until you die",
    "I'll put my dick down your throat",
    "you got it wrong HAHAHAHAH",
    "Good desync, is it ethernity?",
    "You get Baim and run away XD",
    "Fucking country bitch",
    "Did you shoot with your left hand? XD",
    "Nice miss loser HAAHAH",
    "You were looking in the wrong direction",
    "what was that xd",
    "Go wash yourself and give me a blowjob",
    "You're a country bitch looking for ravens with a bag",
    "I am a famous shepherd, I give you a cock to graze",
    "Hello boy, are you lost?",
    "You're so fat you could be seen through three walls",
    "VeRy NeRvoS BaIm",
    "Beautifully",
    "sit down dog",
    "You and your old man still have belly sticking out... Baim!",
    "phew... King Baim! $$",
    "Hallelujah, you blew me!!",
    "lol, I turned off the resolver xDD",
    "The most nervous dinner of my life",
    "BaIm bAiM BaIm",
    "Okay, I'll keep quiet, I'll leave you alone",
    "No, I was joking xD",
    "Hmm... I don't know how to tell you this, but... did you see me as a fireman when I put my penis on your shoulder?",
    "I put my dick on your chest",
    "Will you send the cfg to Osiris?",
    '~" %EF%BF%BD %EF%BF%BD .~ "%EF%BF%BD %EF%BF%BD 1 %EF%BF%BD %EF%BF%BD" ~. %EF%BF%BD %EF%BF%BD "~',
    "easy xD",
    "I fucked you through the wall",
    "I hit you on the head with my dick",
    "1 goes bald",
    "Look on the bright side, at least you covered the wall xD",
    "ESC -> Help and options -> How to play",
    "I recommend skeet with vitamins to pregnant girls",
    "Hakuna matataaaa, when 1 comes in here...",
    "You looked at me like you were nodding your head",
    "fuck you, fuck me like a redneck",
    "Are you scared? Yeah!",
...
local masterSwitch = ui.new_checkbox(tab, container, "TAB\aaac8fbffSENSE")


local menu = {
    aaTab = {
        lol = ui.new_multiselect(tab, container, "Extra\aaac8fbff", {"Safe Knife", "Avoid Backstab", "Static on Manual"}),
        avoidBackstab = ui.new_slider(tab, container, "Avoid\aaac8fbff Backstab", 0, 300, 0, true, "u", 1, {[0] = "Off"}),
    },

    keys = {
        enable_key = ui.new_checkbox(tab, container, "Key\aaac8fbffbinds"),
        freestandHotkey = ui.new_hotkey(tab, container, "Freest\aaac8fbffanding"),
        edgeYawHotkey = ui.new_hotkey(tab, container, "Edge\aaac8fbff Yaw"),
        manualTab = {
            manualLeft = ui.new_hotkey(tab, container, "\aaac8fbffManual " .. func.hex({200,200,200}) .. "left"),
            manualRight = ui.new_hotkey(tab, container, "\aaac8fbffManual\aaac8fbff " .. func.hex({200,200,200}) .. "right"),
            manualForward = ui.new_hotkey(tab, container, "\aaac8fbffManual\aaac8fbff " .. func.hex({200,200,200}) .. "forward"),
        },
        freestandDisablers = ui.new_multiselect(tab, container, "Freestand\aaac8fbff Disablers", {"Air", "Duck", "Manual"}),
    },

    builderTab = {
        LogicComboBox = ui.new_combobox(tab, container, "logica\aaac8fbff secret", "1", "2"),
        PresetComboBox = ui.new_combobox(tab, container, "Pres\aaac8fbffets", "Disabled", "Unmatched", "Community"),
        buttonPresets = ui.new_button(tab, container, "Go to Pres\aaac8fbffets", function() end),
    ...
    visualsTab = {
        indicators = ui.new_combobox(tab, container, "Indic\aaac8fbffators", "Disabled", "Default"),
        ...
        arrows = ui.new_checkbox(tab, container, "Arr\aaac8fbffows"),
        ...
        watermark = ui.new_checkbox(tab, container, "Water\aaac8fbffmark"),
        watermarkClr = ui.new_color_picker(tab, container, "Watermark\aaac8fbff Color", lua_color.r, lua_color.g, lua_color.b, 255),
        logs = ui.new_checkbox(tab, container, "Screen\aaac8fbff Hit Logs"),
        logsClr = ui.new_color_picker(tab, container, "Logs\aaac8fbff Color", lua_color.r, lua_color.g, lua_color.b, 255),
    },
    miscTab = {
        trashTalk = ui.new_checkbox(tab, container, "[Trash\aaac8fbffTalk]"),
        fastLadderEnabled = ui.new_checkbox(tab, container, "[Fast\aaac8fbff ladder]"),
        fastLadder = ui.new_multiselect(tab, container, "\n [fast\aaac8fbff ladder]", "Ascending", "Descending"),
        animationsEnabled = ui.new_checkbox(tab, container, "[Anim\aaac8fbff breakers]"),
        animations = ui.new_multiselect(tab, container, "\n animation\aaac8fbff breakers", "Break legs while in air", "Reset pitch on land", "Leg fucker", "Be Micheal Jackson"),
        dtDischarge = ui.new_hotkey(tab, container, "[Teleport\aaac8fbff Exploit]"),
    },
    configTab = {
...
notifications.new(string.format('Security provided by best coders, cracked by Administrator (cbzcpolska) x Klockowo'), 255, 255, 255)
