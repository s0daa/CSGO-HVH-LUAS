...
local menu = {
    global = {
        menu = ui.new_combobox('AA', 'Anti-aimbot angles', "sirius \a96C83CFFgamesense",
            { "global", "antihit system", "visuals", "misc" })
    },
    anti_aim = {
        states = ui.new_combobox('AA', 'Fake lag', "player\a96C83CFFstate", all.states),
        select = ui.new_combobox('AA', 'Anti-aimbot angles', "buider mode", { "default", "\aB6B665FFdefensive" }),
        def_readt = ui.new_multiselect('AA', 'Anti-aimbot angles', "defensive on", { "hideshots", "doubletap" }),
        defensive = {},
    },
    visuals = {
        indicators = ui.new_checkbox('AA', 'Fake lag', "indicators"),
        ind_color = ui.new_color_picker('AA', 'Fake lag', "indicators", 255, 255, 255, 255),
        logs = ui.new_checkbox('AA', 'Fake lag', "hitlogs"),
    },
    misc = {},
...
for i = 1, #all.states do
    menu.anti_aim[i] = {
        pitch = ui.new_combobox('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "pitch",
            { "off", "default", "up", "down", "minimal", "random", "custom" }),
        custom_pitch = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "custom pitch", -89, 89, 0, true,
            '°'),
        yawbase = ui.new_combobox('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "yaw base",
            { "local view", "at targets" }),
        yaw = ui.new_combobox('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "yaw",
            { "off", "180", "spin", "static", "180z", "crosshair" }),
        yawjitter = ui.new_combobox('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "yaw jitter",
            { "off", "offset", "center", "random", "skitter" }),
        jitterint = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "jitter", -180, 180, 0, true, '°'),
        yawadd = ui.new_combobox('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "yaw add type",
            { "static", "2-side", "slowed", "3-way", "5-way" }),

        yawstatic = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "static", -180, 180, 0, true, '°'),

        yawleft = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "left", -180, 180, 0, true, '°'),
        yawright = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "right", -180, 180, 0, true, '°'),
        ticks = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "slowed by", 2, 8, 0, true, 't'),

        way1 = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "way 1", -180, 180, 0, true, '°'),
        way2 = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "way 2", -180, 180, 0, true, '°'),
        way3 = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "way 3", -180, 180, 0, true, '°'),
        way4 = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "way 4", -180, 180, 0, true, '°'),
        way5 = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "way 5", -180, 180, 0, true, '°'),

        bodyyaw = ui.new_combobox('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "body yaw",
            { "off", "opposite", "jitter", "static" }),
        bodyint = ui.new_slider('AA', 'Fake lag', "\aFFFFFFC8" .. all.menu_states[i] .. "desync", -180, 180, 0, true, '°'),
        bodyfree = ui.new_checkbox('AA', 'Fake lag', all.menu_states[i] .. "freestanding body yaw"),
        defensive = {
            force = ui.new_checkbox('AA', 'Fake lag',
                "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "override defensive"),
            enable = ui.new_checkbox('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "enable"),
            pitch = ui.new_combobox('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "pitch",
                { "off", "default", "up", "down", "minimal", "random", "custom" }),
            custom_pitch = ui.new_slider('AA', 'Fake lag',
                "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "custom pitch", -89, 89, 0, true, '°'),
            yawbase = ui.new_combobox('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "yaw base",
                { "local view", "at targets" }),
            yaw = ui.new_combobox('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "yaw",
                { "off", "180", "spin", "static", "180z", "crosshair" }),

            yawjitter = ui.new_combobox('AA', 'Fake lag',
                "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "yaw jitter",
                { "off", "offset", "center", "random", "skitter" }),
            jitterint = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "jitter",
                -180, 180, 0, true, '°'),

            yawadd = ui.new_combobox('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "yaw add type",
                { "static", "2-side", "slowed", "3-way", "5-way" }),

            yawstatic = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "static",
                -180, 180, 0, true, '°'),

            yawleft = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "left", -180,
                180, 0, true, '°'),
            yawright = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "right", -180,
                180, 0, true, '°'),
            ticks = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "slowed by", 2, 8,
                0, true, 't'),

            way1 = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "way 1", -180, 180,
                0, true, '°'),
            way2 = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "way 2", -180, 180,
                0, true, '°'),
            way3 = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "way 3", -180, 180,
                0, true, '°'),
            way4 = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "way 4", -180, 180,
                0, true, '°'),
            way5 = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "way 5", -180, 180,
                0, true, '°'),
            bodyyaw = ui.new_combobox('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "body yaw",
                { "off", "opposite", "jitter", "static" }),
            bodyint = ui.new_slider('AA', 'Fake lag', "\aB6B665FFdef " .. "\aFFFFFFC8" .. all.menu_states[i] .. "desync", -180,
                180, 0, true, '°'),
            bodyfree = ui.new_checkbox('AA', 'Fake lag', "\aB6B665FFdef " .. all.menu_states[i] .. "freestanding body yaw"),
        }
    }
end
