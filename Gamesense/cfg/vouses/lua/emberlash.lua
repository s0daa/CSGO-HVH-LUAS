...
chat_spammer.phrases = {
    kill = {
        ...
        {"ХВАТИТь пукать говно тупое иди убейся нахуй", "иди зайди в мой лучший дискорд - discord.gg/GZrRny9864"},
        ...
        {"ЛОЛ ИДИ РЯЛКА РОЗОВЫЕ ВИЗУАЛЫ купи фембойчик", "discord.gg/GZrRny9864"},
        {"тк ну и не открывай ротик", "хуесос", "лучше иди луашку мою купи discord.gg/GZrRny9864"},
        ...
        {"мой кфг отчинчанчонил тебя придурок", "увидишь в след соо, заходи чтоб тя не хсали ублюдок"},
        ...
        {"Оправдайся в хуй за слабость ниже"},
        {"Что в хуй после матери нищий?"},
        {"в старом доме на обочине 3 клина, 1 обоссал, осталось двое"},
    },
        death = {
        {"он же", "не понимает", "что ему повезло"},
        {"ты че", "шлюха помойная", "на лаки онли"},
        {"сын пидораса онли на чит надеется"},
        {"уебище как тебе везет", "0 мозга, просто в вжал, хуесос"},
        {"ну хуесос, что ты делаешь"},
        {"уебище ты тупое", "ты не понимаешь", "на discord.gg/GZrRny9864 лучшие луа", "в след раз еденичкой улетишь уебище"},
        {"жирный рейв трип юзер, я тебе в некст раунде нос сломаю,чтоб не визжал от радости"}
    }
}
