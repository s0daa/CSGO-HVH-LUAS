...
██████╦╝███████╗╚█████╔╝██╔╝╚██╗██║░░██║███████╗██████╔╝╚█████╔╝███████╗░░╚██╔╝░░███████╗██║░░██║
╚═════╝░╚══════╝░╚════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚══════╝╚═════╝░░╚════╝░╚══════╝░░░╚═╝░░░╚══════╝╚═╝░░╚═╝
          darov ! | ds server https://discord.gg/MaE6Tvx4ZB  | (Beta)  BloxResolver alpha
...
local EnableResolver = ui.new_checkbox("Lua", "A", "BloxResolver\aCFCFCFCF  [Альфа]")
...
local sentences = {
    ...
    "$name BloxResolver alpha [BUY] ---> t.me/BloxResolver",
...
local killsay_enabled = ui.new_checkbox("LUA", "A", "[BloxResolver] GODMODE")
local killsayName_enabled = ui.new_checkbox("LUA","A","[BloxResolver] JITTER")
...
local auto_headshot_enabled = ui.new_checkbox("LUA", "A", "[BloxResolver] HS MODE")
